<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true"
    CodeFile="CHMSConfigSetup.aspx.cs" Inherits="Application_Admin_CHMSConfigSetup" %>
...
<%--    <meta http-equiv='content-type' content='text/html;charset=UTF-8;' />
    ...
    <center>
       <%-- <div class="container" style="margin-left: 20px; margin-right: 15px;">--%>
                ...
                <div class="col-sm-12">
                    <div class="panel panel-success">--%>
                        <div id="divcmphdrcollapse" runat="server" class="panel-heading" onclick="ShowReqDtl('ctl00_ContentPlaceHolder1_divsrch','btndivSearchDetails');return false;">
                            <div class="row">
                                <div class="col-sm-10" style="text-align: left">
                                    ...
                                    <asp:Label ID="lblTitle" runat="server" Text="CHMS Configuration Setup" CssClass="control-label"
                                        Style="font-size: 10.2pt;"></asp:Label>
                                </div>
                                <div class="col-sm-2">
                                    <span id="btndivSearchDetails" class="glyphicon glyphicon-collapse-down" style="float: right;
                        ...
                        <div id="divsrch" runat="server" class="panel-body" style="display: block; overflow: auto">
                            <asp:GridView ID="gvCHMSSetup" runat="server" CssClass="footable" AutoGenerateColumns="False"
                                 Width="100%" AllowPaging="True"   PageSize="30" OnRowDataBound="gvCHMSSetup_RowDataBound">
                                <RowStyle CssClass="GridViewRowNEW"></RowStyle>
                            <PagerStyle CssClass="disablepage" />
                            <HeaderStyle CssClass="gridview th" />
                                <Columns>
                                    <asp:TemplateField ShowHeader="True" HeaderText="Sr.No.">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField ShowHeader="True" HeaderText="Configuration Value">
                                        <ItemTemplate>
                                            <asp:UpdatePanel runat="server" ID="uplDDLVALUE">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlValue" AutoPostBack="true" CssClass="form-control" Enabled="true"
                                                        runat="server">
                                                    </asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
       ...
       <%--     <div class="row" id="tr3" runat="server" style="margin-bottom: 30px">
                <div class="col-md-12" style="text-align: center">--%>
                  <div class="row" style="margin-top: 12px;">
                    ...
                    <asp:LinkButton ID="btnSave" runat="server" CssClass="btn btn-sample" 
                        CausesValidation="false" OnClick="btnSave_Click" TabIndex="43">
                                  <span class="glyphicon glyphicon-floppy-disk " style="color:White"> </span> Save
               
                    </asp:LinkButton>
                    <asp:LinkButton ID="btnCancel" runat="server" CssClass="btn btn-sample" 
                        CausesValidation="false" TabIndex="44" OnClick="btnCancel_Click">

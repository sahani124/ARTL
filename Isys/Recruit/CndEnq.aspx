...
<asp:content id="Content1" contentplaceholderid="ContentPlaceHolder1" runat="Server">
    ...
    <script>
         ...
         function checkCommValid() {
             debugger;
             var hdnflagval = document.getElementById("ctl00_ContentPlaceHolder1_hdnmdl").value;
             if (hdnflagval != '') {
                 if (hdnflagval == 'PospLicCpy' || hdnflagval == 'AgntLic' || hdnflagval == 'MISPLicCpy') {
                    ...
                    var startDate = convertDateFormat(fromdate);
                     ...
                     var MultiAgentBro = document.getElementById("ctl00_ContentPlaceHolder1_txtAgntBroker");
                     if (MultiAgentBro != '') {
                     var MultiAgentBroval = MultiAgentBro.value;
                     const commaCount = countCommas(MultiAgentBroval);
                     if (commaCount > 5) {
                         alert('Please enter maximum six agent broker code.');
                         return false;
                         }
                     }
                    // if (fromdate == '') {
                    //     alert('Please select Registration Date From');
                    //     return false;
                    // }
                    // if (toDate == '') {
                    //     alert('Please select Registration Date To');
                    //     return false;
                    // }
                    if (fromdate != '' && toDate != '') {
                        const dateCount = getDateCount(startDate, endDate);
                        if ((dateCount) > 31) {
                            alert('Date range should not be greater than 31 days.');
                            return false;
                        }
                    }
                    //else {
                    //    alert('Please select Registration date range');
                    //        return false;
                    //}
                 }
             }
               ...
               <%-- <div id="trPan" runat="Server" class="row rowspacing">
                ...
                <div id="trshowrecords" runat="server" class="row rowspacing">
                    ...
                    <div class="col-sm-4" style="text-align: left">
                        ...
                        <asp:DropDownList TabIndex="12" ID="ddlShwRecrds1" runat="server" CssClass="form-control form-select" AutoPostBack="true"
...
<%--                    <div class="col-sm-4" style="text-align: left">
                        ...
                        <div class="col-sm-12" align="center">
                            <div class="col-sm-12" align="center">
                                ...
                                <asp:LinkButton ID="btnSearch" runat="server" CssClass="btn btn-success" AutoPostback="false"
                                    OnClick="btnSearch_Click" TabIndex="15" OnClientClick="return checkCommValid();">
                    ...
                    <div id="trdgdtls"  runat="server" >
                        ...
                        <div id="trLICId" runat="server" visible="false" class="panel-body">
                            ...
                            <asp:GridView ID="GrdLicId" runat="server" AutoGenerateColumns="False" CssClass="footable"
                                ...
                                OnSorting="GrdLicId_Sorting" OnRowCommand="GrdLicId_RowCommand">
                                <RowStyle CssClass="GridViewRowNew"></RowStyle>
                                <PagerStyle CssClass="disablepage" />
                                <HeaderStyle CssClass="gridview th" />
                                <Columns>
                                    <%--added by ajay 28 july 2023 start--%>
                                    <asp:TemplateField HeaderStyle-Wrap="false" ItemStyle-Width="6%" HeaderText="Select All">
                                    <ItemTemplate>
                               ...
                               <ItemStyle HorizontalAlign="Center" CssClass="pad"  ></ItemStyle>
                                ...
                                <%--added by ajay 28 july 2023 end--%>
                                    ...
                                    <asp:TemplateField  
                                        HeaderText="License Copy" >
                                        <ItemTemplate>
                                            
                                            <asp:LinkButton ID="lnkIndvLic" runat="server" Text="" CommandArgument='<%# Eval("CandidateNo") %>'
                                                CommandName="License">
                                    ...
                                    <asp:TemplateField 
                                        HeaderText="ID Copy" >
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkIndvID" runat="server" Text="" CommandArgument='<%# Eval("CandidateNo") %>'
                                                CommandName="ID">
                                                <span class="glyphicon glyphicon-eye-open"></span>
                                            </asp:LinkButton>
                                        </ItemTemplate>
                               ...
                               <ItemStyle HorizontalAlign="Center" CssClass="pad"  ></ItemStyle>
                                ...
                                <%--added by ajay 28 july 2023 end--%>
                                        ...
                                        <HeaderStyle CssClass="clsCenter" />
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkPospLic" runat="server" Text="" CommandArgument='<%# Eval("CandidateNo") %>'
                                                            CommandName="PospAppointment" >
                                                        <span class="glyphicon glyphicon-eye-open"></span>
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                                      <ItemStyle CssClass="clsCenter" />
    ...
    <asp:HiddenField ID="hdnmdl" runat="server" />

...
public partial class Application_ISys_Recruit_Masters_PopMstEntyTbl : BaseClass
{
	...
	protected void FillControl(string EntyId)
	{
		...
		txtRefNo.Text = ds.Tables[0].Rows[0]["RefNo"].ToString().Trim();
		txtdteofInc.Text = ds.Tables[0].Rows[0]["DteCrptn"].ToString().Trim();
		ddlCnstn.SelectedValue = ds.Tables[0].Rows[0]["Constitution"].ToString().Trim();
		...
		txtcreatedte.Text = ds.Tables[0].Rows[0]["CreatedDate"].ToString().Trim();

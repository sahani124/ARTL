<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/iFrame.master" CodeFile="PopEvntIntrgMppng.aspx.cs"
    Inherits="Application_ISys_Recruit_Masters_PopEvntIntrgMppng" %>
...
<%--        function chosedate() {
    ...
    <script ="text/javascript">
        ...
        function BindMultiSelect() {
            $('#<%= ddlEvntNme.ClientID %>').multiselect({
                    ...
                    <div id="div2" runat="server" class="panel-heading subheader" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divRwd','Img3');return false;" style="width:96%;padding-left:0px">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left;padding-left:28px">
                                ...
                                <asp:Label ID="Label3" Text="Integration Event Mapping" CssClass="control-label HeaderColor" runat="server" />
                            </div>
                            <div class="col-sm-2">
...
<%--									<asp:DropDownList ID="ddlEvntNme" runat="server" CssClass="form-control">
                                    </asp:DropDownList> --%>      
									<asp:Listbox ID="ddlEvntNme" SelectionMode="Multiple" runat="server" CssClass="form-control">
                                    </asp:Listbox>   							
                        </div>
						 <div class="col-sm-4" style="text-align: left">
							 <br />
                                 <asp:LinkButton ID="btnSave" runat="server" OnClick="btnSave_Click" BorderColor="#00cccc" CssClass="btn btn-clear">
                                 <span class="glyphicon glyphicon-plus" style="color:#00cccc"> </span>
                                </asp:LinkButton>  
<%--                                     <asp:LinkButton ID="btnCancel" runat="server" OnClientClick="doCancel();" BorderColor="#00cccc" CssClass="btn btn-clear" TabIndex="44">
                                <span class="glyphicon glyphicon-remove" style="color:#00cccc"> </span>
                                </asp:LinkButton>--%>	
							 </div>
<%--                        <div class="col-sm-4" style="text-align: left">
                            ...
                            <PagerStyle CssClass="disablepage" />
                                        <Columns>
                                            <asp:TemplateField HeaderText="Integration Name" SortExpression="IntrgtNme">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIntrgtNme" runat="server" Text='<%# Bind("IntrgtNme")%>'></asp:Label>
													<asp:Label ID="lblIntrgtId" runat="server" Visible="false" Text='<%# Bind("IntrgtId")%>'></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="Event Name" SortExpression="EvntNme">
                                                <ItemStyle HorizontalAlign="Left" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblEvntNme" runat="server" Text='<%# Bind("EvntNme")%>'></asp:Label>
													<asp:Label ID="lblEvntId" runat="server" Visible="false" Text='<%# Bind("EvntId")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
...
<%--                                            <asp:TemplateField HeaderText="Action">
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkEditRwdTrg" OnClick="lnkEditRwdTrg_Click" runat="server" Text="delete"></asp:LinkButton>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" CssClass="clsCenter"/>
                                            </asp:TemplateField>
                                        </Columns>
                        ...
                        <center>
                            <div id="divRwdPgTrg" visible="true" runat="server" class="pagination" style="padding-top: 10px;padding-left:52px">
                                <center>
                                    <table>
                                        <tr>

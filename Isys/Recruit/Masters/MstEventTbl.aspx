<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/iFrame.master" CodeFile="MstEventTbl.aspx.cs"
    Inherits="Application_ISys_Recruit_Masters_MstEventTbl" %>
...
<%--        function chosedate() {
        ...
        function funEditPopUp(code) {
            var strContent = "ctl00_ContentPlaceHolder1_";
            $find("mdlVwQTrgBID").show();
            document.getElementById("ctl00_ContentPlaceHolder1_ifrmQualTrg").src = "PopMstEventTbl.aspx?EvntId=" + code + "&mdlpopup=mdlVwQTrgBID";
		}
                    ...
                    <div id="div2" runat="server" class="panel-heading subheader" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divRwd','Img3');return false;" style="width:96%;padding-left:0px">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left;padding-left:28px">
                                ...
                                <asp:Label ID="Label3" Text="Event Master Search" CssClass="control-label HeaderColor" runat="server" />
                            </div>
                            <div class="col-sm-2">
...
<%--						 <div class="col-sm-3" style="text-align: left">
					 ...
					 <div class="row" >
						 ...
						 <asp:TextBox ID="txtEvntNme" placeholder="Search Event" CssClass="form-control" style="margin-bottom:5px;width: 210px;display: inline;border:none;border-bottom:1px solid black" runat="server"  Font-Bold="False"></asp:TextBox>
                                 <asp:LinkButton ID="btnSave" runat="server" OnClick="btnSave_Click" BorderColor="White" CssClass="btn btn-clear">
                                 <span class="glyphicon glyphicon-search" style="color:#00cccc"> </span>
                                </asp:LinkButton>  
                                     <asp:LinkButton ID="btnCancel" runat="server" OnClick="btnCancel_Click" BorderColor="White" CssClass="btn btn-clear" TabIndex="44">
                            ...
                            <PagerStyle CssClass="disablepage" />
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Is Mandatory" SortExpression="IsMndtry">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIsMndtry" runat="server" Text='<%# Bind("IsMndtryDesc")%>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" CssClass="clsCenter"/>
                                            </asp:TemplateField>
                            ...
                            <PagerStyle CssClass="disablepage" />
                                        <Columns>
                                            <asp:TemplateField HeaderText="Event Code" SortExpression="EvntId">
                                                ...
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCodeInac" runat="server" Text='<%# Bind("EvntId")%>'></asp:Label>
                                                </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" CssClass="clsCenter"/>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Event Name" SortExpression="EvntNme">
                                                <ItemStyle HorizontalAlign="Left" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDesc1Inac" runat="server" Text='<%# Bind("EvntNme")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Is Active" SortExpression="IsActv">
                                                <ItemStyle HorizontalAlign="Center" />
                                            ...
                                            <asp:TemplateField HeaderText="Is Mandatory" SortExpression="IsMndtry">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIsMndtryInac" runat="server" Text='<%# Bind("IsMndtryDesc")%>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" CssClass="clsCenter"/>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Action">

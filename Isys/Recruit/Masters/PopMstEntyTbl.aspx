<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/iFrame.master" CodeFile="PopMstEntyTbl.aspx.cs"
    Inherits="Application_ISys_Recruit_Masters_PopMstEntyTbl" %>
...
<%--        $(function () {
        ...
        function chosedate() {
            debugger;
            $("#<%= txtdteofInc.ClientID  %>").datepicker({
                dateFormat: 'dd/mm/yy',
                changeMonth: true,
                changeYear: true
			});
                    ...
                    <div id="div2" runat="server" class="panel-heading subheader" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divRwd','Img3');return false;" style="width:96%;padding-left:0px">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left;padding-left:28px">
                                ...
                                <asp:Label ID="Label3" Text="Entity Master Setup" CssClass="control-label HeaderColor" runat="server" />
                            </div>
                            <div class="col-sm-2">
                    ...
                    <div id="divRwd" runat="server" style="width: 95%;display: block;" class="panel-body">
					 <div class="row rowspacing" >
                        <div class="col-sm-4" style="text-align: left">
                                ...
                                <asp:TextBox ID="txtEntyNme" CssClass="form-control" style="margin-bottom:5px;" runat="server" Font-Bold="False"></asp:TextBox>
							<%--<asp:DropDownList ID="ddlEntyNme" runat="server" CssClass="form-control">
                                    </asp:DropDownList>--%>
                            </div>
                        <div class="col-sm-4" style="text-align: left">
                                <asp:Label ID="lblAddress" runat="server" CssClass="control-label" Text="Address" Font-Bold="False"></asp:Label>
							     &nbsp;&nbsp
<%--                                    <asp:DropDownList ID="ddlIsMndatry" runat="server" CssClass="form-control">
										<asp:ListItem Value="Y" Text="YES"></asp:ListItem>
										<asp:ListItem Value="N" Text="NO"></asp:ListItem>
                                    </asp:DropDownList> --%> 
							<asp:TextBox ID="txtAddress" CssClass="form-control" style="margin-bottom:5px;" runat="server" Font-Bold="False"></asp:TextBox>
                        </div>
                        <div class="col-sm-4" style="text-align: left">
...
<%--                                    <asp:DropDownList ID="ddlIsActv" runat="server" CssClass="form-control">
					 ...
					 <div class="row rowspacing" >
                        <div class="col-sm-4" style="text-align: left">
                                <asp:Label ID="lblRefNo" runat="server" CssClass="control-label" Text="Reference Number" Font-Bold="False" ></asp:Label>
							<asp:TextBox ID="txtRefNo" CssClass="form-control" style="margin-bottom:5px;" runat="server" Font-Bold="False"></asp:TextBox>
                            </div>
                        <div class="col-sm-4" style="text-align: left">
                                <asp:Label ID="lbldteofInc" runat="server" CssClass="control-label" Text="Date of Incorporation" Font-Bold="False"></asp:Label>
							<asp:TextBox ID="txtdteofInc" CssClass="form-control" onmousedown="chosedate();" style="margin-bottom:5px;" runat="server" Font-Bold="False"></asp:TextBox>
                        </div>
                        <div class="col-sm-4" style="text-align: left">
                                <asp:Label ID="lblCnstn" CssClass="control-label" runat="server" Text="Constitution" Font-Bold="False"></asp:Label>
							<asp:DropDownList ID="ddlCnstn" runat="server" CssClass="form-control">
                                    </asp:DropDownList>
                        </div>
						 </div>
					 <div class="row rowspacing" >
                        ...
                        <div class="col-sm-4" style="text-align: left">
							...
							<asp:TextBox ID="txtcreatedte" CssClass="form-control" onmousedown="chosedate2();" style="margin-bottom:5px;" runat="server" Enabled="false" Font-Bold="False"></asp:TextBox>
                            </div>
						 </div>
					 <div class="row rowspacing" >
                        <div class="col-sm-4" style="text-align: left">

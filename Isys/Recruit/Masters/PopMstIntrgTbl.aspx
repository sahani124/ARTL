<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/iFrame.master" CodeFile="PopMstIntrgTbl.aspx.cs"
    Inherits="Application_ISys_Recruit_Masters_PopMstIntrgTbl" %>
                    ...
                    <div id="div2" runat="server" class="panel-heading subheader" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divRwd','Img3');return false;" style="width:96%;padding-left:0px">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left;padding-left:28px">
                                ...
                                <asp:Label ID="Label3" Text="Integration Master Setup" CssClass="control-label HeaderColor" runat="server" />
                            </div>
                            <div class="col-sm-2">
                    ...
                    <div id="divRwd" runat="server" style="width: 95%;display: block;" class="panel-body">
					 <div class="row rowspacing" >
                        <div class="col-sm-4" style="text-align: left">
							    ...
							    <asp:Label ID="lblIntgNme" runat="server" CssClass="control-label" Text="Name" Font-Bold="False" ></asp:Label>
...
<%--                                    <asp:DropDownList ID="ddlIsActv" runat="server" CssClass="form-control">
					 ...
					 <div class="row rowspacing" >
                        <div class="col-sm-4" style="text-align: left">
								...
								<asp:Label ID="lblURL" runat="server" CssClass="control-label" Text="URL" Font-Bold="False" ></asp:Label>
                                <asp:TextBox ID="txtURL" CssClass="form-control" style="margin-bottom:5px;" runat="server" Font-Bold="False"></asp:TextBox>
                            </div>
                        <div class="col-sm-4" style="text-align: left">
                                <asp:Label ID="lblUsrnm" runat="server" CssClass="control-label" Text="User Name" Font-Bold="False"></asp:Label>
                        ...
                        <div class="col-sm-4" style="text-align: left">
                                <asp:Label ID="lblPsswrd" CssClass="control-label" runat="server" Text="Password" Font-Bold="False"></asp:Label>
                                    <asp:TextBox ID="txtPsswrd" CssClass="form-control" style="margin-bottom:5px;" TextMode="Password" runat="server" Font-Bold="False"></asp:TextBox> 
                            </div>
						 </div>
					 <div class="row rowspacing" >
                        <div class="col-sm-4" style="text-align: left">
...
<%--                                    <asp:DropDownList ID="ddlIsLcns" runat="server" CssClass="form-control">
							...
							<asp:CheckBox ID="chbkIsLcns" runat="server" Checked="true"/>
                            </div>
                        <div class="col-sm-4" style="text-align: left">
                                <%--<asp:Label ID="lblSrtOrd" runat="server" CssClass="control-label" Text="Sort Order" Font-Bold="False" ></asp:Label>--%>
								<asp:Label ID="lblSrtOrd" runat="server" CssClass="control-label" Text="Execution Order" Font-Bold="False" ></asp:Label>
						...
						<div class="row rowspacing" >
                        <div class="col-sm-4" style="text-align: left">
                                <asp:Label ID="lblEntyeNm" CssClass="control-label" runat="server" Text="Entity Name" Font-Bold="False"></asp:Label>
                                    <asp:DropDownList ID="ddlEntyeNm" runat="server" CssClass="form-control">
                                    </asp:DropDownList>
                        </div>
                        <div class="col-sm-4" style="text-align: left">
...
<%--                        <div id="div5" runat="server" style="width: 100%; border: none; margin: 0px 0 !important;"
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="gv_DBFunction" runat="server" CssClass="footable"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Integration URL" SortExpression="IntrgtUrl">
                                                <ItemStyle HorizontalAlign="Left" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIntgURL" runat="server" Text='<%# Bind("IntrgtUrl")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="UserName" SortExpression="UsrNme">
                                                <ItemStyle HorizontalAlign="Left" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIntgUsrnme" runat="server" Text='<%# Bind("UsrNme")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Password" SortExpression="PassWrd">
                                                <ItemStyle HorizontalAlign="Left" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIntgPsswrd" runat="server" Text='<%# Bind("PassWrd")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Is License" SortExpression="IsLicens">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIsLicense" runat="server" Text='<%# Bind("IsLicens")%>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" CssClass="clsCenter"/>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkMapTrg" OnClick="lnkMapTrg_Click" runat="server" Text="Map with Event"></asp:LinkButton>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" CssClass="clsCenter"/>
                                            </asp:TemplateField>
                                        </Columns>
    ...
    <asp:Panel runat="server" Height="500px" Width="1020px" ID="pnlQualTrg" display="none" CssClass="panel panel-success"
        Style="text-align: center; padding: 10px;">

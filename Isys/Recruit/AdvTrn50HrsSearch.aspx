<%@ Page Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true" CodeFile="AdvTrn50HrsSearch.aspx.cs"
    Inherits="Application_INSC_Recruit_AdvTrn50HrsSearch" Title="Untitled Page" %>
        ...
        <div id="trSearchDetails" runat="server" class="panel-body panelContent">
          ...
          <%--  start added by sanoj for Qc Search- 29092022--%>
             <div class="row rowspacing">
              ...
              <div id="DivBrnch" class="row rowspacing" runat="server">
                  <div class="col-sm-4" style="text-align: left">
    ...
    <div id="divBrnuser" class="card PanelInsideTab_body" runat="server">
     ...
     <%--   <div  >--%>
            <div id="Div2" runat="server" class="HeaderColor" onclick="ShowReqDtl('ctl00_ContentPlaceHolder1_divIRCC','btnDeptMstGrd');return false;">
                <div class="row">
                    <div class="col-sm-4" style="text-align: left">
                        <asp:Label ID="Label3" runat="server" Text="Sponsorship Search Results" CssClass="control-label" style="font-size:19px;margin-left: 12px;">
                        </asp:Label>
                                            ...
                                            <asp:TemplateField SortExpression="Request" HeaderText="Action">
                                                <ItemTemplate>
                                                    <div style="width: 100%; white-space: nowrap;">
                                                        <asp:LinkButton ID="lblcfr" runat="server" Text='View CFR' CommandName="ViewCFR" CssClass="btn btn-success"

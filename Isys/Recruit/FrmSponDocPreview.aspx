<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true" CodeFile="FrmSponDocPreview.aspx.cs" Inherits="Application_ISys_Recruit_FrmSponDocPreview" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <td align="left" class="formcontent" style="width: 20%;">
        ...
        <table class="tableIsys" id="tblupload" runat="server" style="width: 90%;">
            ...
            <tr>
                <td class="test" colspan="3" style="text-align: left;">
                    <asp:Label ID="lblCanddoc" runat="server" Text="Candidate Document Upload" Font-Bold="true"></asp:Label>
                    <%--  Candidate Document Upload &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="txtcolr" runat="server" CssClass="standardtextbox" Width="20px"
      ...
      <center>
        <asp:Panel class="card" ID="Panelphoto2" runat="server"  Width="89%" Visible="true"  ScrollBars="Vertical">
            <asp:UpdatePanel runat="server" ID="upnlHeader">
                <ContentTemplate>
                <div id="Div11" runat="server" class="panel-heading" style="background-color: white !important;" onclick="ShowReqDtl('ctl00_ContentPlaceHolder1_divgrid','btnWfParam');return false;"> 
              
                 <div class="row" >
                          <div class="col-sm-10" style="text-align: center;margin-left:56px">
                            <asp:Label ID="lblpanelheader" runat="server" CssClass="control-label"  Font-Size="19px" Visible="false"/>
                    ...
                    <table class="modalpanel" style="display: none;border-color: #034ea2 !important;">
                        <tr>
                            <td>
                    ...
                    <%----%>
                    <div id="divgrid" runat="server" class="panel-body" style="width: 95%; height: 100%;"> <%--overflow: auto"--%>
                        <table style="border-collapse: separate; left: 0in; position: relative; top: 0px;
                            width: 100%;" class="tableIsys">
                             
                            <div class="row">
                                <div class="col-sm-12">
                                      <asp:GridView ID="GridImage" runat="server" AllowPaging="True" HorizontalAlign="Center"
                                            AutoGenerateColumns="False"
                                            PageSize="10" OnPageIndexChanging="GridImage_PageIndexChanging" OnRowDataBound="GridImage_RowDataBound">
                            ...
                            <AlternatingRowStyle CssClass="GridViewAlternateRow"></AlternatingRowStyle>
                                        <Columns>
                                            ...
                                            <asp:ImageField DataImageUrlField="ID" DataImageUrlFormatString="ImageCSharp.aspx?ImageID={0}"
                                                HeaderText="Preview Image" ControlStyle-Width="500px" ControlStyle-Height="370px">
                                                <ItemStyle CssClass="Pv" />
                                            </asp:ImageField>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <asp:Label ID="lblid" runat="server" CssClass="control-label"  Font-Size="16px" />
                                </div>
                            </div>
                        </table>
                    </div>
            ...
            <div class="row rowspacing">
                <div class="col-sm-12" style="text-align:center;">
                         ...
                         <%--   <asp:Button ID="btnClear" TabIndex="43" OnClick="btnClear_Click" runat="server" Text="Cancel"
                                ...
                                runat="server" 
                                CssClass="btn btn-success" onclick="btnClear_Click">
                                    <span class="glyphicon glyphicon-remove" style="color:White"> </span> Cancel
                                      </asp:LinkButton>
                                  <%--  Added by shreela on 14/07/2014 for renewals--%>
                            <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-clear" Width="114px" Text="CANCEl" Visible="false" OnClientClick="CloseSub()" />

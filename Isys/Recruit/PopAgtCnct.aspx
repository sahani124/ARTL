...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="panel hidScroll" id="divAlert">
                <div id="Div1" runat="server" class="panel-heading">
                    <div class="row" style="text-align: left">
                        <div class="col-sm-10">
                            <asp:Label ID="lblBS" runat="server" Text="Search Criteria" CssClass="control-label HeaderColor"></asp:Label>
                        </div>
                       <%-- <div class="col-sm-2">
                             ...
                             <div id="div2" style="margin-left: 2%; margin-right: 2%; margin-top: 0.5%" 
                                 ...
                                 <div id="tblDtl"  style='height: 50px;' runat="server">
                                     <div id="trtitle" runat="server" class="row">
                                         <div class="col-sm-5">
                                                 <asp:Label ID="lblprospectsearch" runat="server" Text="Search Results" CssClass="control-label HeaderColor"></asp:Label>

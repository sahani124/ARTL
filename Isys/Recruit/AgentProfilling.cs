...
public partial class Application_ISys_Recruit_AgentProfilling : BaseClass
{
    ...
    private void InitializeControl()
    {
        try
        {
            ...
            LblResCity.Text = olng.GetItemDesc("LblResCity");
            ...
            Lblmaritalstatus.Text = olng.GetItemDesc("Lblmaritalstatus");
            ...
            LblOtherinsAsso.Text = olng.GetItemDesc("LblOtherinsAsso");
            LblNameOtherinsAsso.Text = olng.GetItemDesc("LblNameOtherinsAsso");
            Lblfourwhler.Text = olng.GetItemDesc("Lblfourwhler");
            ...
            LblcridtCard.Text = olng.GetItemDesc("LblcridtCard");
            ...
            LblMthertong.Text = olng.GetItemDesc("LblMthertong");
            LblTypeofAgnt.Text = olng.GetItemDesc("LblTypeofAgnt");
            LblWrkExp.Text = olng.GetItemDesc("LblWrkExp");
            ...
            LblFinanceService.Text = olng.GetItemDesc("LblFinanceService");
            LblFinanceServiceName.Text = olng.GetItemDesc("LblFinanceServiceName");
            LblOthrRcl.Text = olng.GetItemDesc("LblOthrRcl");
            LblOthrRclName.Text = olng.GetItemDesc("LblOthrRclName");
            ...
            LblmtrBusns.Text = olng.GetItemDesc("LblmtrBusns");
            LbltrvlBusns.Text = olng.GetItemDesc("LbltrvlBusns");
            LblhealthBusns.Text = olng.GetItemDesc("LblhealthBusns");
            LblCLBusns.Text = olng.GetItemDesc("LblCLBusns");
            LblTotalBusns.Text = olng.GetItemDesc("LblTotalBusns");
            LblOthrGI.Text = olng.GetItemDesc("LblOthrGI");
            LblStaldaloneGI.Text = olng.GetItemDesc("LblStaldaloneGI");
        }
        catch (Exception ex)
        {
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Label3.Text = "Agent Profile data save sucessfully <br/>" + "Candidate No: " + lblCndNoValue.Text + "<br/>Application No: " + lblAppNoValue.Text + "<br/>Agent Name: " + TxtMtrName.Text;
            ...
            Logger.LogInfo("Before agent update UpdateCndTask(1_" + txtaadhr.Text + "@" + "" + "@" + "" + "@" + "" + "@" + txtGivenName.Text + "@" + "" + "@" + txtapplicationno.Text + "@" + "Prospect Reg" + "@" + "" + "@" + ddlDstbnMethod.SelectedItem.Text + "@" + txtapplicationno.Text
+ "@" + "" + "@" +
true + "@" + true + "@" + true + "@" + true + "@" + "" + "@" + txtemail.Text + "@" + "" + "@" + "" + "@" + "" + "@" + true + "@" + "" + "@" + "" + "@" + cboGender.SelectedItem.Text + "@" +
"" + "@" + true + "@" + "" + "@" + "" + "@" + "" + "@" + txtMobileTel.Text + "@" + "" + "@" + "" + "@" + txtEmpCode.Text + "@" + true + "@" + true + "@" + "" + "@" + txtEmpCode.Text + ")");

            ObjTask.UpdateCndTask(txtaadhr.Text, "", "", txtaddofemp1.Text, txtGivenName.Text, "", txtapplicationno.Text, "Pending for Agent Profiling", "", ddlDstbnMethod.SelectedItem.Text, txtapplicationno.Text
                , "",
                true, true, true, true, "", txtemail.Text, "", "", "", true, "", "", cboGender.SelectedItem.Text,
                "", true, "", "", "", txtMobileTel.Text, "", "", txtEmpCode.Text, true, true, "", txtEmpCode.Text);  //To create task in CRM 

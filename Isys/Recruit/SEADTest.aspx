    ...
    <ContentTemplate>
        ...
        <div id="divCount" runat="server" visible="false">
            <div class="col-md-12" style="background-color: #f7f7f7;">
                <h3 class="page-title" style="font-family: Tahoma;">
                   <b> <font size="8" color="darkblue"></font> <font size="8" color="red"></font></b>DashBoard <small>statistics and more</small>
                </h3>
                <table class="page-breadcrumb breadcrumb" width="100%" style="background-color: antiquewhite;">
                    <tr>
                        <td style="font-family: VAG Rounded std bold; padding-left: 10px;">
                        ...
                        <td align="right" style="font-family: VAG Rounded std bold; padding-right: 10px;">
                ...
                <table width="100%" align="center" class="tableIsys">
                        ...
                        <td>
                            <table width="100%">
                                <tr>
                                    ...
                                    <td style="width: 25%;">
                                        <div style="height: 100px; width: 217px; background-color: #28b779;margin-left:20%;">
                                            <table align="center" style="width: 90%">
                                                <tr style="height: 20%">
                                                    <td rowspan="2" style="width: 20%; color: White;">
                                    ...
                                    <td style="width: 25%;">
                                        <div style="height:100px; width: 213px; background-color: #852b99;margin-left:16%;">
                                            <table align="center" style="width: 90%">
                                                <tr style="height: 20%">
                                                    <td rowspan="2" style="width: 20%; color: White;">
                                    ...
                                    <td style="width: 25%;">
                                        <div style="height: 100px; width: 213px; background-color: #87CEEB;margin-left:34%;">
                                            <table align="center" style="width: 90%">
                                                <tr style="height: 20%">
                                                    <td rowspan="2" style="width: 20%; color: White;">
                    ...
                    <tr id="trCandidate" runat="server">
                       ...
                       <td  style="width:7%">
                        ...
                        <td  style="width:47%">
                            <div class="portletIsys" style="border: 1px solid  #17a668;height:196px;">
                                <div class="portletIsys-title" style="background-color: #382982;">
                                    <i class="fa fa-User" style="padding-left: 5px; padding-top: 10px; color: White">
                                    </i>&nbsp;
    ...
    <div id="divSead" runat="server" >
     <table   border="0" cellpadding="1" cellspacing="0" width="60%" align="center" class="table">
            ...
            <tr style="width: 60%;" valign="middle" class="portlet-title">
                <td align="left" colspan="2">
                    ...
                    <div style="float: left; width: 100%; white-space: nowrap;" align="left">
                        <blockquote>
                            <p>
                                Hi <asp:Label ID="lblName" Font-Names="VAG Rounded std bold" runat="server" />!<br />
            ...
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label Text="1.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                            <asp:Button ID="btn1a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                                OnClientClick="javascript:changeTitleText('btn1a');return false;" CssClass="btn btn-xs blue"
                                Width="30%" Text="-" />
                <td>
                    <asp:Label ID="lbl1a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label1" Text="1.B" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn1b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn1b');return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl1b" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label3" Text="2.A" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn2a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                ...
                <td>
                    <asp:Label ID="lbl2a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label8" Text="2.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn2b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn2b'); return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl2b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label10" Text="3.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn3a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn3a');return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl3a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label12" Text="3.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn3b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn3b'); return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl3b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label14" Text="4.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn4a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn4a');return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl4a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label16" Text="4.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn4b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn4b'); return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl4b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label18" Text="5.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn5a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn5a');return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl5a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label20" Text="5.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn5b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn5b'); return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl5b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label22" Text="6.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn6a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn6a');return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl6a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label24" Text="6.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn6b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn6b'); return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl6b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label26" Text="7.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn7a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn7a');return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl7a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label28" Text="7.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn7b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn7b'); return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl7b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label30" Text="8.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn8a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn8a');return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl8a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label32" Text="8.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn8b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn8b'); return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl8b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label34" Text="9.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn9a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn9a');return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl9a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label36" Text="9.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn9b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn9b'); return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl9b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label38" Text="10.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn10a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn10a');return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl10a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label40" Text="10.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn10b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn10b'); return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl10b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label42" Text="11.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn11a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn11a');return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl11a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label44" Text="11.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn11b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn11b'); return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl11b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label46" Text="12.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn12a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn12a');return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl12a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label48" Text="12.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn12b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn12b'); return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl12b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label50" Text="13.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn13a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn13a');return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl13a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label52" Text="13.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn13b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn13b'); return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl13b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label54" Text="14.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn14a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn14a');return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl14a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label56" Text="14.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn14b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn14b'); return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl14b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label58" Text="15.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn15a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn15a');return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl15a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label60" Text="15.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn15b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn15b'); return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl15b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label62" Text="16.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn16a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn16a');return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl16a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label64" Text="16.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn16b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn16b'); return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl16b" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label66" Text="17.A" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn17a" runat="server" ForeColor="Black" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn17a');return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl17a" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label68" Text="17.B" runat="server" Font-Names="VAG Rounded std bold" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn17b" runat="server" ForeColor="Black" Font-Names="Tahoma" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn17b'); return false;" CssClass="btn btn-xs blue" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl17b" runat="server" ForeColor="Black" Font-Names="Tahoma" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label70" Text="18.A" runat="server" ForeColor="Black" Font-Names="Tahoma"
                        Font-Size="14.5px" Width="30px" />
                    <asp:Button ID="btn18a" runat="server" ForeColor="Black" Font-Names="Tahoma" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn18a');return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl18a" runat="server" Font-Names="Tahoma" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td class="style1">
                    <asp:Label ID="Label72" Text="18.B" runat="server" Font-Names="Tahoma" Font-Size="14.5px"
                        Width="30px" />
                    <asp:Button ID="btn18b" runat="server" ForeColor="Black" Font-Names="Tahoma" Font-Size="14.5px"
                        OnClientClick="javascript:changeTitleText('btn18b'); return false;" CssClass="btn btn-xs green" Width="30%"
                         Text="-" />
                </td>
                <td>
                    <asp:Label ID="lbl18b" runat="server" ForeColor="Black" Font-Names="Tahoma" Font-Size="14.5px" />
                </td>
            </tr>
            <tr style="width: 60%;" valign="middle">
                <td colspan="2">
                    ...
                    <asp:UpdatePanel runat="server" ID="UpdPnl_Submit" UpdateMode="Conditional">
                        <ContentTemplate>
                           <%-- <div class="btn btn-primary btn-xs" style="white-space:nowrap; width:110px;">
                                ...
                                <asp:Button Text="Submit" runat="server" CssClass="standardbutton" ID="btnSubmit"
                                    OnClick="btnSubmit_Click" Width="85px"/>
                          <%--  </div>--%>
                            <span style="padding-left: 3px;"></span>
                           <%-- <div class="btn btn-primary btn-xs" style="white-space:nowrap; width:110px;">
                                <i class="fa fa-times"></i>--%>
                                <asp:Button Text="Cancel" runat="server" CssClass="standardbutton" 
                                    ID="btnCancel" onclick="btnCancel_Click" Width="90px"/>
                          <%--  </div>--%>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </td>

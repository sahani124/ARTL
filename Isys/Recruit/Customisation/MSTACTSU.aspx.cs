...
public partial class Application_Isys_Saim_Customisation_MSTACTSU : BaseClass
{
    ...
    protected void ChkPrntAct()
    {
        try
        {
            ...
            dsPrnt = objDal.GetDataSetForPrcRecruit("PRC_CHK_ACT_NO", htParam);
    ...
    protected void getActionNo()
    {
        ...
        DataSet ds = new DataSet();
        ds = objDal.GetDataSetForPrcRecruit("PRC_GET_ACTIONNO", htable);
    ...
    protected void getExecutionOrder()
    {
       ...
       // htable.Add("@action_type", Request.QueryString["ACT_TYPE"].ToString());
        htable.Add("@action_type","1001");
        DataSet ds = new DataSet();
        ds = objDal.GetDataSetForPrcRecruit("PRC_GET_ExecutionOrder", htable);
    ...
    protected void SaveData()
    {
        try
        {
            ...
            DataSet ds = new DataSet();
            ds = objDal.GetDataSetForPrcRecruit("prc_ins_MST_ACT_SU", htable);
    ...
    protected void Fillddl(DropDownList ddl)
    {
        try
        {
           ...
           // drRead = objDal.Common_exec_reader_prc_SAIM("Prc_get_actionType", ht);
            drRead = objDal.Recruit_exec_reader_prc("Prc_get_actionType", ht);
    ...
    protected void FillActNo()
    {
        ...
        dsDDL = objDal.GetDataSetForPrcRecruit("PRC_GET_ACTIONNO", htable1);
    ...
    protected void BindActionGrid()
    {
        try
        {
            ...
            ds = objDal.GetDataSetForPrcRecruit("PRC_GET_ACTIONDATA", htParam);
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (flag)
            {
                ...
                DataSet ds = new DataSet();
                ds = objDal.GetDataSetForPrcRecruit("PRC_UPD_MST_ACT_SU", ht);
    ...
    protected void lnkDelAct_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ds = objDal.GetDataSetForPrcRecruit("PRC_DEL_ACTIONDATA", htParam);
    ...
    protected void btnY_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                ds = objDal.GetDataSetForPrcRecruit("PRC_INS_PRNT_ACT_NO", htParam);

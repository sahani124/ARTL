    ...
    <br />
        <center>
                ...
                <div class="card PanelInsideTab">
                    <div id="Div1" runat="server" class="panel-heading" onclick="ShowReqDtl('ctl00_ContentPlaceHolder1_divSearch','btnWfParam');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                <asp:Label ID="lblTitle" runat="server" CssClass="control-label" Font-Size="19px">ARF Upload</asp:Label>
                            </div>
                            <div class="col-sm-2">
                    ...
                    <div id="divSearch" runat="server" style="display:block;margin-top:36px;" class="panel-body">
                     <%--  <asp:UpdatePanel ID="updfile" runat="server">
                        <ContentTemplate>--%>
                        <div class="row" style="text-align:left">
                            
                                <asp:Label ID="lblUpload" runat="server" CssClass="control-labels"></asp:Label>
                            
                            </div>
                            <div class="row"style="text-align:left">
                            <div class="col-sm-6" style="text-align:left;">
                                <asp:DropDownList ID="ddlUpload" runat="server" CssClass="form-control form-select" DataTextField="ParamDesc"
                                    DataValueField="ParamValue" AutoPostBack="true" OnSelectedIndexChanged="ddlUpload_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                            <div class="col-sm-3" style="text-align:left;">
                                <asp:LinkButton ID="btnUpldFrmt" runat="server" CssClass="btn btn-success" OnClick="btnUpldFrmt_Click" style="height: 34px;"
                                    TabIndex="32">
                       ...
                       <br />
                        <div class="row" style="text-align:left">                           
                                <asp:Label ID="lblFileUpload" CssClass="control-labels" runat="server" ></asp:Label>
                            </div>
                        <div class="row">
                            <div class="col-sm-6" style="text-align:left;">
                      ...
                      <br/>
                         ...
                         <div class="row" >
                             <div class="col-sm-12" align="center">
                                 <asp:LinkButton ID="btn_Upload" runat="server" CssClass="btn btn-success" OnClick="btn_Upload_Click"
                                     TabIndex="32">
                                    <span   class="glyphicon glyphicon-upload" style="color:white"></span> UPLOAD
                                 </asp:LinkButton>
                                 &nbsp;
                                 <asp:LinkButton ID="btn_Validate" runat="server" CssClass="btn btn-success" OnClick="btn_Validate_Click"
                                     TabIndex="32">
                                    <span   class="glyphicon glyphicon-exclamation-sign" style="color:white"></span> VALIDATE
                                 </asp:LinkButton>
                                  &nbsp;
                                 <asp:LinkButton ID="btn_Process" runat="server" CssClass="btn btn-success" OnClick="btn_Process_Click"
                                     TabIndex="32">
                                    <span   class="glyphicon glyphicon-saved" style="color:white"></span> PROCESS
                                 </asp:LinkButton>
                                  &nbsp;
                                 <asp:LinkButton ID="btn_Cancel" runat="server" CssClass="btn btn-clear" CausesValidation="False"
                        ...
                        <div class="row" id="tbl_grid" runat="server" style="display: none">
                            <div class="panel">
                                <div class="panel-heading subheader" onclick="ShowReqDtl('ctl00_ContentPlaceHolder1_divSearchDetails','btnUploadDtls');return false;"
                                    ...
                                    <div class="col-sm-2">
                                        <span id="btnUploadDtls" class="glyphicon glyphicon-chevron-down" style="float: right;
                                            padding: 1px 10px ! important; font-size: 18px;"></span>
                                    </div>
                            ...
                            <div class="panel">
                                  <div class="panel-heading" onclick="ShowReqDtl('ctl00_ContentPlaceHolder1_divValid','btnValid');return false;"
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-sm-2">
                                            <span id="btnValid" class="glyphicon glyphicon-chevron-down" style="float: right;
                                                 padding: 1px 10px ! important; font-size: 18px;"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel-heading subheader" onclick="ShowReqDtl('ctl00_ContentPlaceHolder1_trError','btnValidLog');return false;"
                                  >
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <span id="btnValidLog" class="glyphicon glyphicon-chevron-down" style="float: right;
                                                padding: 1px 10px ! important; font-size: 18px;"></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <br/>
                            ...
                            <div class="panel">
                                <div class="panel-heading subheader" onclick="ShowReqDtl('ctl00_ContentPlaceHolder1_trSuccess','btnValidSuccess');return false;"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <span id="btnValidSuccess" class="glyphicon glyphicon-chevron-down" style="float: right;
                                                padding: 1px 10px ! important; font-size: 18px;"></span>
                                        </div>
                                    </div>
                                </div>
                         ...
                         <div class="row" style="padding-bottom: 6px ! important;">
                            <div class="col-md-12" style="text-align: center">
                                <asp:LinkButton ID="btnExport" runat="server" CssClass="btn btn-success"
                         ...
                         <span class="glyphicon glyphicon-download BtnGlyphicon"></span> Export Errors</asp:LinkButton>
                                    ...
                                    <asp:LinkButton ID="btnFailCase" runat="server" Visible="false" CssClass="btn btn-success" OnClick="btnFailCase_Click" >
                ...
                <asp:HiddenField ID="hdnModuleID" runat="server" /> <%--added by sanoj 31012023--%>
    ...
    <div class="modal-dialog modal-sm" style="width:300px;">
      ...
      <div class="modal-content" >
        <%--<div class="modal-header" style="background-color:white !important;">--%>
            <asp:Label ID="Label3" Text="INFORMATION" runat="server" style="font-weight:bold;margin-left: 83px;color: blue;font-size: 20px;margin-top: 20px;"></asp:Label>
      ...
      <%--  </div>--%>
        ...
        <%--<div class="modal-footer" style="text-align: center">--%>
          <button type="button" class="btn btn-success" data-dismiss="modal" style='margin-bottom: 18px;width: 69px;margin-left: 114px;' >

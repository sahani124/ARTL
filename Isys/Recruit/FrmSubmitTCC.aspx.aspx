                      ...
                      <div class="col-sm-4" style="text-align: left" >
                       ...
                       <asp:TextBox ID="lblTrnHrsValue1" runat="server" CssClass="form-control" disabled="disabled"></asp:TextBox>
                              ...
                              <%--</div>--%>
                               ...
                               <div id="divExm" runat="server" visible="false">  <%--style=" margin-left:-89px;margin-right:-13px;"--%>
...
<%--                     </div>
                        ...
                        <asp:Label ID="lblExmDt" runat="server"  CssClass="control-label labelSize" ></asp:Label>
                            ...
                            <ContentTemplate>
                             ...
                             <div class="col-sm-4" style="text-align: left" >
                       <asp:TextBox ID="lblExmDtValue" CssClass="form-control" runat="server" Text="System Exam Date" placeholder="dd/mm/yyyy"></asp:TextBox>
...
<%--                    <span style="color:Red">*</span> --%>
                        <asp:Label ID="lblNpreexamlng" runat="server" class="control-label labelSize" Font-Bold="False" style="color:Black"></asp:Label>                         
                          ...
                          <div class="row" style="padding-left:20px;">
                            ...
                            <ContentTemplate>
                            <asp:DropDownList ID="ddlNExam" runat="server"  AutoPostBack="true" CssClass="form-control mandatory" OnSelectedIndexChanged="ddlNExam_SelectedIndexChanged"> 
                                </asp:DropDownList>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                      </div>
                        ...
                        <asp:UpdatePanel ID="UpdNExmBody" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlNExmBody" runat="server" cssclass="form-control mandatory " OnSelectedIndexChanged="ddlNExmBody_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                      </div>
                          <div class="col-sm-4" style="text-align: left" >
                            ...
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlNpreeamlng" runat="server" CssClass="form-control mandatory" OnSelectedIndexChanged="ddlNpreeamlng_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList> 
                            </ContentTemplate>
                        </asp:UpdatePanel>
                      </div>
                     ...
                     <%-- <span style="color:Red">*</span>--%>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            ...
                            <asp:DropDownList ID="ddlExmCentre" runat="server" CssClass="form-control" Visible="false"> 
                                ...
                                <asp:TextBox ID="txtExmCntr" runat="server" Enabled="false" CssClass="form-control" 
                                            Visible="true"></asp:TextBox>
                                      <span class="input-group-btn input-addon_extended">
                                         <asp:LinkButton ID="btnExmCentre" runat="server" CausesValidation="False"   CssClass="btn btn-clear"
                                           Text="Search" />
                                        </span>
...
<%--                                  <span class="glyphicon glyphicon-remove" style="color:White"></span> CANCEL--%>
                                  ...
                                  <asp:LinkButton ID="btnCancel" runat="server" Visible="false" OnClientClick="funcClear()" class="glyphicon glyphicon-remove"  CssClass="btn btn-clear" Text="CANCEL" OnClick="btnClear_Click" style="border: 2px solid;border-radius: 5px;color:#f04e5e"
                                  TabIndex="43">
                                  <%--<span class="glyphicon glyphicon-remove" style="color:White"> </span> CANCEL--%>
                                </asp:LinkButton>
                                </div>
...
<%--                    commit by pallavi on 10102022--%>
      ...
      <%-- added by shreela on 25-04-2014 for Renewal Details start--%>
       ...
       <%-- added by shreela on 25-04-2014 for Renewal Details end--%>   
          ...
          <div id="tblPrefExm" runat="server"  visible="false" class="panel  ">
...
<asp:Label ID="waitingMsg" runat="server" Text="Please wait..." ForeColor="red"></asp:Label>
        ...
        <asp:Panel runat="server" ID="PnlExm" Width="600" Height="350" display="none">

...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   <script type="text/javascript" src="/../Script/COMM/CalendarControl.js"></script>
    ...
    <script type="text/javascript">
        ...
        function DatetxtYrPass() {
         ...
         function DatetxtPreDate() {
            $("#<%= txtPreDate.ClientID  %>").datepicker({
                dateFormat: 'dd/mm/yy',
                changeMonth: true,
                changeYear: true,
                maxDate:'0'
    ...
    <script type="text/javascript">
        ...
        function ValidationPAN() {
            ...
            if (varPAN.length == 0) {
                ...
                document.getElementById('<%= txtNomnPan.ClientID %>').focus();
                return false;
            }
            if (varPAN.length < 10) {
               <%-- document.getElementById('<%=lblPANMsg.ClientID%>').innerHTML = '';
        ...
        function AddValid() {
            ...
            //    alert("Please Enter Present Address Line3");
        ...
        function BankValid() {
            ...
            //Bank Name
            if (document.getElementById(strContent + "txtbnkname").selectedIndex == 0) {
        ...
        function NomieeVali() {
            ...
            if (document.getElementById(strContent + "Ddlrelation").selectedIndex == 0) {
                alert("Please select Relationship to Advisor");
            ...
            //Branch Name
            if (document.getElementById(strContent + "ddlnmBnkname").selectedIndex == 0) {
                alert("Please Enter branch Name");
        ...
        function funexm() {
            ...
            if (document.getElementById("ctl00_ContentPlaceHolder1_ddlpreeamlng").selectedIndex == 0) {
                    alert("Please Select Prefer Exam Language");
            ...
            if (document.getElementById(strContent + "txtPreDate").value == "")//txtYrPass_txtDate
            {
                alert("Please Enter Preferred Date");
                document.getElementById("ctl00_ContentPlaceHolder1_txtPreDate").focus();
                return false;
                }
        ...
        <ContentTemplate>
            ...
            <div class="stripPanelClass">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link Strip" id="divPAH" runat="server" data-bs-toggle="tab" data-bs-target="#divPA" type="button" role="tab" aria-controls="divPA" aria-selected="false"><span id="span4" runat="server" class="badge bg-secondary numbercircle ">4</span>&nbsp Address Detailss</button>
                    </li>
    ...
    <div class="card PanelInsideTab">
            ...
            <div  id="divPannel1" runat="server" visible="false">
                ...
                <div id="divPersonal" style="display: block;" runat="server" class="panel-body panelContent">
                    <div class="row rowspacing">
                        ...
                        <div class="col-sm-4" style="text-align: left">
                            ...
                            <asp:TextBox ID="txtregdate" runat="server" CssClass="form-control mandatory" Enabled="False" ReadOnly="true"
                    ...
                    <div class="row rowspacing">
                        <div class="col-sm-1">
                            ...
                            <asp:DropDownList ID="cboTitle" runat="server" CssClass="form-control form-select PrefixDll mandatory" DataTextField="ParamDesc" style="text-align:left;" OnSelectedIndexChanged="cboTitle_SelectedIndexChanged"
                                DataValueField="ParamValue" AppendDataBoundItems="True" DataSourceID="dscbotitle" AutoPostBack="true" Width="90px"
                                TabIndex="10">
                            </asp:DropDownList>
                            <%--  </span>--%>
                            <%-- </div>--%>
                        ...
                        <div class="col-sm-4" style="text-align: left;">
                             <asp:Label ID="lblMiddleName" runat="server" Text="Surname" CssClass="control-label labelSize"></asp:Label></span>
                                    <asp:TextBox ID="txtsurname" runat="server" CssClass="form-control mandatory" TabIndex="13"
                                            onChange="javascript:this.value=this.value.toUpperCase();"
                    ...
                    <div class="row">
                        <div class="col-sm-4" style="text-align: left">
                            <asp:TextBox CssClass="form-control mandatory" onmousedown="Datedob();" placeholder="DOB (dd/mm/yyyy)"
                    ...
                    <div class="row rowspacing">
                        ...
                        <div class="col-sm-4" style="text-align: left">
                            <asp:Label ID="lblPrimProf" runat="server" CssClass="control-label labelSize" Text="Current Occupation"></asp:Label>
  ...
  <asp:TextBox ID="TxtAnnivrsryDt" runat="server" CssClass="form-control" MaxLength="12" TabIndex="23" onmousedown="AnnvDte ();" placeholder="Anniversary Date"> </asp:TextBox>
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtNationalCode" runat="server" Style="margin-bottom: 20px;" CssClass="form-control mandatory" onChange="javascript:this.value=this.value.toUpperCase();"
                                        Enabled="False" MaxLength="3" TabIndex="24" Width="90px"></asp:TextBox>
                                </div>
                                <div class="col-sm-9">
                        ...
                        <div class="col-sm-4">
                            ...
                            <asp:DropDownList ID="ddlFessWav" runat="server" TabIndex="23" CssClass="form-control form-select" Visible="false">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-lg-9">
                                                <asp:TextBox ID="txthometel" runat="server"
                                                    ...
                                                    Placeholder="Not start with 0 and accept 10 digit" TabIndex="145"></asp:TextBox>
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-9">
                                                <asp:TextBox ID="txtMobileTel" runat="server" CssClass="form-control mandatory"
                                                    Placeholder="Mobile No should be 10 digit." MaxLength="10" TabIndex="147"></asp:TextBox>
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-9">
                                                    ...
                                                    <asp:TextBox ID="txtMobile2" runat="server" CssClass="form-control"
                                                        MaxLength="10" TabIndex="146"></asp:TextBox>
                                ...
                                <div class="row rowspacing">
                                    <div class="col-sm-4">
                                        ...
                                        <asp:TextBox ID="txtWorkTel" runat="server" CssClass="form-control"
                                            MaxLength="10" TabIndex="148"></asp:TextBox>
                                    ...
                                    <div class="col-sm-4" style="text-align: left">
                                        ...
                                        <asp:TextBox ID="txtemail" runat="server" CssClass="form-control mandatory"
                                            MaxLength="50" TabIndex="149"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-4" style="text-align: left">
                                        <span>
                ...
                <asp:UpdatePanel ID="UpdatePanel22" runat="server">
                    <ContentTemplate>
                        <div  style="margin-left: 0px; margin-right: 0px">
                            ...
                            <div id="divRecruitInformation" style="display: block;" runat="server" class="panel-body panelContent">
                                <div class="row">
                                    <div class="col-sm-4">
                                ...
                                <div class="row ">
                                    ...
                                    </div><%--class="glyphicon glyphicon-search BtnGlyphicon"--%>
                                </div>
                                <div class="row rowspacing">
                                    <div class="col-sm-4" style="text-align: left">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3" style="text-align: left">
                                                <asp:UpdatePanel ID="UpdatePanel21" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlState" runat="server" CssClass="form-control form-select mandatory" Style="width: 108% !important"
                                                            TabIndex="107">
                                                        </asp:DropDownList>
                                            ...
                                            <div class="col-sm-1">
                                                <asp:LinkButton ID="btnstatesearch" runat="server" CssClass="btn btn-verify btnColor btncolor1" TabIndex="113" OnClick="btnstatesearch_Click">
                                      <span> SEARCH </span>    
                                                </asp:LinkButton>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <asp:TextBox ID="txtCountryCodeP" runat="server" CssClass="form-control mandatory"
                                                    ...
                                                    MaxLength="3" TabIndex="121" Width="90px"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-9">
            ...
            <div  id="divpanel5" runat="server" visible="false">
                <div  style="margin-left: 0px; margin-right: 0px">
                    ...
                    <div id="divbnkdtls" style="display: block;" runat="server" class="panel-body panelContent">
                        <div class="row rowspacing">
                            <div class="col-sm-4" style="text-align: left">
                            ...
                            <div class="col-sm-4">
                                <asp:Label ID="lblbnkname" runat="server" CssClass="control-label labelSize"></asp:Label>
                                    <%--<asp:TextBox ID="txtbnkname" runat="server" CssClass="form-control mandatory" TabIndex="182" MaxLength="100" onChange="javascript:this.value=this.value.toUpperCase();"></asp:TextBox>--%>
                        ...
                        <div class="row rowspacing">
                            <div class="col-sm-4" style="text-align: left">
                                ...
                                <asp:TextBox ID="txtmicrcode" runat="server" CssClass="form-control mandatory" TabIndex="186" MaxLength="9"></asp:TextBox>
                            ...
                            <div class="col-sm-4" style="display:none;">
                                ...
                                <asp:TextBox ID="txtremakrs" runat="server"
                                    CssClass="form-control" TabIndex="185" MaxLength="11"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div  style="margin-left: 0px; margin-right: 0px">
                            ...
                            <div id="divNomineeDetails" style="display: block;" runat="server" class="panel-body panelContent">
                                <div class="row rowspacing">
                                    ...
                                    <div class="col-sm-4" style="text-align: left">
                                        <asp:Label ID="Label7" Text="Relationship to Advisor" runat="server" CssClass="control-label labelSize"></asp:Label>
                                ...
                                <div class="row rowspacing">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel39" runat="server">
                                            <ContentTemplate>
                                                <asp:TextBox ID="txtNomnPan" runat="server" CssClass="form-control" MaxLength="10" onmousedown="NMPan();"
                                ...
                                <asp:Label ID="lblnmbnkhldname" runat="server" Text="Account Holder Name" CssClass="control-label labelSize"></asp:Label>
                                   ...
                                   <asp:DropDownList ID="ddlnmBnkname" runat="server" CssClass="form-control form-select" TabIndex="84" >
                                    <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                                    <asp:ListItem Text="IDBI" Value="IDBI"></asp:ListItem>
                                    <asp:ListItem Text="HDFC" Value="HDFC"></asp:ListItem>
                                    </asp:DropDownList>
                                ...
                                <div class="row rowspacing">
                                    ...
                                    <div class="col-sm-4">
                                     ...
                                     <div class="col-sm-4">
                                        ...
                                        <%--<asp:DropDownList ID="ddlnmifscode" runat="server" CssClass="form-control" Style="width: 100%" TabIndex="184">
                                            <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                                        </asp:DropDownList>--%>
                                        <asp:TextBox ID="ddlnmifscode" runat="server" CssClass="form-control" TabIndex="87" MaxLength="11" onmousedown="NomieeIfsc();"></asp:TextBox>
                                    </div>
                                    </div>
                                <div class="row rowspacing">
            ...
            <div  id="divpanel7" runat="server" visible="false">
                <div >
                    ...
                    <div id="divProofofDocument" runat="server" class="panel-body panelContent">
                        <div class="row rowspacing">
                            <div class="col-sm-4">
                        ...
                        <div class="row rowspacing">
                         ...
                         <div class="row">
                             <div class="col-sm-4">
                                     <asp:TextBox ID="txtYrPass" runat="server" CssClass="form-control mandatory" onmousedown="DatetxtYrPass()"  placeholder="Date of Passing (dd/mm/yyyy)"
                ...
                <div >
                    <div id="Div4" runat="server" >
                        ...
                        <div id="div5" runat="server" class="panel-body panelContent">
                            <div class="row rowspacing">
                                <div class="col-sm-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <asp:UpdatePanel ID="updExmCentre" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtExmCentre" runat="server" CssClass="form-control mandatory" Enabled="false" Width="275px"
                                ...
                                <div class="col-sm-1">
                                    <asp:Button ID="btnExmCentre" runat="server" CssClass="btn btn-success"  CausesValidation="False" style="width:61px;height:34px"
                                        Text="..." TabIndex="99" />
                                </div>
                            </div>
                            <div class="row rowspacing">
            ...
            <div  id="divpanel8" runat="server" visible="false">
                <div  style="margin-left: 0px; margin-right: 0px">
                    ...
                    <div id="divQPersonal" runat="server" style="display: block" class="panel-body panelContent" width="100%;">
                        <div class="row rowspacing">
                            <div class="col-sm-4" style="text-align: left">
                ...
                <div  style="margin-left: 0px; margin-right: 0px">
                    ...
                    <div id="div3" runat="server" style="display: block;" class="panel-body panelContent">
                        <div class="row rowspacing">
                            <div class="col-sm-4" style="text-align: left">
                                        ...
                                        <asp:TemplateField HeaderStyle-Width="90px" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="updFU1">
                                                    <ContentTemplate>
                                                        <asp:Button ID="btn_Upload" runat="server" CssClass="standardbutton" Text="Upload" Width="80px" Visible="false"
            ...
            <div  id="divTrans" runat="server" visible="false">
                <div id="divTrnsferDetails" runat="server" visible="false" class="DynamicpanelheadingAliginment">
                    ...
                    <div id="divTransfer" style="display: block;" runat="server" class="panel-body panelContent">
                        ...
                        <div id="trTrnsfr1" runat="server" class="row rowspacing">
                            ...
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtDateOfAppointmentTrnsfr" runat="server" CssClass="form-control mandatory" onmousedown="DatetxtDateOfAppointmentTrnsfr()"  placeholder="Date of appointment as agent"
                            ...
                            <div id="trTrnsfr2" runat="server" class="row rowspacing">
                                <div class="row ">
                                  ...
                                  <div class="row ">
                                        <div class="col-sm-4">
                                    <asp:TextBox ID="txtDateOfCessationTrnsfr" runat="server" CssClass="form-control mandatory" onmousedown="DatetxtDateOfCessationTrnsfr()" placeholder="Date of cessation of agency"
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="row rowspacing">
                                    <div class="col-sm-4">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="ddlCatComp" runat="server" CssClass="form-control form-select mandatory"
                                                    TabIndex="62">
                                                    <asp:ListItem Value="" Text="Select"></asp:ListItem>
                                                </asp:DropDownList>
                                            </ContentTemplate>
                                ...
                                <div id="trInsurer" runat="server">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <asp:TextBox ID="txtDateOfAppointment" runat="server" CssClass="form-control mandatory" onmousedown="DatetxtDateOfAppointment();" placeholder="Date of appointment as agent"
                               ...
                               <span class="glyphicon glyphicon-plus BtnGlyphicon"> </span> Add
                                        ...
                                        <div class="rowspacing">
                                            ...
                                            <asp:GridView ID="gvComposite" OnRowDeleting="gvComposite_RowDeleting" AutoGenerateColumns="false" Style="border-bottom-color: black;"
                                                TabIndex="70" AutoGenerateDeleteButton="false" runat="server" CssClass="footable" OnRowDataBound="gvComposite_RowDataBound">
                                                <RowStyle CssClass="GridViewRowNew"></RowStyle>
                                                <PagerStyle CssClass="disablepage" />
                                                <HeaderStyle CssClass="gridview th" />
                                                <Columns>
    ...
    <div class="row rowspacing" style="text-align:center">
        <div class="col-sm-12">
           ...
           <asp:LinkButton ID="btnPrev3" runat="server" Text="PREVIOUS" CssClass="btn btn-success" Visible="false" OnClick="btnPrev3_Click" >
            ...
            <asp:LinkButton ID="btnPrev5" runat="server" Text="PREVIOUS" CssClass="btn btn-success" Visible="false" OnClick="btnPrev5_Click"
                ><span class="glyphicon glyphicon-arrow-left BtnGlyphicon"> </span>  PREVIOUS  </asp:LinkButton>
            ...
            <asp:LinkButton ID="btnexit" runat="server" CssClass="btn btn-danger" CausesValidation="False" OnClick="btnexit_Click">EXIT
              ...
              <asp:LinkButton ID="btnNextPannel1" runat="server" Text="" CssClass="btn btn-success" OnClick="btnNextPannel1_Click"  Visible="true">
                NEXT  <span class="glyphicon glyphicon-arrow-right BtnGlyphicon"> </span>
            </asp:LinkButton>
        <asp:LinkButton ID="btnNextPannel2" runat="server" Text="NEXT" CssClass="btn btn-success" OnClick="btnNextPannel2_Click" Visible="false">
             NEXT  <span class="glyphicon glyphicon-arrow-right BtnGlyphicon"> </span>
        </asp:LinkButton>
            ...
            <asp:LinkButton ID="btnNextPannel6" runat="server" Text="NEXT" CssClass="btn btn-success" OnClick="btnNextPannel6_Click"  Visible="false">
                 NEXT  <span class="glyphicon glyphicon-arrow-right BtnGlyphicon"> </span>
    ...
    <asp:UpdatePanel ID="pop1" runat="server">
        <ContentTemplate>
   <asp:Panel ID="pnl" runat="server" BorderColor="ActiveBorder"   Width="38%" Height="62%" style="background-color: white">
        ...
        <table>
            <tr>
                <td style="width: 391px;">
                   ...
                   <%-- <center>
                        <asp:Label ID="lbl4" runat="server" visible="false"></asp:Label><br />
                        <br />
                    </center>--%>
<%--                    <br />--%>
                </td>
  ...
  <script>
      ...
      //    var enteredValue = document.getElementById("ctl00_ContentPlaceHolder1_txtDOB").value;

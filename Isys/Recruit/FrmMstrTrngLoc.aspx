<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true" CodeFile="FrmMstrTrngLoc.aspx.cs" Inherits="Application_ISys_Recruit_FrmMstrTrngLoc" %>
    ...
    <table id="Table1" class="container" runat="server" width="80%">
            ...
            <table id="tblTrnInstDtl" runat="server" class="tableIsys" style="border-collapse: separate; left: 0in; top: 0px; width:100%;">
                <tr>
                    <td class="test" colspan="4" align="left"  style="height:20px; vertical-align:baseline;">
                        <asp:Label ID="lbltitle" runat="server" Text="Training Location Search" Font-Bold="true" Height="10px"></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <table class="formtable" style="border-collapse:separate; left:0in; position:relative; top:0px; width:100%;">
                    <tr id="trtitle" runat="server" visible="false">
                        <td style="border-collapse: separate" class="test" height="30px;">
                            ...
                            <ContentTemplate>
                                <asp:Label ID="lblExmCntrSrch" runat="server" Text="Training Location Search" Font-Bold="true" Font-Size="Small" align="left"></asp:Label>
                    ...
                    <tr id="trgridMstTrnInst" runat="server">
                        <td colspan="2">
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="dgMstTrnLoc" runat="server" AllowSorting="True" CssClass="formtable"
                                    ...
                                    AllowPaging="True"  
                                    Width="100%" OnRowCommand="dgMstTrnLoc_RowCommand" OnRowDataBound="dgMstTrnLoc_RowDataBound" OnPageIndexChanging="dgMstTrnLoc_PageIndexChanging"> 
                                    <Columns>
        ...
        <tr>
            ...
            <table id="tblTrn" runat="server" class="tableIsys" visible="false" style="border-collapse: separate; left: 0in; top: 0px; width:100%;">
                <tr>
                    <td class="test" colspan="4" align="left"  style="height:20px; vertical-align:baseline;">
                        <asp:Label ID="lblTrnSearch" runat="server" Text="Training Location" Font-Bold="true" Height="10px"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="formcontent" align="left" style="width: 20%">

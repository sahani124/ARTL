...
public partial class Application_Isys_Saim_CompAccSrch : BaseClass
{
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                if (Request.QueryString["ACT_TYPE"] != null)
                {
                    ...
                    {
                        txtMemName.Text = Request.QueryString["CMP_CODE"].ToString().Trim();
                ...
                FillDropDowns(ddlStatus, "24", "Prc_GetLookValDESC", ht);
                ht.Clear();
              ...
              //  ddlMemType.Enabled = false;
                ...
                ////BindGrid(txtMemName.Text.Trim(), txtJVNo.Text.ToString().Trim(), ddlMemType.SelectedValue.ToString().Trim(), ddlStatus.SelectedValue.ToString().Trim());
                //EnblDsblAct();
    ...
    //                //btnAddNew.Visible = false;
    //                BindGrid(txtMemName.Text.Trim(), txtJVNo.Text.ToString().Trim(), ddlMemType.SelectedValue.ToString().Trim(), ddlStatus.SelectedValue.ToString().Trim(), "2");
    ...
    protected void GetChannelWiseCompenDesign()
    {
        try
        {
            ...
            htPara= addparameter(ddlMemType, "@MEM_TYPE_CODE", htPara);

            htPara = addparameter(txtMemName, "@Agent_Name", htPara);
            htPara = addparameter(txtJVNo, "@RefNo", htPara);
            htPara = addparameter(ddlStatus, "@PickedByXI", htPara);
            ds = objDal.GetDataSetForPrc_SAIM("PRC_GET_ACCOUNT_SEARCH", htPara);

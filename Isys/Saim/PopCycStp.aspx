<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true"
    CodeFile="PopCycStp.aspx.cs" Inherits="Application_ISys_Saim_PopCycStp" %>
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            <center>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <div id="divfinhdrcollapse" runat="server" style="width: 95%; border-style:none;" class="panel panel-success">
                            <div id="Div6" runat="server" class="panel-heading" style="border-style:none;" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divfinhdr','myImg');return false;">
                                <div class="row">
                                    <div class="col-sm-10" style="text-align: left">
                                        ...
                                        <asp:Label ID="lblbusiyrhdr" Font-Size="19px" runat="server" />
                                    </div>
                                    <div class="col-sm-2">
                            ...
                            <div id="divfinhdr" runat="server" style="width: 96%; text-align: left; white-space: nowrap;"
                                class="panel-body">
                ...
                <br />
                <br />
                <div id="divYr" runat="server" style="width: 95%; border-style:none;" class="panel panel-success">
                    <div id="Div1" runat="server" class="panel-heading" style="border-style:none;" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divyrhdr','Img3');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                <%--<span class="glyphicon glyphicon-menu-hamburger" style="color: #034ea2;"></span>&nbsp;--%>
                                <asp:Label ID="lblyrhdr" Font-Size="19px" runat="server" />
                            </div>
                            <div class="col-sm-2">
                               <span class="glyphicon glyphicon-menu-hamburger" style="float: right;color:#034ea2;
                            padding: 1px 10px ! important; font-size: 18px;"></span>&nbsp;
                    ...
                    <div id="divyrhdr" runat="server" style="width: 96%;" class="panel-body">
                        ...
                        <div class="row" style="margin-top: 12px;">
                            <div class="col-sm-12" align="center">
                                <asp:LinkButton ID="btnSaveYr" runat="server" CssClass="btn btn-sample" OnClick="btnSaveYr_Click">
                                            <span class="glyphicon glyphicon-floppy-disk" style="color:White"></span> Save
                                </asp:LinkButton>
                                <asp:LinkButton ID="btnCnclYr" runat="server" CssClass="btn btn-sample" TabIndex="25"
                ...
                <br />
                <br />
                <div id="divHyr" runat="server" style="width: 95%; border-style:none;" class="panel panel-success">
                    <div id="Div2" runat="server" class="panel-heading" style="border-style:none;" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divhyrhdr','Img4');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                <%--<span class="glyphicon glyphicon-menu-hamburger" style="color: #034ea2;"></span>&nbsp;--%>
                                <asp:Label ID="lblhyrhdr" Font-Size="19px" runat="server" />
                            </div>
                            <div class="col-sm-2">
                                <span class="glyphicon glyphicon-menu-hamburger" style="float: right;color:#034ea2;
                            padding: 1px 10px ! important; font-size: 18px;"></span>&nbsp;
                    ...
                    <div id="divhyrhdr" runat="server" style="width: 96%;" class="panel-body">
                        ...
                        <div class="row" style="margin-top: 12px;">
                            <div class="col-sm-12" align="center">
                                ...
                                <asp:LinkButton ID="btnCnclHyr" runat="server" CssClass="btn btn-sample" TabIndex="25"
                ...
                <br />
                <br />
                <div id="divQtr" runat="server" style="width: 95%; border-style:none;" class="panel panel-success">
                    <div id="Div3" runat="server" class="panel-heading" style="border-style:none;" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divqtrhdr','myImg');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                <%--<span class="glyphicon glyphicon-menu-hamburger" style="color: #034ea2;"></span>&nbsp;--%>
                                <asp:Label ID="lblqtryrhdr" Font-Size="19px" runat="server" />
                            </div>
                            <div class="col-sm-2">
                               <span class="glyphicon glyphicon-menu-hamburger" style="float: right;color:#034ea2;
                            padding: 1px 10px ! important; font-size: 18px;"></span>&nbsp;
                    ...
                    <div id="divqtrhdr" runat="server" style="width: 96%;" class="panel-body">
                        ...
                        <div class="row" style="margin-top: 12px;">
                            <div class="col-sm-12" align="center">
                                <asp:LinkButton ID="btnSaveQtr" runat="server" CssClass="btn btn-sample" OnClick="btnSaveQtr_Click">
                                            <span class="glyphicon glyphicon-floppy-disk" style="color:White"></span> Save
                                </asp:LinkButton>
                                <asp:LinkButton ID="btnCnclQtr" runat="server" CssClass="btn btn-sample" TabIndex="25"
                ...
                <br />
                <br />
                <div id="divMonth" runat="server" style="width: 95%; border-style:none;" class="panel panel-success">
                    <div id="Div4" runat="server" class="panel-heading" style="border-style:none;" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divmthhdr','Img1');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                <%--<span class="glyphicon glyphicon-menu-hamburger" style="color: #034ea2;"></span>&nbsp;--%>
                                <asp:Label ID="lblmthyrhdr" Font-Size="19px" runat="server" />
                            </div>
                            <div class="col-sm-2">
                                <span class="glyphicon glyphicon-menu-hamburger" style="float: right;color:#034ea2;
                            padding: 1px 10px ! important; font-size: 18px;"></span>&nbsp;
                    ...
                    <div id="divmthhdr" runat="server" style="width: 96%;" class="panel-body">
                        ...
                        <div class="row" style="margin-top: 12px;">
                            <div class="col-sm-12" align="center">
                                <asp:LinkButton ID="btnSaveMth" runat="server" CssClass="btn btn-sample" OnClick="btnSaveMth_Click">
                                            <span class="glyphicon glyphicon-floppy-disk" style="color:White"></span> Save    
                                </asp:LinkButton>
                                <asp:LinkButton ID="btnCnclMth" runat="server" CssClass="btn btn-sample" TabIndex="25"

<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true"
    CodeFile="PopStdPrdctDef.aspx.cs" Inherits="Application_ISys_Saim_PopStdPrdctDef" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function doOk(LOBcode,LOBName,PrdctCode,PrdctName,Freq,FreqVal,Consider,ConsiderVal,Type,TypeVal,Wght) {
            ...
            window.parent.document.getElementById('<%=Request.QueryString["PrdctName"].ToString()%>').value = PrdctCode;
            window.parent.document.getElementById('<%=Request.QueryString["PrdctNameval"].ToString()%>').value = PrdctName;
                    ...
                    <table class="formtablehdr" style="width: 100%;">
                        <tr style="height: 30px;">
                            <td style="padding-left: 5px;">
                                ...
                                <asp:Label ID="lblhdr" Text="Select product level weightage definitions" runat="server"
                    ...
                    <div id="divPrdct" class="divBorder1" runat="server" style="width: 100%;">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="white-space: nowrap; width: 20%;" class="form-body align col-md-6">
                                    <asp:Label ID="lblPrdctName" Text="Product Name" runat="server" CssClass="control-label col-md-5" />
                                </td>
                                <td style="width: 30%; white-space: nowrap;" class="col-md-7">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddlPrdctName" runat="server" AutoPostBack="true" CssClass="select2-container form-control col-md-5" OnSelectedIndexChanged="ddlPrdctName_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </td>

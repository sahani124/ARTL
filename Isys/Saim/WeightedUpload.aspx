<%@ Page Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true" CodeFile="WeightedUpload.aspx.cs"
    Inherits="Application_ISys_Saim_WeightedUpload" %>
   ...
   <link href="../../../KMI%20Styles/Bootstrap/css/bootstrap.min.css" rel="stylesheet"
    ...
    <script language="javascript" type="text/javascript">
        ...
        function doCancel() {
            ...
            window.opener.document.getElementById("Button10_Click").click();
                    ...
                    <div id="Div1" runat="server" class="panel-heading" onclick="ShowReqDtl('ctl00_ContentPlaceHolder1_divSearch','btnWfParam');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                <asp:Label ID="lblTitle" runat="server" CssClass="control-label" Font-Size="19px">Product Level Weightage Upload</asp:Label>
                            </div>
                            <div class="col-sm-2">

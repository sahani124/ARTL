<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true"
    CodeFile="CmpSetup.aspx.cs" Inherits="Application_ISys_Saim_CmpSetup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <link href="../../../Styles/main.css" rel="stylesheet" type="text/css" />
    <script lang="javascript" type="text/javascript" src="~/Scripts/formatting.js"></script>
    <link href="../../../KMI Styles/assets/css/jquery.ui.all.css" rel="stylesheet" type="text/css" />
    <link href="../../../KMI Styles/assets/jqueryCalendar/jquery-ui.css" rel="stylesheet"
        type="text/css" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        //Added by Abuzar on 14/07/2020 starts
        function funPopUpEdit(cmpcode, cmpdesc, pcntstcd, flag) {
            debugger;
            $find("mdlViewBID").show();
            document.getElementById("ctl00_ContentPlaceHolder1_ifrmMdlPopup").src = "PopCntst.aspx?cmpCode=" + cmpcode + "&cmpdesc=" + cmpdesc
                + "&pcntstcd=" + pcntstcd + "&flag=" + flag + "&mdlpopup=mdlViewBID";
        }
        //Added by Abuzar on 14/07/2020 ends
        ...
        function validate() {
            ...
            //Added by amit marathe on 29 Nov 2018
            if (document.getElementById('<%=ddlAccYear.ClientID %>').value == "1003") {
                if ((document.getElementById('<%=ddlExtendedDate.ClientID %>').value == "Select") || (document.getElementById('<%=ddlExtendedDate.ClientID %>').value == "")) {
                    alert("Please Select Is Extended Year");
                    document.getElementById('<%= ddlExtendedDate.ClientID %>').focus();

                    return false;
                }
            }
            //Ended by amit marathe on 29 Nov 2018
            ...
            <center>
                ...
                <div id="divcmphdrcollapse" runat="server" class="panel" style="margin-left: 2%; margin-top: 0.5%">
                    ...
                    margin-bottom: 0.9%">
                        ...
                        <div class="row" style="margin-bottom: 5px;">
                            <div class="col-sm-3" style="text-align: left">
                                  <%-- added by amit on 30 jan 2019--%>
                                <asp:Label ID="lblCompDesc2"  runat="server" CssClass="control-label" />
                                <%-- <asp:Label ID="lblComDesc2_s" Text="*" runat="server" ForeColor="red" />--%>
                            </div>
                          
                            <div id="divCompDesc2" class="col-sm-3" runat="server">
                            ...
                            <div id="divcbSingelCycle" class="col-sm-3" runat="server" style="padding-right:200px">
                                 <asp:RadioButton ID="rdSingleCycle" runat="server" AutoPostBack="True"  GroupName="Is Single Cycle"
                                      OnCheckedChanged="rdSingleCycle_CheckedChanged" Text="Yes" /> <%--added by amit on 28 feb 2019--%>
                                &nbsp;
                                 <asp:RadioButton ID="rdSingleCycle1" runat="server" AutoPostBack="True" GroupName="Is Single Cycle" OnCheckedChanged="rdSingleCycle_CheckedChanged" Text="No" />
                            </div>
                           <%-- ended by amit on 30 jan 2019--%>
                            <div class="col-sm-3" style="text-align: left">
                      ...
                      <%--  added by amit on 26/11/2018--%>
                         <div class="row" style="margin-bottom: 5px;" runat="server">
                            <div id="divExtended"  class="col-sm-3" style="text-align: left" runat="server">
                                <asp:Label ID="lblExtended" Text="Is Extended Year" runat="server" CssClass="control-label" />
                                <asp:Label ID="lblExtended1" Text="*" runat="server" ForeColor="red" />
                            </div>
                            <div id="divExtended1" class="col-sm-3" runat="server">
                                <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlExtendedDate" runat="server" CssClass="form-control" AutoPostBack="true"
                                            TabIndex="29" Enabled="false" OnSelectedIndexChanged="ddlExtendedDate_SelectedIndexChanged" >
                            ...
                            <div id="divCompuRule" class="col-sm-3" style="text-align: left" runat="server"><%-- Added By Amit--%>
                            ...
                            <div id="divCompuRule1" class="col-sm-3"  style="text-align: left" runat="server"> <%-- Added By Amit--%>
                        ...
                        <div id="divEffDtFrm" class="row" style="margin-bottom: 5px;" runat="server"> <%--added by amit--%>
                            <div class="col-sm-3" style="text-align: left">
                            ...
                            <div class="col-sm-3" style="white-space: nowrap;">
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                       <asp:TextBox ID="txtEffDtFrm" runat="server" Enabled="false" CssClass="form-control" onmousedown="PopulateCalender()"
                            ...
                            <div class="col-sm-3">
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtEffDtTo" runat="server"   Enabled="false" CssClass="form-control" 
                                            AutoPostBack="true" />
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                        </div>
                        <div id="divVerEffFrm" class="row" style="margin-bottom: 5px;" runat="server"> <%--added by amit--%>
                            <div class="col-sm-3" style="text-align: left">
                        ...
                        <div class="row" style="margin-bottom: 5px;">
                            ...
                            <div id="SetTdiv" class="col-sm-3" style="text-align: left" runat="server"> <%-- added by amit on 28 feb 2019 --%>
                            ...
                            <div id="SetTdiv1" class="col-sm-3" style="margin-right:0px;" runat="server" >   <%-- added by amit on 28 feb 2019 --%>
...
<%--                            <div class="col-sm-3" style="text-align: left">
                        ...
                        <div id="tbladdcmpst" runat="server" class="row" style="margin-top: 12px;">
                            <div class="col-sm-12" align="center">
                                ...
                                <asp:LinkButton ID="btnSave" runat="server"   style="width:85px !important" CssClass="btn btn-sample" TabIndex="17"
                                    OnClientClick="return validate();" OnClick="btnSave_Click">
                                                    <span class="glyphicon glyphicon-floppy-disk" style="color:White"></span> SAVE
                                </asp:LinkButton>
                                <asp:LinkButton ID="btnCnclCmp" runat="server" style="background-color:#FFF;color:#f04e5e !important; width:85px !important" CssClass="btn btn-sample" TabIndex="18"
                ...
                <div id="divcmphdrview" runat="server" class="panel" visible="false" style="margin-left: 2%; margin-top: 0.5%">
                    <div id="Div5" runat="server" class="panel-heading" onclick="ShowReqDtl('ctl00_ContentPlaceHolder1_div3','Img5');return false;">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                 <span id="Img5" class="glyphicon glyphicon-chevron-down" style="float: right;color:#034ea2;
                            padding: 1px 10px ! important; font-size: 18px; margin-top:12px"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div id="divcntstcollapse" runat="server" class="panel" style="margin-left: 2%; margin-top: 0.5%">
                    <div id="Div7" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divcntst','Img1');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                               <span style="margin-left:6px">
                                    <img id="imgCodeIcon3" src="../../../KMI%20Styles/assets/css/Images/compensation_icon.png"/>
                                </span>
                                <asp:Label ID="Label1" Text="CONTENSTANT DETAILS" runat="server" Font-Size="19px" Style="padding-left: 5px;" />
                            </div>
                            <div class="col-sm-2">
                    ...
                    <%--div starts--%>
                    <div id="divcntst" runat="server"  style="display: block; margin-top: 0.9% ;width:98% !important;
                    margin-bottom: 0.9%">
                                ...
                                <div style="margin-top: 0.9%;margin-bottom: 0.9%" class="table-scrollable">
                                    <asp:GridView ID="dgCntst" runat="server" AutoGenerateColumns="false" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Rule Description" SortExpression="PRTCPTN_BSD_ON">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRUL_DESC" runat="server" Text='<%# Bind("RUL_DESCri")%>'></asp:Label>
                                                    <asp:HiddenField ID="hdnRUL_DESC" runat="server" Value='<%# Bind("PRTCPTN_BSD_ON")%>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>


                                            <asp:TemplateField HeaderText="Relation Type" SortExpression="UNT_REL_TYPE">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblUNT_REL_TYPE_DESC" runat="server" Text='<%# Bind("UNT_REL_TYPE_DESC")%>'></asp:Label>
                                                    <asp:HiddenField ID="hdnUNT_REL_TYPE_DESC" runat="server" Value='<%# Bind("UNT_REL_TYPE")%>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                               <asp:TemplateField HeaderText="Set Unit Rank" SortExpression="SetUnitRank">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblSetUnitRank" runat="server" Text='<%# Bind("SetUnitRank")%>'></asp:Label>
                                                                                <asp:HiddenField ID="hdnSetUnitRank" runat="server" Value='<%# Bind("SetUnitRank")%>' />
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>


                                                                         <asp:TemplateField HeaderText="Set Unit Type" SortExpression="SetUnitType">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblSetUnitType" runat="server" Text='<%# Bind("SetUnitType")%>'></asp:Label>
                                                                                <asp:HiddenField ID="hdnSetUnitType" runat="server" Value='<%# Bind("SetUnitType")%>' />
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                        ...
                        <div id="tbladdcntst" runat="server" class="row" style="margin-top: 12px;">
                            <div class="col-sm-12" align="center">
                                <asp:LinkButton ID="btnAddCntst" runat="server" style="background-color:#034ea2;color:#FFF; border:none !important; width:105px !important" CssClass="btn btn-sample" Enabled="true" OnClick="btnAddCntst_Click">
                                ...
                                <asp:LinkButton ID="btnSaveCntst" runat="server"  style="width:85px !important" CssClass="btn btn-sample" Visible="false"
                                        ...
                                        <td style="white-space: nowrap;">
                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                <ContentTemplate>
                                                    ...
                                                    <asp:Button ID="btnnext" Text=">" CssClass="form-submit-button" runat="server" Enabled="true" Style="border-style: solid;
                    ...
                    </div>   <%--Added by Rajkapoor on 28-01-2022--%>
                   
                <%--ADDED BY KALYANI START--%>
                <div id="divC" runat="server" class="panel" style="margin-left: 2%; margin-top: 0.5%">
                    <div class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divok','Img2');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                <span style="margin-left:6px">
                                    <img id="imgCodeIcn1" src="../../../KMI%20Styles/assets/css/Images/compensation_icon.png"/>
                                </span>
                                <asp:Label ID="Label4" Text="COMPENSATION STATUS" runat="server" Font-Size="19px" Style="padding-left: 5px;" />
                            </div>
                            <div class="col-sm-2">
                                 <span id="Img2" class="glyphicon glyphicon-chevron-down" style="float: right;color:#034ea2;
                            padding: 1px 10px ! important; font-size: 18px; margin-top:12px"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div id="divAudit" runat="server" class="panel" style="margin-left: 2%; margin-right: 2%; margin-top: 0.5%">
                    <div id="Div2" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divAuditTrail','Img4');return false;">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <span id="Img4" class="glyphicon glyphicon-chevron-down" style="float: right; color:  #034ea2;
                                    padding: 1px 10px ! important; font-size: 18px;"></span>
                            </div>
                        </div>
                    </div>
                    <div id="divAuditTrail" runat="server"  style="display: block; margin-top: 0.9%; margin-bottom: 0.9%; width:98% !important" >
            ...
            <asp:Panel ID="pnl" runat="server" Width="320px" DefaultButton="btnok"
                CssClass="modal-content">
                <div style="align-items: center; margin: 0 auto; width: 44px; height: 44px; margin-top: 15px;">
                    <img src="../ChannelMgmt/Img/icon_info.png" />
                </div>
                <div class="modal-header" style="text-align: center !important; font-size: 20px; border-bottom: none !important">
                    Information
                </div>
                <div class="modal-body" style="text-align: center; color: #7c7c7c !important">
                ...
                <div class="modal-footer" style="text-align: center; border-top: none !important">
                    <asp:LinkButton ID="btnok" runat="server" TabIndex="1" CssClass="btn btn-danger" Style="border-radius: 5px !important;"
                        OnClick="btnAddRegistro_Click"
                        Font-Bold="true">
                        <%--<img src="../ChannelMgmt/Img/btn_ok.png" />--%>
            ...
            <ajaxToolkit:ModalPopupExtender ID="mdlpopup" runat="server" TargetControlID="lbl3"
                ...
                DropShadow="false" OkControlID="btnok" Y="100" OnOkScript="onOk();">
            </ajaxToolkit:ModalPopupExtender>
        </ContentTemplate>
    </asp:UpdatePanel>
    <asp:Panel runat="server" Height="550px" Width="1000px" ID="pnlMdl" display="none"
        Style="height: 508px; width: 1000px; text-align: center !important; position: absolute !important; z-index: 100001 !important; left: 174.5px !important; top: -20.5px !important;">
        <iframe runat="server" id="ifrmMdlPopup" width="100%" frameborder="0" display="none"
            style="height: 78%; margin-top: 50px !important"></iframe>
    </asp:Panel>

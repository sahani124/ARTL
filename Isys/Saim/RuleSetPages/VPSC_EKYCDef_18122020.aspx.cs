    ...
    private void EditVPSC()
    {
        ...
        if (Request.QueryString["RuleId"] != null)
        {
            ...
            catch (Exception ex)
            {
                ...
                objErr.LogErr("ISYS-SAIM", "VPSC_EKYCDef", "EditVPSC", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
            }
        }
        else
        {
        ...
        ds = objDal.GetDataSetForPrcDBConn("Prc_EditVPSCEKYC_WithRecId", ht, "SAIMConnectionString");
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["RuleId"] != null && Request.QueryString["RuleId"].ToString() != "undefined")
        {
            ...
            catch (Exception ex)
            {
                ...
                objErr.LogErr("ISYS-SAIM", "VPSC_EKYCDef", "btnsave_Click", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
            }
        }
        else
        {
        ...
        obDAL.GetDataSetForPrcDBConn("Prc_ISVPSC_EKYCDef_SaveData", htparam, "SAIMConnectionString");

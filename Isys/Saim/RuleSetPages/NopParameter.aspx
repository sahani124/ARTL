<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true"
    CodeFile="NopParameter.aspx.cs" Inherits="Application_ISys_Saim_RuleSetPages_NopParameter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function doOk(rultyp, flag) {
            ...
            window.parent.document.getElementById("btnNOPclick_Click").click();
        }
        ...
        function doCancel() {
            debugger;
            window.parent.$find('<%=Request.QueryString["mdlpopup"].ToString()%>').hide();
            //window.parent.document.getElementById("Button11_Click").click();
            if (window.parent.document.getElementById("btnNOPpop") != null) {
                window.parent.document.getElementById("btnNOPpop").click();
            }
            else {
        ...
        <ContentTemplate>
            <center>
                <div id="divcmphdrcollapse" runat="server" style="width: 97%;" class="panel">
                        ...
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left;font-size:19px">
                               <%-- <span class="glyphicon glyphicon-menu-hamburger" style="color: Orange;"></span>--%>
                                <asp:Label ID="lblhdr" Text="NOP Level Include Exclude Definition" runat="server" />
                            </div>
                            <div class="col-sm-2">
                    ...
                    <div style="width: 100%; text-align: left; padding: 10px; display:none" >

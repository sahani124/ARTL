...
public partial class Application_ISys_Saim_RuleSetPages_FFContestPageStdDef : BaseClass
{
    ...
    public void checkforstddefflg2()
    {
        ...
        ht1.Add("@Kpi_code", Request.QueryString["KpiCode"].ToString().Trim());
        ...
        if (ds.Tables[0].Rows.Count != 0)
        {
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                ds2.Clear();
                ht2.Clear();
                ht2.Add("@MAP_CODE", Request.QueryString["mapcode"].ToString().Trim());
                ...
                sb.Append("\n");
                sb.Append("object[\"NEW_MAP_CODE\"] = " + Request.QueryString["mapcode"].ToString().Trim() + ";");
                sb.Append("\n");
                ...
                sb.Append("\n");
                sb.Append("btnSaveRprt (" + mapcodeinherited.ToString().Trim() + "," + Request.QueryString["mapcode"].ToString().Trim() + "," + ds.Tables[0].Rows[i]["ACT_TYPE"].ToString().Trim() + ",optionVal)");
                sb.Append("\n");
                sb.Append("}");
                sb.Append("\n");

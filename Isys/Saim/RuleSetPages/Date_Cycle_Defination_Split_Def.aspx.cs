...
public partial class Application_Isys_Saim_RuleSetPages_Date_Cycle_Defination_Split_Def : BaseClass
{
    #region Declaration
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "Page_Load", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    public void SetEffDate()
    {
        try
        {
            ...
            htParam.Add("@CYCLE", Request.QueryString["CYCLE"].ToString().Trim());
            ds = objDal.GetDataSetForPrc_SAIM("Prc_GetdataForSplit", htParam);

            if (ds.Tables[0] != null)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    hdnEffFrm.Value = ds.Tables[0].Rows[0]["START_DATE"].ToString();
                    hdnEffTo.Value = ds.Tables[0].Rows[0]["END_DATE"].ToString();
                }
            }
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "SetEffDate", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    public void Deletedata()
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "Deletedata", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    private void binddata()
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "binddata", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    private void GetData()
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "GetData", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "btnadd_Click", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    private void EmptydgCycle(GridView gv)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "EmptydgCycle", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    private void SetInitialRow()
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "SetInitialRow", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    protected void txtnofpart_TextChanged(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "txtnofpart_TextChanged", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    private void AddNewRowToGrid(int norow)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "AddNewRowToGrid", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    protected void btnSaveHyr_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            for (int intDataCount = 0; intDataCount < lstlblMthCode.Count; intDataCount++)
            {
                ...
                ds = objDal.GetDataSetForPrc_SAIM("Prc_InsMST_BUSI_YR_SPLIT", htParam);
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "btnSaveHyr_Click", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    protected void FillCycle()
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "FillCycle", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    private void ShowNoResultFound(DataTable source, GridView gv)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "ShowNoResultFound", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    protected void OnRowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "OnRowDataBound", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    protected void grdshowcycle_OnRowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "Date_Cycle_Defination_Split_Def", "grdshowcycle_OnRowDeleting", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }

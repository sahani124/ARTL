        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["RuleId"] != null)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    objErr.LogErr("ISYS-SAIM", "PremiumFreeqDef", "Page_Load", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
            ...
            ds = objDal.GetDataSetForPrcDBConn("Prc_EditPremiumFreq_WithRecId", ht, "SAIMConnectionString");
       ...
       // @RecId
        ...
        if (Request.QueryString["RuleId"] != null)
        {
            ...
            catch (Exception ex)
            {
                ...
                objErr.LogErr("ISYS-SAIM", "PremiumFreeqDef", "Button1_Click", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
            }
        ...
        objDal.GetDataSetForPrcDBConn("Prc_PremiumFreqDef_SaveData", htparam, "SAIMConnectionString");

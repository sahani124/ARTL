<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true" CodeFile="VPSC_EKYCDef.aspx.cs" Inherits="Application_Isys_Saim_RuleSetPages_VPSC_EKYCDef" %>
                        ...
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left;font-size:19px">
                               <%-- <span class="glyphicon glyphicon-menu-hamburger" style="color: Orange;"></span>--%>
                                <asp:Label ID="lblhdr" Text="VPSC & EKYC Weightage Definition" runat="server" />
                            </div>
                            <div class="col-sm-2">
                    ...
                    <div id="divcmphdr" runat="server" style="width: 96%;" class="panel-body">
                        <div class="row" style="margin-bottom: 5px;">
                            <div class="col-sm-3" style="text-align: left">
                                <asp:Label ID="Label10" Text="IS VPSC" runat="server" CssClass="control-label" />
                                <asp:Label ID="lblconsider" Text="*" runat="server" ForeColor="red" />
                            </div>
                            <div class="col-sm-3">
                                <asp:DropDownList ID="ddlISVPSC"  runat="server" 
                            ...
                            <div class="col-sm-3" style="text-align: left">
                                <asp:Label ID="Label2" Text="IS EKYC" runat="server" CssClass="control-label" />
                                <asp:Label ID="Label12" Text="*" runat="server" ForeColor="red" />
                            </div>
                            <div class="col-sm-3">
                               <asp:DropDownList ID="ddlISEKYC"  runat="server"
                                   CssClass="form-control">
                                    <asp:ListItem Text="--SELECT--" Value=""></asp:ListItem>
                                    <asp:ListItem Text="YES" Value="Y"></asp:ListItem>
                                    <asp:ListItem Text="NO" Value="N"></asp:ListItem>

<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true" CodeFile="FFCntDateRelatedDef.aspx.cs" Inherits="Application_Isys_Saim_RuleSetPages_FFCntDateRelatedDef" %>
            ...
            <center>
                <div id="divcmphdrcollapse" runat="server" style="width: 97%;" class="panel">
                    ...
                    <div id="divcmphdr" runat="server" style="width: 96%;" class="panel-body">
                        <div id="trBusi" runat="server" class="row" style="margin-bottom: 5px;display:none;">
                        ...
                        <div class="row" style="margin-bottom: 5px;">
                            ...
                            <div class="col-sm-3">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlDateType" runat="server" CssClass="select2-container form-control">    <%--AutoPostBack="true" OnSelectedIndexChanged="ddlDateType_SelectedIndexChanged"--%>
                                        </asp:DropDownList>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true" CodeFile="Date_Cycle_Defination_Split_Def.aspx.cs" Inherits="Application_Isys_Saim_RuleSetPages_Date_Cycle_Defination_Split_Def" %>
                                ...
                                <HeaderStyle CssClass="gridview th" />
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Cycle Description" HeaderStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtcydsc" runat="server" Text='<%# Bind("MTH_NAME")%>' MaxLength="20" CssClass="form-control"></asp:TextBox>

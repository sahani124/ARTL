...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function btnaddProd() {
            debugger;
            $("#<%= btnAddProdweightages.ClientID %>").click();
            return false;
        }
        function btnaddMPL() {
            debugger;
    ...
    <center>
        ...
        <div id="divsnd" runat="server" style="width: 97%;" class="panel">
            ...
            <div id="divStdDefLOBDtls" runat="server" style="width: 100%;" >
                ...
                <div id="div4" runat="server" style="width: 97%; padding: 10px; display: block;" class="panel-body">
...
<%--                                                <asp:HiddenField ID="hdnWeightage" runat="server" Value='<%# Bind("Weightage")%>' />--%>
                              ...
                              <%--  <asp:LinkButton ID="btnDwnUpd" runat="server" CssClass="btn btn-sample" Enabled="true" OnClientClick="funPopUpRulSetProductBulk()">
                                ...
                                <asp:LinkButton ID="btn_Download" runat="server" CssClass="btn btn-sample" Enabled="true"  OnClick="btn_Download_Click">
                                   ...
                                   <button id="btnDwnUpd" type="button" class="btn btn-sample" onclick="javascript: return fnCallPOP();" runat="server">
                                            <span class="glyphicon glyphicon-upload" style="color: White;"></span> Bulk Upload</button>
                ...
                <div id="div17" runat="server" style="width: 97%; padding: 10px; display: block;" class="panel-body">
                    <h3 class="form-section" style="text-align: left;">Minimum Premium Limit Definitions</h3>

                    <div id="DivMApActionMPL" runat="server">
                        <div class="col-sm-4">
                    ...
                    <div class="col-sm-12" id="div18" runat="server">
                                <asp:Button ID="btnMPL" runat="server" CssClass="btn btn-sample"   Text="Continue For MPL Setup" OnClick="btnMPL_Click" />
                        </div>
                    </div>
            </div>

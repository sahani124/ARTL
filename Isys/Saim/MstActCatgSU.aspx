...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <center>
        ...
        <div id="div1" runat="server" style="width: 97%;" class="panel">
           ...
           <asp:updatepanel runat="server" ID="UPD_CATG_ADD">
               <contenttemplate>
                ...
                <div class="row" style="margin-bottom: 5px;">
                    ...
                    <div class="col-sm-3">
                        <asp:ListBox ID="lstfixfactors" runat="server" SelectionMode="Multiple"></asp:ListBox>
                    </div>
                     <div class="col-sm-3" style="text-align: left">
                    ...
                    <div class="col-sm-3">
                        <asp:ListBox ID="lstrangeFactors" runat="server" SelectionMode="Multiple"></asp:ListBox>
                    </div>
                                       ...
                                       <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                           ...
                                           <asp:TemplateField HeaderText="Action">
                                            <HeaderStyle CssClass="gridview th" />
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkMPLView"  runat="server" Text="MPLViewForm"  OnClick="lnkMPLView_Click"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
    ...
    <script>
        ...
        function callEffectiveDate() {
            ...
            $("#<%= txtEffDFrom.ClientID%>").datepicker({ changeMonth: true, changeYear: true, dateFormat: 'dd/mm/yy' });
        ...
        function callCeaseDate() {
            ...
            var dateArr = $("#<%=txtEffDFrom.ClientID%>").val().split('/');
            $("#<%= txtEffDTo.ClientID%>").datepicker({ changeMonth: true, changeYear: true, dateFormat: 'dd/mm/yy' });
            $.datepicker.initialized = true;
            $("#<%= txtEffDTo.ClientID%>").focus();
        ...
        function fnValidate() {
            ...
            var optionSelIndex2 = ddlstatus.options[ddlstatus.selectedIndex].value;

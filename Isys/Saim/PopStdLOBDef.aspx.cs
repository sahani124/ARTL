...
public partial class Application_ISys_Saim_PopStdLOBDef : BaseClass
{
    ...
    protected void FillDdlLOBName()
    {
        ...
        catch (Exception ex)
        {
           ...
           // String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "PopStdLOBDef", "FillDdlLOBName", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    protected void FillDdlProductName()
    {
        ...
        catch (Exception ex)
        {
           ...
           // System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
           // String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "PopStdLOBDef", "FillDdlProductName", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim()); 
        }
    }

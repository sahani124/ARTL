...
<body>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div class="container-fluid" id="container" runat="server">
                    <div class="row" style="min-height: 300px;">
                        ...
                        <div class="col-sm-2">
                            <div style="text-align: center; transform: translateY(130%);">
                                <asp:Button Text="Select >>" runat="server" width="110px" class="btn btn-sample" OnClick="btnSelectorLeft_Click" ID="btnSelectorLeft" />
                    ...
                    <div class="row">
                        <center>
                        <asp:Button Text="Confirm" runat="server" ID="btnSelect" width="85px" OnClick="btnSelect_Click" ClientIDMode="Static" CssClass="btn btn-sample" />
                        <asp:Button Text="Reset" runat="server" width="85px" ID="btnLoadData" OnClick="btnLoadData_Click" ClientIDMode="Static" CssClass="btn btn-sample" />
                            </center>
                    </div>
                </div>
                ...
                <asp:HiddenField ID="hdnMemCodeChild" runat="server"/>
            </ContentTemplate>
        </asp:UpdatePanel>
    </form>
    ...
    <script>
        ...
        function ClosePopup() {
            data = document.getElementById('hdnMemCodeChild').value;
            window.parent.GetDataFromChild(data);    
            window.parent.$find('mdlVwRwdRulBID').hide();
        }

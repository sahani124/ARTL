<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true"
    CodeFile="BusiYearStp_bkp12072021.aspx.cs" Inherits="Application_ISys_Saim_BusiYearStp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <center>
            ...
            <div id="Div6" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divfinhdr','myImg');return false;">
                <div class="row">
                    <div class="col-sm-10" style="text-align: left">
                        ...
                        <asp:Label ID="Label1" Text="Financial Year Setup" runat="server" />
                    </div>
                    <div class="col-sm-2">
            ...
            <div id="divfinhdr" runat="server" style="width: 100%;" class="panel-body">
                ...
                <div class="row" style="margin-top: 12px;">
                    <div class="col-sm-12" align="center">
                        <asp:LinkButton ID="btnAddFin" runat="server" CssClass="btn btn-primary" OnClick="btnAddFin_Click">
                                    <span class="glyphicon glyphicon-plus BtnGlyphicon"></span> Add New
                        </asp:LinkButton>
                        <asp:LinkButton ID="btnCnclFin" runat="server" CssClass="btn btn-primary" OnClick="btnCnclFin_Click">
        ...
        <br />
        <div id="divcalhdrcollapse" runat="server" style="width: 95%;" class="panel panel-success">
            <div id="Div1" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divcalhdr','Img1');return false;">
                <div class="row">
                    <div class="col-sm-10" style="text-align: left">
                        <span class="glyphicon glyphicon-menu-hamburger" style="color: Orange;"></span>&nbsp;
                        <asp:Label ID="Label2" Text="Calendar Year Setup" runat="server" />
                    </div>
                    <div class="col-sm-2">
            ...
            <div id="divcalhdr" runat="server" style="width: 100%;" class="panel-body">
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                    ...
                    <tr>
                        <td style="text-align: center; padding-bottom: 5px; padding-top: 5px;">
                            <asp:LinkButton ID="btnAddCal" runat="server" 
                                CssClass="btn btn-primary" onclick="btnAddCal_Click">
                                    <span class="glyphicon glyphicon-plus BtnGlyphicon"></span> Add New
                                </asp:LinkButton>
                            <asp:LinkButton ID="btnCnclCal" runat="server"
                                CssClass="btn btn-primary" onclick="btnCnclCal_Click">
                                <span class="glyphicon glyphicon-erase BtnGlyphicon"></span> Cancel
                                </asp:LinkButton>
                        </td>
                    </tr>

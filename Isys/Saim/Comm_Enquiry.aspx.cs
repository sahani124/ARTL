            ...
            if (!IsPostBack)
            {
                if (Request.QueryString["Flag"] != null)
                {
                    if (Request.QueryString["Flag"].ToString()=="COM")
                    {
                        ...
                        //UpdatePanel4.Visible = false;COMMISSON ENQUIRY
                    ...
                    if (Request.QueryString["Flag"].ToString() == "INC")
                    {
                        ...
                        //UpdatePanel4.Visible = false; INCENTIVE ENQUIRY
                        dgCmpStEq.Visible = false;
                        LinkButton1.Visible = false;
                    ...
                    //added by Abuzar Siddiqui on 03/03/2021 starts
                    if (Request.QueryString["Flag"].ToString() == "APR")
                    {
                        txtPage.Text = "1";
                        lblhdr.Text = "APPRAISAL ENQUIRY";
                        //UpdatePanel4.Visible = false;
                        dgCmpStEq.Visible = false;
                        LinkButton1.Visible = false;
                        lblCmpSrch.Text = "APPRAISAL ENQUIRY RESULTS";
                        FillDropDoun(ddlCompCode, "APR");

                    }
                    //added by Abuzar Siddiqui on 03/03/2021 ends
                }
    ...
    protected void EnblDsblAct()
    {
        try
        {
            if (Request.QueryString["flag"] != null)
            {
                ...
                //added by Abuzar Siddiqui on 03/03/2021 starts
                if (Request.QueryString["flag"].ToString().Trim() == "APR")
                {
                    Ds = BindData(ddlCompCode.SelectedValue.ToString(), ddlContCode.SelectedValue.ToString().Trim(), ddlRSetKey.SelectedValue.ToString().Trim(), Request.QueryString["flag"].ToString().Trim());
                    if (Ds.Tables.Count > 0)
                    {

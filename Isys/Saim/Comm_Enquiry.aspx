                ...
                <div class="row" style="margin-top: 12px;">
                    <div class="col-sm-12" align="center">
                        <%--<asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>--%>
                                <asp:LinkButton ID="btnSearch" runat="server" CssClass="btn btn-sample" OnClick="btnSearch_Click" OnClientClick="Enable(); Validtion()">
                                    <span class="glyphicon glyphicon-search" style="color: White;"></span> SEARCH
                                </asp:LinkButton>

                                <asp:LinkButton ID="btnCancel" style="background-color:#FFF;color:#f04e5e; width:105px !important" CssClass="btn btn-sample"  runat="server"   OnClick="btnCancel_Click">

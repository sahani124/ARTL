...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function funAddVarMaster1(CmpTyp, flag, mapcode, CMPNSTN_CODE, CNTST_CODE, KPI_CODE, bizsrc, chncls, memtype, DRVDKPI, RuleSetKey, KPIMode, KpiCode, Mode) {
            debugger;
            //var strContent = "ctl00_ContentPlaceHolder1_";
            //$find("mdlVwBID").show();
            //document.getElementById("ctl00_ContentPlaceHolder1_ifrmRwd1").src = "../Saim/RuleSetPages/FFContestPageStdDef.aspx?role=maker&CmpTyp=" + CmpTyp + "&flag=" + flag + "&mapcode=" + mapcode + "&CMPNSTN_CODE=" + CMPNSTN_CODE +
            //    "&CNTST_CODE=" + CNTST_CODE + "&KPI_CODE=" + KPI_CODE + "&bizsrc=" + bizsrc + "&chncls=" + chncls + "&memtype=" + memtype +
            //    "&DRVDKPI=" + DRVDKPI + "&RuleSetKey=" + RuleSetKey + "&KPIMode=" + KPIMode + "&KpiCode=" + KpiCode + "&Mode=" + Mode
            //+ "&mdlpopup=mdlVwBID";

            window.open("../Saim/RuleSetPages/FFContestPageStdDef.aspx?role=maker&CmpTyp=" + CmpTyp + "&flag=" + flag + "&mapcode=" + mapcode + "&CMPNSTN_CODE=" + CMPNSTN_CODE +
                "&CNTST_CODE=" + CNTST_CODE + "&KPI_CODE=" + KPI_CODE + "&bizsrc=" + bizsrc + "&chncls=" + chncls + "&memtype=" + memtype +
                "&DRVDKPI=" + DRVDKPI + "&RuleSetKey=" + RuleSetKey + "&KPIMode=" + KPIMode + "&KpiCode=" + KpiCode + "&Mode=" + Mode, '', 'width=900,height=550,toolbar=no,scrollbars=Yes,resizable=No,left=180,top=150,location=0;');
            ...
            <ContentTemplate>
                <div id="divqualhdrcollapse" runat="server" style="width: 97%;" class="panel">
                    ...
                    <div id="divqual" runat="server" class="panel-body">
                        ...
                        <div class="row" style="margin-bottom: 5px;">
                            <div class="col-sm-3" style="text-align: left">
                                 <asp:Label ID="lblincstaason" Text="Income Status as on" runat="server" CssClass="control-label" />
                                 <asp:Label ID="Label32" Text="*" runat="server" Visible="false" ForeColor="red" />
                                </div>
                             <div class="col-sm-3" style="text-align: left">
                                 <asp:DropDownList runat="server" Enabled="false" ID="ddlincstaason" 
                                            CssClass="form-control" Width="100%">
                                 </asp:DropDownList>
                             
                                </div>
                                <div class="col-sm-3" style="text-align: left">
                                    <asp:Label ID="lblMemhierusdate" Text="Member Hierarchy Date Logic" runat="server" CssClass="control-label" />
                                    <asp:Label ID="Label33" Text="*" runat="server" Style="color: Red" />
                                </div>
                                <div class="col-sm-3">
                                            <asp:DropDownList ID="ddlMemhierusdate" runat="server" AutoPostBack="true" CssClass="form-control"
                                                TabIndex="4">
                                            </asp:DropDownList>
                                    </div>
                            </div>
    ...
    <%--    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
        <ContentTemplate>
            ...
            <asp:HiddenField ID="hdnKPICategory" runat="server" />
            <asp:HiddenField ID="hdnMemhierusdate" runat="server" />
            <asp:HiddenField ID="hdnMemhierusdatevalue" runat="server" />
            <asp:HiddenField ID="hdnincstsval" runat="server" />

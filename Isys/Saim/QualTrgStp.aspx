<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true"
    CodeFile="QualTrgStp.aspx.cs" Inherits="Application_ISys_Saim_QualTrgStp" %>
                            ...
                            <asp:GridView ID="dgQualTrg" runat="server" AutoGenerateColumns="false" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Member Code" SortExpression="MEM_CODE">
                                        <ItemStyle HorizontalAlign="Right" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblMemCode" runat="server" Text='<%# Bind("MEM_CODE")%>'></asp:Label>
                                            <asp:HiddenField ID="hdnMemCode" runat="server" Value='<%# Bind("MEM_CODE")%>' />
                                           
                                        </ItemTemplate>
                                    </asp:TemplateField>


                                    <asp:TemplateField HeaderText="Member Location" SortExpression="MEM_UNT_CODE">
                                        <ItemStyle HorizontalAlign="Right" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblMemLocation" runat="server" Text='<%# Bind("MEM_UNT_CODE")%>'></asp:Label>
                                            <asp:HiddenField ID="hdnMemLoc" runat="server" Value='<%# Bind("MEM_UNT_CODE")%>' /> 
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6" style="text-align: left;padding-left:40px;">
                        <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                            <ContentTemplate>
                                <asp:CheckBox ID="chkConfTrg" Enabled="true" AutoPostBack="true"

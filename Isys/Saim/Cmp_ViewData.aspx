                                        ...
                                        <tr>
                                            <td style="white-space: nowrap;">
                                                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Button ID="btnprevious" runat="server" OnClick="btnprevious_Click" CssClass="form-submit-button" Enabled="false"  Style="border-style: solid; border-width: 1px; background-repeat: no-repeat;
                                                        ...
                                                        <asp:Button ID="btnnext" runat="server" OnClick="btnnext_Click"  CssClass="form-submit-button"  Style="border-style: solid;
                        ...
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gvRevPolicy" runat="server" AutoGenerateColumns="false" Width="100%" Visible="true"
                                    PageSize="10" AllowSorting="True"  AllowPaging="true"   onRowDataBound="gvRevPolicy_RowDataBound"
                                    CssClass="footable" >
                                    <RowStyle CssClass="GridViewRowNew"></RowStyle>
                                    <PagerStyle CssClass="disablepage" />
                                    <HeaderStyle CssClass="gridview th" />
                                    <Columns>
                                         ...
                                         <asp:TemplateField HeaderText="Action">  
                                                               <HeaderTemplate>
                                                                <asp:CheckBox ID="chkall" runat="server" OnCheckedChanged="chkLeftAll_CheckedChanged" AutoPostBack="true"  />
                                                                </HeaderTemplate>
                                                       <%--<EditItemTemplate>  
...
<%--                                                            <asp:CheckBox ID="chkOne" runat="server" />  --%>
                                        ...
                                        <asp:TemplateField HeaderText="Policy No" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="HdnRevpolicyNo" Value='<%# Bind("POLICY_NO") %>' runat="server" />
                                        ...
                                        <tr>
                                            <td style="white-space: nowrap;">
                                                <asp:UpdatePanel ID="UpdatePanelrev7" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Button ID="revbtnprevious" runat="server" OnClick="revbtnprevious_Click" CssClass="form-submit-button" Enabled="false"  Style="border-style: solid; border-width: 1px; background-repeat: no-repeat;
                                                        background-color: transparent; float: left; margin: 0; height: 30px;" Text="&lt;" Width="40px"  />
                                                        <asp:TextBox ID="revtxtPage" runat="server"  Text="1" CssClass="form-control" ReadOnly="true" Style="width: 50px; border-style: solid;
                                                        border-width: 1px; border-color: Gray; height: 30px; float: left; margin: 0;
                                                        text-align: center;" />
                                                        <asp:Button ID="revbtnnext" runat="server" OnClick="revbtnnext_Click" CssClass="form-submit-button"  Style="border-style: solid;
                                                        border-width: 1px; background-repeat: no-repeat; background-color: transparent;
                                                        float: left; margin: 0; height: 30px;" Text="&gt;" Width="40px"  />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="GrdParPolicy" runat="server" AutoGenerateColumns="false" Width="100%" Visible="true"
                                    PageSize="10" AllowSorting="True"  AllowPaging="true"   onRowDataBound="GrdParPolicy_RowDataBound" 
                                    CssClass="footable" >
                                    <RowStyle CssClass="GridViewRowNew"></RowStyle>
                                    <PagerStyle CssClass="disablepage" />
                                    <HeaderStyle CssClass="gridview th" />
                             ...
                             HeaderStyle-Wrap="true" ItemStyle-HorizontalAlign="Center" >
                                        ...
                                        <asp:TemplateField HeaderText="Policy Tenure " HeaderStyle-HorizontalAlign="Center"
                                           ...
                                           <asp:TemplateField HeaderText="Reason For Revised">
                                               ...
                                               <asp:DropDownList runat="server" ID="ddlRsnFrResdA" AutoPostBack="true" 
                                                CssClass="form-control" Width="100%"       >   <%-- SelectedValue='<%# Bind ("RSN_FOR_RVSD") %>'--%>

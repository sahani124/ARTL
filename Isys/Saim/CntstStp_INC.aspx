<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true"
    CodeFile="CntstStp_INC.aspx.cs" Inherits="Application_ISys_Saim_CntstStp_INC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function funViewData(RuleSetkey, kpiCode, Memcode, CycleCode, lnkbtn, flag) {
            debugger;
            //    window.open("CntstStp_INC.aspx");

            window.open("Cmp_ViewData.aspx?flag=" + flag + "&RuleSetKey=" + RuleSetkey + "&kpiCode=" + kpiCode + "&Memcode=" +
                Memcode + "&CycleCode=" + CycleCode + "&lnkbtn=" + lnkbtn + "&#divKPIRR", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=40,left=70,bottom=80,width=1200,height=600");


        }


        function funViewStddef(CmpTyp, flag, mapcode, RuleSetKey, Memcode, lblCompCodeVal, lblCntstCdVal, HiddenKpiCode, drvdkpi, CYCLE, lnkbtn, KPITrgt) {
            debugger;
            //    window.open("CntstStp_INC.aspx");

            window.open("RuleSetPages/FFContestPageStdDef.aspx?CmpTyp=" + CmpTyp + "&flag=" + flag + "&mapcode=" + mapcode + "&RuleSetKey=" + RuleSetKey + "&Memcode=" + Memcode
                + "&CMPNSTN_CODE=" + lblCompCodeVal + "&CNTST_CODE=" + lblCntstCdVal + "&KPI_CODE=" + HiddenKpiCode
                + "&DRVDKPI=" + drvdkpi + "&CYCLE=" + CYCLE + "&lnkbtn=" + lnkbtn + "&KPITrgt=" + KPITrgt + "&#divKPIRR", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=40,left=70,bottom=80,width=1200,height=600");
        ...
        function funBulkUpload(cmpcode, cntstcode) {
            debugger;
            var strContent = "ctl00_ContentPlaceHolder1_";
            $find("mdlVwBID").show();
            document.getElementById("ctl00_ContentPlaceHolder1_ifrmRwd1").src = "BulkTarUpload.aspx?CmpCode=" + cmpcode
                + "&CntstCode=" + cntstcode
                + "&mdlpopup=mdlVwBID";
        }
        ...
        function funEditPopUp(div, rultyp, code, sID) {
            ...
            var strContent = "ctl00_ContentPlaceHolder1_";
            $find("mdlViewBID").show();
            document.getElementById("ctl00_ContentPlaceHolder1_ifrmMdlPopup").src = "PopQualSetup.aspx?code=" + code
        ...
        //function funPopUpTrgEdit(sort, cmpcode, cntstcd, rultyp, catgcd, sID, code, flag, RuleSetKey, FlagEnquiry, RuleCode, CYCLE) {
        //    debugger;
        //    var strContent = "ctl00_ContentPlaceHolder1_";
        ...
        //    + "&rultyp=" + rultyp + "&catgcd=" + catgcd + "&sID=" + sID + "&sort=" + sort + "&code=" + code + "&flag=" + document.getElementById(strContent + "hdnFlag").id + "&RuleSetKey=" + RuleSetKey + "&FlagEnquiry=" + FlagEnquiry
        //   + "&RuleCode=" + RuleCode + "&CYCLE=" + CYCLE + "&mdlpopup=mdlVwQTrgBID";
        //}
        ...
        function funRunStep(id) {
            ...
            //document.getElementById("ctl00_ContentPlaceHolder1_load").style.display = "block";
            document.getElementById("ctl00_ContentPlaceHolder1_imgStatus").style.display = "block";
            document.getElementById("ctl00_ContentPlaceHolder1_lblStatus").style.display = "block";
            document.getElementById("ctl00_ContentPlaceHolder1_imgStatus").src = "../../../images/spinner.gif"
            document.getElementById("ctl00_ContentPlaceHolder1_lblStatus").value = "Please Wait"
        ...
        function funPopUpTrgEdit(sort, cmpcode, cntstcd, rultyp, catgcd, sID, code, flag, FlagEnquiry) {
            debugger;
            var strContent = "ctl00_ContentPlaceHolder1_";
            $find("mdlVwQTrgBID").show();
            document.getElementById("ctl00_ContentPlaceHolder1_ifrmQualTrg").src = "QualTrgStp_INC.aspx?compcode=" + cmpcode + "&cntstcd=" + cntstcd
                + "&rultyp=" + rultyp + "&catgcd=" + catgcd + "&sID=" + sID + "&sort=" + sort + "&code=" + code + "&flag=" + document.getElementById(strContent + "hdnFlag").id + "&FlagEnquiry=" + FlagEnquiry
        ...
        //      + "','R','" + hdnCode.Value.ToString().Trim() + "','" + FlagEnquiry + "');", true);
        ...
        function funPopUpTrgEditRev(sort, cmpcode, cntstcd, rultyp, code, RuleSetKey, Memcode, FlagEnquiry) {
            var strContent = "ctl00_ContentPlaceHolder1_";
            debugger;
            $find("mdlVwQTrgBID").show();
            document.getElementById("ctl00_ContentPlaceHolder1_ifrmQualTrg").src = "QualTrgStp_INC.aspx?compcode=" + cmpcode + "&cntstcd=" + cntstcd
                + "&rultyp=" + rultyp + "&RuleSetKey=" + RuleSetKey + "&sort=" + sort + "&code=" + code + "&Memcode=" + Memcode + "&FlagEnquiry=" + FlagEnquiry
                + "&mdlpopup=mdlVwQTrgBID";

            //ScriptManager.RegisterStartupScript(this, this.GetType(), "popup", "funPopUpTrgEditRev('','" + lblCompCodeVal.Text.ToString().Trim() + "','" + lblCntstCdVal.Text.ToString().Trim()
            //    + "','R','" + hdnCode.Value.ToString().Trim() + "','" + hdnRulStKy.Value.ToString().Trim() + "','" + Request.QueryString["Memcode"].ToString() + "'," + FlagEnquiry + "');", true);
        ...
        function FunHideUnhideTRG(id) {

            //ctl00_ContentPlaceHolder1_DivOriginalTrg
            document.getElementById("ctl00_ContentPlaceHolder1_DivOriginalTrg").style.display = "none"
            document.getElementById("ctl00_ContentPlaceHolder1_divRevisedTrg").style.display = "none"


            document.getElementById(id).style.display = "Block"
        }

        function FunHideUnhideTRGACH(id) {

            //ctl00_ContentPlaceHolder1_DivOriginalTrg

            //  alert(id);
            document.getElementById("ctl00_ContentPlaceHolder1_DivTrgAchRevised").style.display = "none"
            document.getElementById("ctl00_ContentPlaceHolder1_DivTrgAchOriiginal").style.display = "none"


            document.getElementById(id).style.display = "Block"
        }

        function FunHideUnhideRewardRules(id) {
            //Reward Rules

            //ctl00_ContentPlaceHolder1_DivOriginalTrg

            //  alert(id);
            document.getElementById("ctl00_ContentPlaceHolder1_divRevisedRWDRule").style.display = "none"
            document.getElementById("ctl00_ContentPlaceHolder1_divOriginalRWDRule").style.display = "none"


            document.getElementById(id).style.display = "Block"
        }

        function FunHideUnhideRewardRulesResult(id) {
            //Reward Rules
            ...
            document.getElementById("divOriginalRWDRuleResult").style.display = "none"
            document.getElementById("divRevisedRWDRuleResult").style.display = "none"
      ...
      <%--  function Validation() {
            if ((document.getElementById('<%=ddlRuleSet.ClientID %>').value == "Select") || (document.getElementById('<%=ddlRuleSet.ClientID %>').value == "")) {
                alert("Please Select Rule Set Key");
                document.getElementById('<%= ddlRuleSet.ClientID %>').focus();

                return false;
            }
            if ((document.getElementById('<%=ddlCycleCode.ClientID %>').value == "Select") || (document.getElementById('<%=ddlCycleCode.ClientID %>').value == "")) {
                alert("Please Select Cycle Code");
                document.getElementById('<%= ddlCycleCode.ClientID %>').focus();

                return false;
            }
            if ((document.getElementById('<%=ddlCatgCode.ClientID %>').value == "Select") || (document.getElementById('<%=ddlCatgCode.ClientID %>').value == "")) {
                alert("Please Select Category Description");
                document.getElementById('<%= ddlCatgCode.ClientID %>').focus();
       ...
       <%-- function Validation1() {
            if ((document.getElementById('<%=ddlRSetK_Rwd.ClientID %>').value == "Select") || (document.getElementById('<%=ddlRSetK_Rwd.ClientID %>').value == "")) {
                alert("Please Select Rule Set Key");
                document.getElementById('<%= ddlRSetK_Rwd.ClientID %>').focus();

                return false;
            }
            if ((document.getElementById('<%=ddlCyCod_Rwd.ClientID %>').value == "Select") || (document.getElementById('<%=ddlCyCod_Rwd.ClientID %>').value == "")) {
                alert("Please Select Cycle Code");
                document.getElementById('<%= ddlCyCod_Rwd.ClientID %>').focus();

                return false;
            }
            if ((document.getElementById('<%=ddlCatgCod_Rwd.ClientID %>').value == "Select") || (document.getElementById('<%=ddlCatgCod_Rwd.ClientID %>').value == "")) {
                alert("Please Select Category Description");
                document.getElementById('<%= ddlCatgCod_Rwd.ClientID %>').focus();
    ...
    <asp:Panel ID="Panel3" runat="server">
        <center>
            ...
            <div id="MemberDetails" runat="server" style="width: 97%;" class="panel">
                 <div class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divcntst','Img1');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left" >
                               <%-- <span class="glyphicon glyphicon-menu-hamburger" style="color: Orange;"></span>&nbsp;--%>
                               <img id="ImageMEM" src="../../../images/member_details_Icon.png" style="border-width:0px;width: 35px;margin-top: 0px;margin-bottom:10px;height: 35px;"/>
                                <asp:Label ID="lblMember" Text="Member Details" Style="font-size:19px;" runat="server" />
                            </div>
                            <div class="col-sm-2">
                                <%--<img id="Img5" src="../../../assets/img/portlet-reload-icon-white.png" style="padding-right: 5px;"
                                    alt="" onclick="funcall();" />--%>
                                <span id="Imgmem" class="glyphicon glyphicon-menu-hamburger" style="float: right;color:#034ea2;
                            padding: 1px 10px ! important; font-size: 18px;"></span> <%--added by ajay sawant 25/4/2018--%>
                            </div>
                        </div>
                    </div>
                 <div id="divMeDtls" runat="server" style="width: 96%;text-align:left;white-space:nowrap;" class="panel-body">
                        <div class="row" style="margin-bottom: 5px;">
                            <div class="col-sm-3" style="text-align: left">
                                <asp:Label ID="lblmem" Text="Member Code" runat="server" CssClass="control-label" /><%--col-md-5--%>
                            </div>
                            <div class="col-sm-3">
                                <asp:Label ID="txtMemberCode" runat="server" CssClass="form-control-static new_text_new"></asp:Label>
                            </div>
                            <div class="col-sm-3" style="text-align: left">
                                <asp:Label ID="lblMemberName" Text="Member Name" runat="server" CssClass="control-label" />
                            </div>
                            <div class="col-sm-3">
                                <asp:Label ID="txtmemberName" runat="server" CssClass="form-control-static new_text_new"></asp:Label>
                            </div>
                        </div>
               </div>
              ...
              <%--  <asp:UpdatePanel runat="server" ID="">
                    <ContentTemplate>--%>
                        <div id="divqualcollapse" runat="server" style="width: 97%;" class="panel">
                            ...
                            <div id="div12" runat="server" style="display: none; text-align: left;padding-left: 42px;">
                                <asp:CheckBox ID="chkQual" runat="server" CssClass="checkbox"/>
                            ...
                            <div id="divqual" runat="server" class="panel-body">
                                ...
                                <h3 class="form-section" style="text-align: left;">
                                    <img id="ImageKPITrg" src="../../../images/Key_Performance_Indicator_targets.png" style="border-width:0px;width: 35px;margin-top: 6px;margin-bottom:10px;height: 35px;"/>
                                ...
                                <div class="row" style="margin-top: 12px;">
                                    <div class="col-sm-12" align="center">
                                        ...
                                        <asp:LinkButton ID="btnBlkQualTrg" runat="server" CssClass="btn btn-sample" Visible="true" Enabled="true">
                        ...
                        <div id="divRwdcollapse" runat="server" style="width: 97%;" class="panel">
                            ...
                            <div id="divKPI" runat="server" >
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="dgReward" runat="server" CssClass="footable" AllowSorting="True"
                                                ...
                                                <HeaderStyle CssClass="gridview th" />
                                                <Columns>
                                                    <asp:TemplateField HeaderText="RS Key" SortExpression="RULE_CODE">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkRulStKy" runat="server" Text='<%# Bind("RULE_SET_KEY")%>' />
                                                            <asp:LinkButton ID="lblRulCode" runat="server" Text='<%# Bind("RULE_CODE")%>' OnClick="lblRulCdRwd_Click" Visible="false"></asp:LinkButton>
                                                            <asp:HiddenField ID="hdnRulCode" runat="server" Value='<%# Bind("RULE_CODE")%>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="RS Key Desc" SortExpression="RULE_SET_KEY">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblRulStKy" runat="server" Text='<%# Bind("RULE_SET_KEY_DESC")%>'></asp:Label>
                                                            <asp:HiddenField ID="hdnRulStKy" runat="server" Value='<%# Bind("RULE_SET_KEY")%>' />
                                                        </ItemTemplate>
                                ...
                                <div id="divKPIT" runat="server">
                                    ...
                                    Key Performance Indicator Targets</h3>
                              <ul class="nav nav-pills" id="trgOR"  runat="server">
            <li class="liRO"><a href="#DivOriginalTrg" onclick="FunHideUnhideTRG('ctl00_ContentPlaceHolder1_DivOriginalTrg')" class="aRO">Original Target</a></li>
            <li style="
    width: 25%;
    font-size: initial;
"><a href="#divRevisedTrg" onclick="FunHideUnhideTRG('ctl00_ContentPlaceHolder1_divRevisedTrg')" class="aROG">Revised Target</a></li>
          
                           </ul>


                                    <div runat="server" id ="DivOriginalTrg">


                                    <%--added by amit on 13/10/2018--%>
                               <%-- <h3 class="form-section" style="text-align: left;">
                                    Key Performance Indicator Targets Search</h3>--%>
                                     <div id="div24" runat="server" visible="false" style="width: 100%;margin-left:-3px;margin-right:-3px" class="panel">
                                       <div id="div22" runat="server" class="panel-heading" onclick="ShowDiv('divchkRwd');">
                                <div id="div23" runat="server" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_div20','span1');return false;">
                                    <div class="row">
                                        <div class="col-sm-10" style="text-align: left">
                                           
                                            <asp:Label ID="Label22" Text="Key Performance Indicator Targets Search"  style="font-size: 20px;" runat="server" />
                                        </div>
                                        <div class="col-sm-2">
                            ...
                            padding: 1px 10px ! important; font-size: 18px;"></span>
                                    ...
                                    <div id="div20" runat="server" style="width: 100%;margin-left:-3px;margin-right:-3px" class="panel-body">
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="Label15" Text="Rule Set Key" runat="server" CssClass="control-label" ></asp:Label>
                     <%--  <span style="color: #ff0000">&nbsp*</span>--%>
                    </div>
                    <div class="col-sm-3">
                        <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlRuleSet" runat="server"  CssClass="select2-container form-control" OnSelectedIndexChanged="ddlRuleSet_SelectedIndexChanged"  AutoPostBack="true">
                                 </asp:DropDownList>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="Label16" Text="Cycle Code" runat="server" CssClass="control-label"></asp:Label>
                       <%--  <span style="color: #ff0000">&nbsp*</span>--%>
                    </div>
                    <div class="col-sm-3">
                        <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                            <ContentTemplate>
                               <asp:DropDownList ID="ddlCycleCode" runat="server" AutoPostBack="true" CssClass="select2-container form-control">
                                    </asp:DropDownList> 
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                ...
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="Label17" Text="Category Code" runat="server" CssClass="control-label"></asp:Label>
                       <%--  <span style="color: #ff0000">&nbsp*</span>--%>
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="row" style="margin-top: 12px;">
                    <div class="col-sm-12" align="center">
                                ...
                                <asp:LinkButton ID="btnSearch_KPIT" runat="server" CssClass="btn btn-sample" OnClick="btnSearch_KPIT_Click">
                                    <span class="glyphicon glyphicon-search" style="color: White;"></span> Search
                                </asp:LinkButton>
                                <asp:LinkButton ID="btnClear_KPIT" runat="server" CssClass="btn btn-sample" OnClick="btnClear_KPIT_Click">
                                    ...
                                    <%--Ended by amit on 13/10/2018--%>

                                <div id="div5" runat="server" style="width: 100%; border: none; margin: 0px 0 !important;overflow:auto "
                                    class="table-scrollable">
                                     <%--added by Amit Marathe on 15/10/2018--%>
                                   
                                     <%--Ended by Amit Marathe on 15/10/2018--%>
                                ...
                                <div id="tblrwdtrg" runat="server" class="row" style="margin-top: 12px; ">
                                    <div class="col-sm-12" align="center">
                                        ...
                                        <asp:LinkButton ID="btnBlkRwTrg" Text="BULK ADD TARGETS" runat="server" CssClass="btn btn-sample" Visible="false"  Style="display:none;"
                                            Enabled="true">
                                                    <span class="glyphicon glyphicon-plus BtnGlyphicon" style="color: White;"></span> Bulk Add Targets    
                                        </asp:LinkButton>
                                        ...
                                        <asp:LinkButton ID="btnEdit" runat="server" CssClass="btn btn-sample" Enabled="true"  OnClick="btnEdit_Click"
                                            >
                                                <span class="glyphicon glyphicon-plus BtnGlyphicon" style="color: White;"></span> Copy Targets
                                        </asp:LinkButton>
                                     ...
                                     <div runat="server" id ="divRevisedTrg"  style="display:none;" >



                                          <div id="div28" runat="server" style="width: 100%; border: none; margin: 0px 0 !important;overflow:auto "
                                    class="table-scrollable">
                                     <%--added by Amit Marathe on 15/10/2018--%>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel21" runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="trgReviseGrd" runat="server" CssClass="footable" AllowSorting="True"
                                                AllowPaging="true" AutoGenerateColumns="false" OnRowDataBound="dgRwdTrg_RowDataBound"
                                                OnSorting="dgRwdTrg_Sorting"  PageSize="10">
                                                <RowStyle CssClass="GridViewRowNew"></RowStyle>
                                                <PagerStyle CssClass="disablepage" />
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="RS Key" SortExpression="RULE_SET_KEY">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:HiddenField ID="hdnRulStKy" runat="server" Value='<%# Bind("RULE_SET_KEY")%>' />
                                                            <asp:HiddenField ID="hdnBusiCode" runat="server" Value='<%# Bind("BUSI_CODE")%>' />
                                                            <asp:HiddenField ID="hdnCodeREV" runat="server" Value='<%# Bind("CODE")%>' />
                                                            <asp:HiddenField ID="HiddenRulecode" runat="server" Value='<%# Bind("RULE_CODE")%>' />
                                                            <asp:HiddenField ID="HiddenCycleCode" runat="server" Value='<%# Bind("CYCLE_CODE")%>' />
                                                            <asp:HiddenField ID="HiddenKpiCode" runat="server" Value='<%# Bind("KPI_CODE")%>' />
                                                            <asp:HiddenField ID="hdnKpiOrg" Value='<%# Bind("KPI_ORIGIN")%>' runat="server">
                                                    ...
                                                    <asp:TemplateField HeaderText="Action">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkEditRwdTrgRev" runat="server" Text="Edit" OnClick="lnkEditRwdTrgRev_Click"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Action">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Std Def.">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkKPITrgtSetRule" runat="server" Text="Set Rule" OnClick="lnkKPITrgtSetRule2_Click"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                                ...
                                <div id="div29" visible="true" runat="server" class="pagination" style="padding: 10px;">
                                    <center>
                                        <table>
                                            <tr>
                                                <td style="white-space: nowrap;">
                                                    <asp:UpdatePanel ID="UpdatePanel22" runat="server">
                                                        <ContentTemplate>
                                                            <asp:Button ID="Button5" Text="<" CssClass="form-submit-button" runat="server"
                                                                Width="40px" Enabled="false" Style="border-style: solid; border-width: 1px; background-repeat: no-repeat;
                                                                background-color: transparent; float: left; margin: 0; height: 30px;" OnClick="btnprevrwdtrg_Click" />
                                                            <asp:TextBox runat="server" ID="TextBox2" Style="width: 40px; border-style: solid;
                                                                border-width: 1px; border-color: Gray; height: 30px; float: left; margin: 0;
                                                                text-align: center;" Text="1" CssClass="form-control" ReadOnly="true" />
                                                            <asp:Button ID="Button6" Text=">" CssClass="form-submit-button" runat="server"
                                                                Style="border-style: solid; border-width: 1px; background-repeat: no-repeat;
                                                                background-color: transparent; float: left; margin: 0; height: 30px;" Width="40px"
                                                                Enabled="false" OnClick="btnnextrwdtrg_Click" />
                                                        </ContentTemplate>
                                ...
                                <div id="divAchieve" runat="server" style="width: 100%;margin-left:-3px;margin-right:-3px" class="panel">
                                       
                                    <h3 class="form-section" style="text-align: left;">
                                        <img id="ImageMEMAC" src="../../../images/member_achievement_icon.png" style="border-width:0px;width: 35px;margin-top: 6px;margin-bottom:10px;height: 35px;"/>
                                     Member Achievements</h3>


                                        <ul class="nav nav-pills" id="achOR" runat="server">
            <li class="liRO"><a href="#DivTrgAchOriiginal" onclick="FunHideUnhideTRGACH('ctl00_ContentPlaceHolder1_DivTrgAchOriiginal')" class="aRO">Original Achievement</a></li>
            <li style="   width: 25%;    font-size: initial;">
                <a href="#DivTrgAchRevised" onclick="FunHideUnhideTRGACH('ctl00_ContentPlaceHolder1_DivTrgAchRevised')" class="aROG">Revised Achievement</a></li>
          
                           </ul>

                                       <div runat="server" id ="DivTrgAchOriiginal">
                                    ...
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="dgTrgMEM" runat="server" CssClass="footable" AllowSorting="True" PageSize="10"
                                             ...
                                             <asp:TemplateField HeaderText="Category Code">
                                                ...
                                                <ItemStyle HorizontalAlign="Center" Width="20px"  CssClass="gridcenter"/>
                                                <ItemTemplate>
                                             ...
                                             <asp:TemplateField HeaderText="Category Description" SortExpression="CategoryDesc">
                                                ...
                                                <ItemStyle HorizontalAlign="Center" Width="20px" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lbllegalname" runat="server" Text='<%# Bind("legalname")%>' />
                                                     
                                                   
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="Member Cycle" SortExpression="MEM_PAY_CYCLE">
                                                <HeaderStyle Width="20px" />
                                                <ItemStyle HorizontalAlign="Center" Width="20px" CssClass="gridcenter" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMEM_PAY_CYCLE" runat="server" Text='<%# Bind("MEM_PAY_CYCLE")%>' />
                                                   
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                           <asp:TemplateField HeaderText="KPI Description" SortExpression="KPI_CODE">
                                                <HeaderStyle Width="20px" />
                                                <ItemStyle HorizontalAlign="Center" Width="20px" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblKPI_DESC" runat="server" Text='<%# Bind("KPI_DESC")%>' />
                                                    <asp:HiddenField ID="hdnKPI_CODE" runat="server" Value='<%# Bind("KPI_CODE")%>' />

                                                </ItemTemplate>
                                            </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="Member Achivement" SortExpression="CALC_RESULT">
                                                <HeaderStyle Width="20px" />
                                                <ItemStyle HorizontalAlign="Right" Width="20px"  CssClass="gridright" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCALC_RESULT" runat="server" Text='<%# Bind("CALC_RESULT")%>' />
   ...
   <asp:TemplateField HeaderText="Action1">  
                                                    ...
                                                    <ItemStyle HorizontalAlign="Center" />
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkRevised" runat="server" Text="Revised" 
                                                          OnClick="lnkRevised_Click"  ></asp:LinkButton>    
                                       ...
                                       <div runat="server" id ="DivTrgAchRevised" style="display:none;">
                                           <div id="div30" runat="server" style="width: 100%; border: none; margin: 0px 0 !important;overflow:auto;"
                                    class="table-scrollable">
                                     <%--added by Amit Marathe on 15/10/2018--%>
                                    ...
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="GrdACHRevised" runat="server" CssClass="footable" AllowSorting="True" PageSize="10"
                                                AllowPaging="true" AutoGenerateColumns="false" >
                                                <RowStyle CssClass="GridViewRowNew"></RowStyle>
                                                <PagerStyle CssClass="disablepage" />
                                                <HeaderStyle CssClass="gridview th" />
                                ...
                                <div id="divKPIRR" runat="server" >
                                  ...
                                  <%--   <h3 class="form-section" style="text-align: left;">
                                    Key Performance Indicator Reward Rules Search</h3>--%>
                                     
                                      <div id="div25" runat="server" visible="false" style="width: 100%;margin-left:-3px;margin-right:-3px" class="panel">
                                       <div id="div26" runat="server" class="panel-heading" onclick="ShowDiv('divchkRwd');">
                                <div id="div27" runat="server" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_div21','span2');return false;">
                                    <div class="row">
                                        <div class="col-sm-10" style="text-align: left">
                                           
                                            <asp:Label ID="Label23" Text=" Key Performance Indicator Reward Rules Search"  style="font-size: 20px;" runat="server" />
                                        </div>
                                        <div class="col-sm-2">
                            ...
                            padding: 1px 10px ! important; font-size: 18px;"></span>
                                        ...
                                        <div id="div21" runat="server" style="width: 100%;margin-left:-3px;margin-right:-3px" class="panel-body">
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="Label18" Text="Rule Set Key" runat="server" CssClass="control-label" ></asp:Label>
                     <%--  <span style="color: #ff0000">&nbsp*</span>--%>
                    </div>
                    <div class="col-sm-3">
                        <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlRSetK_Rwd" runat="server" AutoPostBack="true"  CssClass="select2-container form-control" OnSelectedIndexChanged="ddlRSetK_Rwd_SelectedIndexChanged" >
                                 </asp:DropDownList>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="Label19" Text="Cycle Code" runat="server" CssClass="control-label"></asp:Label>
                        <%-- <span style="color: #ff0000">&nbsp*</span>--%>
                    </div>
                    <div class="col-sm-3">
                        <asp:UpdatePanel ID="UpdatePanel19" runat="server">
                            <ContentTemplate>
                               <asp:DropDownList ID="ddlCyCod_Rwd" runat="server" AutoPostBack="true"  CssClass="select2-container form-control">
                                    </asp:DropDownList> 
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                ...
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="Label20" Text="Category Code" runat="server" CssClass="control-label"></asp:Label>
                       <%--  <span style="color: #ff0000">&nbsp*</span>--%>
                    </div>
                    <div class="col-sm-3">
                        <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlCatgCod_Rwd" runat="server" AutoPostBack="true" CssClass="select2-container form-control"
                                    TabIndex="4"> 
                                </asp:DropDownList>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                ...
                <div class="row" style="margin-top: 12px;">
                    <div class="col-sm-12" align="center">
                                ...
                                <asp:LinkButton ID="btnSearch_Rwd" runat="server" CssClass="btn btn-sample" OnClick="btnSearch_Rwd_Click">
                                    <span class="glyphicon glyphicon-search" style="color: White;"></span> Search
                                </asp:LinkButton>
                                <asp:LinkButton ID="btnClear_Rwd" runat="server" CssClass="btn btn-sample" OnClick="btnClear_Rwd_Click">
                                    <span class="glyphicon glyphicon-erase BtnGlyphicon"></span> Clear
                                </asp:LinkButton>
                                    ...
                                    <h3 class="form-section" style="text-align: left;">
                                         <img id="ImageRWDRule" src="../../../images/member_reward_rule.png" style="border-width:0px;width: 35px;margin-top: 6px;margin-bottom:10px;height: 35px;"/>
                                     Member Reward Rules</h3>

                                            <ul class="nav nav-pills" id="RWDOR"  runat="server">
            <li class="liRO"><a href="#divOriginalRWDRule" onclick="FunHideUnhideRewardRules('ctl00_ContentPlaceHolder1_divOriginalRWDRule')" class="aRO">Original Reward Rules</a></li>
            <li style="   width: 25%;    font-size: initial;">
                <a href="#divRevisedRWDRule" onclick="FunHideUnhideRewardRules('ctl00_ContentPlaceHolder1_divRevisedRWDRule')" class="aROG">Revised Reward Rules</a></li>
          
                           </ul>
                                    <div id="divOriginalRWDRule">

                                <div id="divRwdRul" runat="server" style="width: 100%; border: none; margin: 0px 0 !important;overflow:auto;"
                                    class="table-scrollable">
                                     <%--added by Amit Marathe on 15/10/2018--%>
                                ...
                                <div id="tblrwdrul" runat="server" class="row" style="margin-top: 12px;">
                                    ...
                                    <div id="divRevisedRWDRule" style="display:none;">

                                        
                                <div id="div32" runat="server" style="width: 100%; border: none; margin: 0px 0 !important;overflow:auto;"
                                    class="table-scrollable">
                                     <%--added by Amit Marathe on 15/10/2018--%>
                                    ...
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="GrgRWDRevised" runat="server" CssClass="footable" AllowSorting="True" PageSize="10"
                                                OnSorting="dgRwdRul_Sorting" AllowPaging="true" AutoGenerateColumns="false" >
                                                <RowStyle CssClass="GridViewRowNew"></RowStyle>
                                                <PagerStyle CssClass="disablepage" />
                                                <HeaderStyle CssClass="gridview th" />
                                                <Columns>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <div id="divChild" runat="server" style="display: none; width: auto; margin: 0px 0 !important;"
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel61" runat="server">
                                                        <ContentTemplate>
                                                            <asp:GridView ID="dgCntst12" runat="server" AutoGenerateColumns="false" Width="100%"
                                                                PageSize="10" AllowSorting="False" AllowPaging="true" CssClass="footable"
                                                                 >
                                ...
                                <div id="div33" visible="true" runat="server" class="pagination" style="padding: 10px;">
                                    <center>
                                        <table>
                                            <tr>
                                                <td style="white-space: nowrap;">
                                                    <asp:UpdatePanel ID="UpdatePanel23" runat="server">
                                                        <ContentTemplate>
                                                            <asp:Button ID="Button7" Text="<" CssClass="form-submit-button" runat="server"
                                                                Width="40px" Enabled="false" Style="border-style: solid; border-width: 1px; background-repeat: no-repeat;
                                                                background-color: transparent; float: left; margin: 0; height: 30px;" OnClick="btnprevrwdrul_Click" />
                                                            <asp:TextBox runat="server" ID="TextBox3" Style="width: 40px; border-style: solid;
                                                                border-width: 1px; border-color: Gray; height: 30px; float: left; margin: 0;
                                                                text-align: center;" Text="1" CssClass="form-control" ReadOnly="true" />
                                                            <asp:Button ID="Button8" Text=">" CssClass="form-submit-button" runat="server"
                                                                Style="border-style: solid; border-width: 1px; background-repeat: no-repeat;
                                                                background-color: transparent; float: left; margin: 0; height: 30px;" Width="40px"
                                                                Enabled="false" OnClick="btnnextrwdrul_Click" />
                                                        </ContentTemplate>
                                   ...
                                   <div id="divRwdAch" runat="server" style="width: 100%;margin-left:-3px;margin-right:-3px" class="panel">
                                       

                                      <div id="div90" runat="server" style="width: 100%; border: none; margin: 0px 0 !important;overflow:auto;"
                                    class="table-scrollable">
                                     <%--added by Amit Marathe on 15/10/2018--%>
                                    <h3 class="form-section" style="text-align: left;">
                                        <img id="ImageRWDRslt" src="../../../images/member_reward_achievement_result.png" style="border-width:0px;width: 35px;margin-top: 6px;margin-bottom:10px;height: 35px;"/>

                                     Member Reward Results</h3>

                                                      <ul class="nav nav-pills" runat="server" id="RWDACHOR"> 
            <li class="liRO"><a onclick="FunHideUnhideRewardRulesResult('divOriginalRWDRuleResult')" class="aRO">Original Reward Result</a></li>
            <li style="   width: 25%;    font-size: initial;">
                <a  onclick="FunHideUnhideRewardRulesResult('divRevisedRWDRuleResult')" class="aROG">Revised Reward Result</a></li>
          
                           </ul>

                                          <div id="divOriginalRWDRuleResult">
                                     <%--Ended by Amit Marathe on 15/10/2018--%>
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="gvRwdAch" runat="server" CssClass="footable" AllowSorting="True" PageSize="10"
                                                AllowPaging="true" AutoGenerateColumns="false" >
                                                <RowStyle CssClass="GridViewRowNew"></RowStyle>
                                                <PagerStyle CssClass="disablepage" />
                                                <HeaderStyle CssClass="gridview th" />
                                             ...
                                             <asp:TemplateField HeaderText="Category Description" SortExpression="CategoryDesc">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMEM_PAY_CYCLE" runat="server" Text='<%# Bind("MEM_PAY_CYCLE")%>' />
                                                     ...
                                                     <asp:TemplateField HeaderText="Reward Description" SortExpression="RWRD_DESC">
                                                <HeaderStyle Width="20px" />
                                                <ItemStyle HorizontalAlign="Center" Width="20px" CssClass="gridcenter" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRWRD_DESC" runat="server" Text='<%# Bind("RWRD_DESC")%>' />
                                                   
                                                </ItemTemplate>
                                            </asp:TemplateField>


                                                    <asp:TemplateField HeaderText="Reward Value" SortExpression="RWRD_AMT">
                                                <HeaderStyle Width="20px" />
                                                <ItemStyle HorizontalAlign="Center" Width="20px"  CssClass="gridright"/> 
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRWRD_AMT" runat="server" Text='<%# Bind("RWRD_AMT")%>' />
                                          ...
                                          <div id="divRevisedRWDRuleResult" style="display:none;">

                                               <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="GridView1" runat="server" CssClass="footable" AllowSorting="True" PageSize="10"
                                                AllowPaging="true" AutoGenerateColumns="false" >
                                                <RowStyle CssClass="GridViewRowNew"></RowStyle>
                                                <PagerStyle CssClass="disablepage" />
                                                <HeaderStyle CssClass="gridview th" />
                ...
                <div class="row">
                     <asp:UpdatePanel id="upd" runat="server">
                        ...
                        <ContentTemplate>
                <div class="col-sm-12" id="btnLoad" runat="server"  >
                     <asp:Label ID="lblStatus" Text="Please Wait"  runat="server"  Style="text-decoration-color:green;display:none" />
                           <asp:Image ID="imgStatus" runat="server" Height="15px" Width="15px" style="display:none;" />
                ...
                <div id="Table1" runat="server" class="row" style="margin-top: 12px;">
                    <div class="col-sm-12" align="center">
                        ...
                        <asp:LinkButton ID="btnCnclFn" Text="BACK" runat="server" CssClass="btn btn-sample"
                         ...
                         <asp:LinkButton ID="LinkButton4" Text="Recompute" runat="server" CssClass="btn btn-sample"
                             OnClick="LinkButton4_Click" Visible="true">
                                <span class="glyphicon glyphicon-pencil" style="color: White;"></span> Revised   
                        </asp:LinkButton>
                      
                        <asp:LinkButton ID="LinkButton3" Text="Recompute" runat="server" CssClass="btn btn-sample"
                             OnClick="LinkButton3_Click" Visible="true"  OnClientClick="funRunStep(this.id)">
                                <span class="glyphicon glyphicon-credit-card" style="color: White;"></span> Recompute   
                        </asp:LinkButton>
                ...
                <div id="divAudit" runat="server" style="width: 97%;" class="panel">
                    <div id="div15" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divAuditTrail','Img8');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                <%--<span class="glyphicon glyphicon-menu-hamburger" style="color: Orange;"></span>&nbsp;--%>
                                <img id="ImageCompAud" src="../../../images/Compensation_Detail_Icon.png" style="border-width:0px;width: 35px;margin-top: 6px;margin-bottom:10px;height: 35px;"/>
              
                                <asp:Label ID="Label9" Text="Compensation Audit Trail" Style="font-size:19px" runat="server" />
                            </div>
                            <div class="col-sm-2">

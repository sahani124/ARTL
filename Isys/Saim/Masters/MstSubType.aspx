<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MstSubType.aspx.cs" Inherits="Application_ISys_Saim_Masters_MstSubType" MasterPageFile="~/iFrame.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <script type="text/javascript">
      ...
      function funPopup(code, bizsrc, chncls) {
          $find("mdlPopBID").show();
          document.getElementById("ctl00_ContentPlaceHolder1_ifrmPop").src = "PopMstSrvcTax.aspx?code=" + code +
            "&bizsrc=" + bizsrc + "&chncls=" + chncls + "&mdlpopup=mdlPopBID";
      }
    </script>
    <style type="text/css">
        .gridview th
    ...
    </style><asp:UpdatePanel ID="UpdatePanel11" runat="server">
        <ContentTemplate>
        <center>
                                ...
                                <asp:GridView ID="gv_DBFunction" runat="server" CssClass="footable"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Code" SortExpression="CODE">
                                         ...
                                         <asp:TemplateField HeaderText="Type Code Description" SortExpression="TYPE_DESC">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblTypeCode" runat="server" Text='<%# Bind("TYPE_DESC")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Sub Type Description" SortExpression="DESC01">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>

...
public partial class Application_ISys_Saim_Masters_PopMstAccYear : BaseClass
{
    ...
    public void GetFuncDtls()
    {
        ...
        if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
            ...
            txtYearType.Text = ds.Tables[0].Rows[0]["YEAR_TYPE"].ToString().Trim();
    ...
    protected void FillGrid()
    {
        ...
        catch (Exception ex)
        {
            ...
            objErr.LogErr("ISYS-SAIM", "PopMstAccYear", "FillGrid", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }

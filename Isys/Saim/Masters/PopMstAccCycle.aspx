<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopMstAccCycle.aspx.cs" Inherits="Application_ISys_Saim_Masters_PopMstAccCycle"
            ...
            <div id="div2" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divtrg','myImg');return false;">
                <div class="row">
                    <div class="col-sm-10" style="text-align: left">
                        ...
                        <asp:Label ID="lblhdr" Text="Accumulation Cycle Setup" runat="server" />
                    </div>
                    <div class="col-sm-2">
                        <span id="myImg" class="glyphicon glyphicon-chevron-down" style="float: right; color: Orange;
                            padding: 1px 10px ! important; font-size: 18px;"></span>
                    </div>
                </div>
            </div>
            <div id="divtrg" runat="server" style="white-space: nowrap; text-align: left;"
                class="panel-body">
                <div class="row" style="margin-bottom: 5px;">
                    ...
                    <div class="col-sm-3">
                        <asp:TextBox ID="txtCount" runat="server" CssClass="select2-container form-control"
                            placeholder="Count"></asp:TextBox>
                    </div>
                </div>
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-sm-3" style="text-align: left">
                ...
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="lblDefault" Text="Default" runat="server" CssClass="control-label" />
                    </div>
                    <div class="col-sm-3">
                        <asp:DropDownList ID="ddlDefault" runat="server" CssClass="select2-container form-control">
                            <asp:ListItem Value="Y" Text="YES"></asp:ListItem>
                            <asp:ListItem Value="N" Text="NO"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="lblDivCount" Text="Division Count" runat="server" CssClass="control-label" />
                    </div>
                    <div class="col-sm-3">
                        <asp:TextBox ID="txtDivCount" runat="server" CssClass="select2-container form-control"
                            placeholder="Division Count"></asp:TextBox>
                    </div>
                </div>

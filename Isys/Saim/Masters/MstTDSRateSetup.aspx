<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/iFrame.master" CodeFile="MstTDSRateSetup.aspx.cs" Inherits="Application_Isys_Saim_Masters_MstTDSRateSetup" %>
            ...
            <div id="Div2" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_div3','myImages');return false;">
                <div class="row">
                    <div class="col-sm-10" style="text-align: left">
                        ...
                        <asp:Label ID="Label2" Text="ADD ACTION" style="margin-left: 8px;font-size:19px;" runat="server" />
                    </div>
                    <div class="col-sm-2">
        ...
        <div id="divcmphdrcollapse" runat="server" style="width: 97%;" class="panel">
            ...
            <div id="divcmphdr" runat="server" style="width: 96%;" class="panel-body">
                ...
                <div class="row" style="margin-bottom: 5px;">
                         ...
                         <div class="col-sm-2" style="text-align: left">
                         <asp:Label ID="lblFinYr" Text="PAN Status" runat="server" CssClass="control-label" />
                    </div>
                    <div class="col-sm-2">
                      ...
                      <div class="col-sm-2">
                        <asp:UpdatePanel ID="UpdatePanel41" runat="server">
                            <ContentTemplate>
                                ...
                                <%--<asp:TextBox ID="txtAppAson" runat="server" CssClass="form-control" placeholder="DD/MM/YYYY">
                                    </asp:TextBox>--%>
                      ...
                      <div class="col-sm-2">
                        <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                            <ContentTemplate>
                               ...
                               <%-- <asp:TextBox ID="txtAppTo" runat="server" CssClass="form-control" placeholder="DD/MM/YYYY">
                                    </asp:TextBox>--%>
                ...
                <div id="divcmpsrchhdrcollapse" runat="server" style="width: 97%;" class="panel ">
                    <div class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divkpisrch','Img1');return false;">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                    <asp:Label ID="lblCmpSrch" Text="STANDARD TDS RATE SETUP"  style="font-size:19px; margin-left:-5px !important" runat="server" />
                            </div>
                               <div class="col-sm-6">
                            ...
                            padding: 1px 10px ! important; font-size: 18px;">
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                        </div>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="dgCmp" runat="server" AutoGenerateColumns="false" Width="100%"
                                    PageSize="50" AllowSorting="True" OnSorting="dgCmp_Sorting" AllowPaging="true"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="FINANCIAL YEAR" SortExpression="[Financial Year]" HeaderStyle-HorizontalAlign="Center"
                                         ...
                                         <asp:TemplateField HeaderText="NATURE OF PAYMENT" SortExpression="[Nature Of Payment]" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Wrap="true" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>          
                                         ...
                                         <asp:TemplateField HeaderText="PAN STATUS" SortExpression="[PAN Status]" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Wrap="true" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>          
                                                <asp:Label ID="lblPanStatus"  Text='<%# Bind("[PAN Status]")%>' runat="server"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <ItemStyle CssClass="cssalingleft" />
                                        </asp:TemplateField>
                                         ...
                                         <asp:TemplateField HeaderText="COMMISSION AMOUNT (Rs) FROM" SortExpression="[Comm Amt Frm]">
                                            <ItemTemplate>          
                                         ...
                                         <asp:TemplateField HeaderText="COMMISSION AMOUNT (Rs) T0" SortExpression="[Comm Amt To]">
                                            <ItemTemplate>          

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopMstAccYear.aspx.cs" Inherits="Application_ISys_Saim_Masters_PopMstAccYear"
        ...
        <div id="divtrghdrcollapse" runat="server" style="width: 95%;" class="panel panel-success">
            <div id="div2" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divtrg','myImg');return false;">
                <div class="row">
                    <div class="col-sm-10" style="text-align: left">
                        ...
                        <asp:Label ID="lblhdr" Text="Accumulation Year Setup" runat="server" Style="padding-left: 5px;" />
                    </div>
                    <div class="col-sm-2">
            ...
            <div id="divtrg" runat="server" style="white-space: nowrap; text-align: left;"
                ...
                <div class="row" style="margin-bottom: 5px;">
                    ...
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="lblYeartype" Text="Year Type" runat="server" CssClass="control-label" />
                    </div>
                    <div class="col-sm-3">
                        <asp:TextBox ID="txtYearType" runat="server" CssClass="select2-container form-control"

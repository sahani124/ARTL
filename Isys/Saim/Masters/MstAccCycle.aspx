<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/iFrame.master" CodeFile="MstAccCycle.aspx.cs"
    Inherits="Application_ISys_Saim_Masters_MstAccCycle" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <ContentTemplate>
            <center>
                <div id="divRwdcollapse" runat="server" style="width: 97%;" class="panel">
                    <div id="div2" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divRwd','Img3');return false;" style="width:96%">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                
                                <asp:Label ID="Label3" Text="MASTER SETUP" Font-Size="19px" runat="server" />
                            </div>
                            <div class="col-sm-2">
                    ...
                    <div id="divRwd" runat="server" style="width: 95%;display: block;" class="panel-body">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="gv_DBFunction" runat="server" CssClass="footable"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Accumulation Cycle Description" SortExpression="DESC01">
                                                <ItemStyle HorizontalAlign="Left" />
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Is Active" SortExpression="ISACTIVE">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblIsActive" runat="server" Text='<%# Bind("ParamDesc1")%>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" CssClass="clsCenter"/>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Count" SortExpression="COUNT" Visible="false">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCount" runat="server" Text='<%# Bind("COUNT")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Default" SortExpression="DEFAULT" Visible="false">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDefault" runat="server" Text='<%# Bind("DEFAULT")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Div Count" SortExpression="DIV_COUNT" Visible="false">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDivCount" runat="server" Text='<%# Bind("DIV_COUNT")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Cycle Type" SortExpression="CYCLE_TYPE" Visible="false">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCycleType" runat="server" Text='<%# Bind("CYCLE_TYPE")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemStyle HorizontalAlign="Center" />
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkEditRwdTrg" runat="server" Text="Edit"></asp:LinkButton>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" CssClass="clsCenter"/>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Action">
                                        ...
                                        <tr>
                                            <td style="white-space: nowrap;">
                                                <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Button ID="btnprev" Text="<" CssClass="form-submit-button" runat="server" OnClick="btnprev_Click"
                                                        ...
                                                        <asp:Button ID="btnnext" Text=">" CssClass="form-submit-button" runat="server" OnClick="btnnext_Click"
                        ...
                        <div id="tblrwdtrg" runat="server" class="row" style="margin-top: 12px;">
                            <div class="col-sm-12" align="center">
                                <asp:LinkButton ID="btnAddRwdTrg" runat="server" CssClass="btn btn-sample"
                                    Enabled="true">
                                        <span class="glyphicon glyphicon-plus BtnGlyphicon" style="color:White"></span> Add
                                    </asp:LinkButton>
                                <asp:LinkButton ID="btnSaveRwdTrg" runat="server" CssClass="btn btn-sample"
                                    Enabled="true" >
    ...
    <asp:Panel runat="server" Height="370px" Width="1020px" ID="pnlQualTrg" display="none" CssClass="panel panel-success"
        Style="text-align: center; padding: 10px;">

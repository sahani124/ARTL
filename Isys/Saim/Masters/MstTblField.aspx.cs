...
public partial class Application_ISys_Saim_Masters_MstTblField : BaseClass
{
    ...
    protected void BindGrid()
    {
        ...
        htParam.Clear();
        ds.Clear();
        ds = objDal.GetDataSetForPrc_SAIM("Prc_GetMstTblFieldDtls", htParam);
    ...
    protected void btnnext_Click(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            objErr.LogErr("ISYS-SAIM", "MstTblField", "btnnext_Click", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    #endregion
    ...
    protected void btnprev_Click(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MstTblField", "btnprev_Click", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    #endregion
}
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopMstAccMode.aspx.cs" Inherits="Application_ISys_Saim_Masters_PopMstAccMode" MasterPageFile="~/iFrame.master"%>
        ...
        <div id="divtrghdrcollapse" runat="server" style="width: 95%;" class="panel panel-success">
            <div id="div2" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divtrg','myImg');return false;">
                <div class="row">
                    <div class="col-sm-10" style="text-align: left">
                        ...
                        <asp:Label ID="lblhdr" Text="Accumulation Mode Setup" runat="server" />
                    </div>
                    <div class="col-sm-2">
            ...
            <div id="tblsvtrg" runat="server" class="row" style="margin-top: 12px;">
                <div class="col-sm-12" align="center">
                    ...
                    <asp:LinkButton ID="btnCnclTrg" runat="server" CssClass="btn btn-primary"

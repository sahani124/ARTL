<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MstAccMode.aspx.cs" MasterPageFile="~/iFrame.master"
    Inherits="Application_ISys_Saim_Masters_MstAccMode" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function funEditPopUp(code, sID) {
            ...
            document.getElementById("ctl00_ContentPlaceHolder1_ifrmQualTrg").src = "PopMstAccMode.aspx?code=" + code + "&sID=" + sID
                ...
                <div id="divRwdcollapse" runat="server" style="width: 97%;" class="panel">
                    <div id="div2" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divRwd','Img3');return false;">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                               <%-- <span id="Span1" class="glyphicon glyphicon-collapse-down" style="float: right; color: #034ea2;
                    ...
                    <div id="divRwd" runat="server" style="width: 96%; display: block;" class="panel-body">
                        <h3 class="form-section" style="text-align: left; border-bottom:none;">
                            Accumulation Mode</h3>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gv_DBFunction" runat="server" CssClass="footable" AllowSorting="True"
                                        AllowPaging="true" AutoGenerateColumns="false" OnRowDataBound="gv_DBFunction_RowDataBound"
                                        PageSize="10">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Accumulation Mode Description" SortExpression="DESC01">
                                                <ItemStyle HorizontalAlign="Left" />
                                                <ItemTemplate>
                        ...
                        <div id="tblrwdtrg" runat="server" class="row" style="margin-top: 12px;">
                            <div class="col-sm-12" align="center">
                                ...
                                <asp:LinkButton ID="btnCancelRwdTrg" runat="server" CssClass="btn btn-sample" Enabled="true">

<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true"
    CodeFile="PopMstTDS.aspx.cs" Inherits="Application_ISys_Saim_Masters_PopMstTDS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function doCancel() {
            window.parent.document.getElementById("ctl00_ContentPlaceHolder1_btntds").click();
    ...
    <center>
        <div id="divtrghdrcollapse" runat="server" style="width: 95%;" class="panel panel-success">
            <div id="div2" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divRwd','Img3');return false;">
                <div class="row">
                    <div class="col-sm-10" style="text-align: left">
                        ...
                        <asp:Label ID="lblhdr" Text="TDS Setup" runat="server" Style="padding-left: 5px;" />
                    </div>
                    <div class="col-sm-2">
            ...
            <div id="divtrg" runat="server" style="width: 100%; padding: 5px;" class="panel-body">
                ...
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="lblTaxRate" Text="TDS Rate" runat="server" CssClass="control-label" />
                        <span style="color: Red;">*</span>
                    </div>
                    <div class="col-sm-3">
                        <asp:TextBox ID="txtTaxRate" runat="server" CssClass="form-control" placeholder="TDS Rate"></asp:TextBox>
                    </div>
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="lblTaxCode" Text="TDS Code" runat="server" CssClass="control-label" />
                        <span style="color: Red;">*</span>
                    </div>
                    <div class="col-sm-3">
                        <asp:TextBox ID="txtTaxCode" runat="server" CssClass="form-control" placeholder="TDS Code"
                ...
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="lblPayTyp" Text="Payee Type" runat="server" CssClass="control-label" />
                        <span style="color: Red;">*</span>
                    </div>
                    <div class="col-sm-3">
                        <asp:TextBox ID="txtPayTyp" runat="server" CssClass="form-control" placeholder="Payee Type"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div id="tblsvtrg" runat="server" class="row" style="margin-top: 12px;">
                <div class="col-sm-12" align="center">
                    <asp:LinkButton ID="btnSave" runat="server" Width="100px" CssClass="btn btn-sample"
                        Enabled="true" OnClick="btnSave_Click">
                                <span class="glyphicon glyphicon-floppy-disk" style="color:White"></span> Save
                    </asp:LinkButton>
                    <asp:LinkButton ID="btnCnclTrg" runat="server" Width="100px" CssClass="btn btn-sample"
                        Enabled="true" OnClientClick="doCancel();return false;">

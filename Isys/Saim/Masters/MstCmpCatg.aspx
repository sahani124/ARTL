<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MstCmpCatg.aspx.cs" Inherits="Application_ISys_Saim_Masters_MstCmpCatg"  MasterPageFile="~/iFrame.master"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function funEditPopUp(code, sID) {
            ...
            document.getElementById("ctl00_ContentPlaceHolder1_ifrmQualTrg").src = "PopMstCmpCatg.aspx?code=" + code + "&sID=" + sID
                        ...
                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gv_DBFunction" runat="server" CssClass="footable"
                                    AllowSorting="True" AllowPaging="true" AutoGenerateColumns="false"  OnRowDataBound="gv_DBFunction_RowDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Compensation Category Description" SortExpression="DESC01">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>

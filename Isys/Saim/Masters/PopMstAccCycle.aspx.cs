...
public partial class Application_ISys_Saim_Masters_PopMstAccCycle : BaseClass
{
    ...
    public void GetFuncDtls()
    {
        ...
        if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
            ...
            txtCount.Text = ds.Tables[0].Rows[0]["COUNT"].ToString().Trim();
            ...
            ddlDefault.SelectedValue = ds.Tables[0].Rows[0]["DEFAULT"].ToString().Trim();
            txtDivCount.Text = ds.Tables[0].Rows[0]["DIV_COUNT"].ToString().Trim();
        }
    }
    ...
    protected void FillGrid()
    {
        ...
        catch (Exception ex)
        {
            ...
            objErr.LogErr("ISYS-SAIM", "PopMstAccCycle", "FillGrid", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }

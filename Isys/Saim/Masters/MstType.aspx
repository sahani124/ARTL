<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MstType.aspx.cs" Inherits="Application_ISys_Saim_Masters_MstType"
                    ...
                    <div id="divRwd" runat="server" style="width: 96%; white-space: nowrap; text-align: left;
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="gv_DBFunction" runat="server" CssClass="footable" AllowSorting="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Unit Type Description" SortExpression="DESC01">
                                                <ItemStyle HorizontalAlign="Left" />
                                                <ItemTemplate>
                        ...
                        <div id="tblrwdtrg" runat="server" class="row" style="margin-top: 12px;">
                            <div class="col-sm-12" align="center">
                                ...
                                <asp:LinkButton ID="btnSaveRwdTrg" runat="server" style="background-color:#FFF;color:#f04e5e; width:105px !important"  CssClass="btn btn-sample"
                                    Enabled="true">   

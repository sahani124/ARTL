<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MstOrigin.aspx.cs" Inherits="Application_ISys_Saim_Masters_MstOrigin" MasterPageFile="~/iFrame.master" %>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gv_DBFunction" runat="server" CssClass="footable"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="KPI Origin Description" SortExpression="DESC01">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>

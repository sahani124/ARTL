<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/iFrame.master" CodeFile="MstDBFunc.aspx.cs"
    Inherits="Application_ISys_Saim_Masters_MstDBFunc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function funPopUp(catgcd, sID) {
            var strContent = "ctl00_ContentPlaceHolder1_";
            $find("mdlVwQTrgBID").show();
            document.getElementById("ctl00_ContentPlaceHolder1_ifrmQualTrg").src = "PopMstDBFunc.aspx?catgcd=" + catgcd + "&sID=" + sID
        ...
        function funEditPopUp(code, sID) {
            ...
            var strContent = "ctl00_ContentPlaceHolder1_";
            $find("mdlVwQTrgBID").show();
            document.getElementById("ctl00_ContentPlaceHolder1_ifrmQualTrg").src = "PopMstDBFunc.aspx?code=" + code + "&sID=" + sID
            + "&flag=" + document.getElementById(strContent + "hdnFlag").id + "&mdlpopup=mdlVwQTrgBID";
        }
    ...
    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
        ...
        <center>
            <div id="divRwdcollapse" runat="server" style="width: 90%;" class="panel panel-success">
                ...
                <div id="divRwd" runat="server" style="width: 100%; white-space:nowrap;text-align:left;display: block;" class="panel-body">
                    <h3 class="form-section" style="text-align: left;">
                        Database Function</h3>
                                ...
                                <asp:GridView ID="gv_DBFunction" runat="server" CssClass="footable"
                                    ...
                                    <HeaderStyle CssClass="gridview th" />
                                     <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Description 2" SortExpression="DESC02">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblDesc2" runat="server" Text='<%# Bind("DESC02")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Description 3" SortExpression="DESC03">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblDesc3" runat="server" Text='<%# Bind("DESC03")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Name" SortExpression="DB_FUNCNAME">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblName" runat="server" Text='<%# Bind("DB_FUNCNAME")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

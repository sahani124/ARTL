...
public partial class Application_ISys_Saim_Masters_PopMstAccMode : BaseClass
{
    ...
    protected void FillGrid()
    {
        ...
        catch (Exception ex)
        {
            ...
            objErr.LogErr("ISYS-SAIM", "PopMstAccMode", "FillGrid", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }

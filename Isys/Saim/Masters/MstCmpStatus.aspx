<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MstCmpStatus.aspx.cs" Inherits="Application_ISys_Saim_Masters_MstCmpStatus"  MasterPageFile="~/iFrame.master"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
        <ContentTemplate>
        <center>
            <div id="divRwdcollapse" runat="server" style="width: 96%;" class="panel">
                <div id="div2" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divRwd','Img3');return false;">
                    <div class="row">
                        <div class="col-sm-10" style="text-align: left">
                            ...
                            <asp:Label ID="Label3" Text="MASTER SETUP" runat="server" Style="padding-left: 5px; font-size:19px" />
                        </div>
                        <div class="col-sm-2">
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gv_DBFunction" runat="server" CssClass="footable"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Compensation Status Description" SortExpression="DESC01">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="WF Code" SortExpression="WFCODE" Visible="false">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblWFCode" runat="server" Text='<%# Bind("WFCODE")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Action Flag" SortExpression="ACTIONFLAG" Visible="false">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblActionFlag" runat="server" Text='<%# Bind("ACTIONFLAG")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="WS Status" SortExpression="WS_Status" Visible="false">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblWSSatus" runat="server" Text='<%# Bind("WS_Status")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

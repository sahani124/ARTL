<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MstMeasuredAs.aspx.cs" Inherits="Application_ISys_Saim_Masters_MstMeasuredAs" MasterPageFile="~/iFrame.master" %>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gv_DBFunction" runat="server" CssClass="footable"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Measured As Description" SortExpression="DESC01">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>

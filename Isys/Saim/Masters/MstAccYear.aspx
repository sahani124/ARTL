<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MstAccYear.aspx.cs" Inherits="Application_ISys_Saim_Masters_MstAccYear" MasterPageFile="~/iFrame.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function funEditPopUp(code, sID) {
            ...
            document.getElementById("ctl00_ContentPlaceHolder1_ifrmQualTrg").src = "PopMstAccYear.aspx?code=" + code + "&sID=" + sID
    ...
    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
        ...
        <center>
            <div id="divRwdcollapse" runat="server" style="width: 97%;" class="panel">
                ...
                <div id="divRwd" runat="server" style="width: 96%; white-space:nowrap;text-align:left;display: block;" class="panel-body">
                    <h3 class="form-section" style="text-align: left; border-bottom:none;">
                        Accumulation Year</h3>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gv_DBFunction" runat="server" CssClass="footable"
                                    AllowSorting="True" AllowPaging="true" AutoGenerateColumns="false" OnRowDataBound="gv_DBFunction_RowDataBound" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Accumulation Year Description" SortExpression="DESC01">
                                        ...
                                        <asp:TemplateField HeaderText="Is Active" SortExpression="ISACTIVE">
                                            ...
                                            <ItemStyle HorizontalAlign="Center" CssClass="clsCenter"/>
                                               ...
                                               <asp:TemplateField HeaderText="Year Type" SortExpression="YEAR_TYPE">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblYearType" runat="server" Text='<%# Bind("YEAR_TYPE")%>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" CssClass="clsCenter"/>
                                        </asp:TemplateField>
                    ...
                    <div id="tblrwdtrg" runat="server" class="row" style="margin-top: 12px;">
                        <div class="col-sm-12" align="center">
                            ...
                            <asp:LinkButton ID="btnSaveRwdTrg" Text="SAVE" runat="server" CssClass="btn btn-sample"
                                Enabled="true">

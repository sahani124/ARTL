<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MstCmpType.aspx.cs" Inherits="Application_ISys_Saim_Masters_MstCmpType" MasterPageFile="~/iFrame.master"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function funPopUp(div, rultyp) {
            ...
            + "&rultyp=" + rultyp
            + "&cmpnstcd.gridview th=" + document.getElementById(strContent + "lblCompCodeVal").innerText
                        ...
                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gv_DBFunction" runat="server" CssClass="footable"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Code" SortExpression="CODE" HeaderStyle-Width="10%">
                                        ...
                                        <asp:TemplateField HeaderText="Compensation Type Description" SortExpression="DESC01">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Permissible Cycles" SortExpression="ISACTIVE" HeaderStyle-Width="6%">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblPermsCyc" runat="server" Text='<%# Bind("PRMSCYC")%>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" CssClass="clsCenter"/>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Is Active" SortExpression="ISACTIVE" HeaderStyle-Width="6%">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <%--<asp:Label ID="lblIsActive" runat="server" Text='<%# Bind("ISACTIVE")%>'></asp:Label>--%>
                                                <asp:Label ID="lblIsActive" runat="server" Text='<%# Bind("ACTIVE")%>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" CssClass="clsCenter"/>
                                        </asp:TemplateField>

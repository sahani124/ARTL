...
public partial class Application_Isys_Saim_Masters_MstTDSRateSetup : BaseClass
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            objErr.LogErr("ISYS-SAIM", "MstTDSRateSetup", "Page_Load", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    protected void GetChannelWiseCompenDesign()
    {
        try
        {
            ...
            ds = objDal.GetDataSetForPrc_SAIM("PRC_GET_MST_TDS_STD_DEF_DTLS", htPara);
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                dgCmp.DataSource = ds;
                dgCmp.DataBind();
    ...
    protected void btnAddNew_Click(object sender, EventArgs e)
    {
        ...
        htable.Add("@Flag1", "S");
        //htable.Add("@MEMBER_CODE", txtMemberCode.Text.Trim());
    ...
    protected void BtnCncl_Click(object sender, EventArgs e)
    {
        Response.Redirect("MstTDSRateSetup.aspx");
    }
}

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopMstCmpCatg.aspx.cs" Inherits="Application_ISys_Saim_Masters_PopMstCmpCatg"
            ...
            <div id="div2" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divtrg','myImg');return false;">
                <div class="row">
                    <div class="col-sm-10" style="text-align: left">
                        ...
                        <asp:Label ID="lblhdr" Text="Compensation Category Setup" runat="server" />
                    </div>
                    <div class="col-sm-2">

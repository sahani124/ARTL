...
public partial class Application_ISys_Saim_Masters_PopMstDBFunc : BaseClass
{
    ...
    public void GetFuncDtls()
    {
        ...
        if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
        {
            ...
            txtName.Text = ds.Tables[0].Rows[0]["DB_FUNCNAME"].ToString().Trim();
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            if (txtCode.Text.Trim() != "")
            {
                ...
                dr["DB_FUNCNAME"] = txtName.Text.Trim();
        ...
        catch (Exception ex)
        {
            ...
            objErr.LogErr("ISYS-SAIM", "PopMstDBFunc", "FillGrid", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }

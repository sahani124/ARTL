<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MstDBTable.aspx.cs" Inherits="Application_ISys_Saim_Masters_MstDBTable" MasterPageFile="~/iFrame.master"%>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gv_DBFunction" runat="server" CssClass="footable"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="DB TableName" SortExpression="DB_TABLENAME" >
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblDBTableName" runat="server" Text='<%# Bind("DB_TABLENAME")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true" CodeFile="RwrdBulkFileUpload.aspx.cs" Inherits="Application_Isys_Saim_RwrdBulkFileUpload" %>
                    ...
                    <div id="divSearch" runat="server" style="display:block;" class="panel-body">
                     <%--  <asp:UpdatePanel ID="updfile" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <asp:LinkButton ID="btnUpldFrmt" runat="server" CssClass="btn btn-sample" OnClick="btnUpldFrmt_Click"
                                    TabIndex="32">

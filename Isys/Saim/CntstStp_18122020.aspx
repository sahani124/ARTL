<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true"
    CodeFile="CntstStp.aspx.cs" Inherits="Application_ISys_Saim_CntstStp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function funEditPopUp(div, rultyp, code, kpiCode, sID) {
            debugger;
            var strContent = "ctl00_ContentPlaceHolder1_";
            $find("mdlViewBID").show();
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                                        <ContentTemplate>
                                                            <asp:Button ID="btnprevrwdtrg" Text="<" CssClass="form-submit-button" runat="server"
                                                                ...
                                                                <asp:TextBox runat="server" ID="txtpgrwdtrgnew" Style="width: 40px; border-style: solid;
                                                                border-width: 1px; border-color: Gray; height: 30px; float: left; margin: 0;
                                                                text-align: center;" Text="1" CssClass="form-control" ReadOnly="true" />

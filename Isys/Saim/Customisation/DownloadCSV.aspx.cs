            ...
            try
            {
                ...
                if (RANGE == "N")
                {
                    if(Mode == "current")
                        ...
                        ds = objDal.GetDataSetForPrc_SAIM("PRC_GET_UPDATED_PENDING_DATA_WITH_RANGE_HISTORY", ht);
                }
                else
                {
                    if (Mode == "current")
                        ...
                        ds = objDal.GetDataSetForPrc_SAIM("PRC_GET_UPDATED_PENDING_DATA_WITHOUT_RANGE_HISTORY", ht);
                }

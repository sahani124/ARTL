<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true" CodeFile="CmpRptGenerate.aspx.cs" Inherits="Application_Isys_Saim_Customisation_CmpRptGenerate" %>
...
<%--                        <span class="glyphicon glyphicon-chevron-down" style="color: Orange;"></span>&nbsp;commennted by ajay sawant 25/4/2018--%>
                        <asp:Label ID="lblhdr" Text="COMPENSATION REPORT COLUMN MAPPING" Font-Size="19px" runat="server" />
                    </div>
                    <div class="col-sm-2">
            ...
            <div id="divcmphdr" runat="server" style="width: 96%;" class="panel-body">
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="lblCompCode" Text="Compensation Description" runat="server" CssClass="control-label" />
                    </div>
                    <div class="col-sm-3">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txtCompCode" runat="server" CssClass="form-control" TabIndex="1" Visible="false"
                                    MaxLength="8" placeholder="Compensation Description" />
                                <ajaxToolkit:FilteredTextBoxExtender ID="FTXCompCd" runat="server" FilterType="Numbers"
                                    TargetControlID="txtCompCode">
                                </ajaxToolkit:FilteredTextBoxExtender>
                                 <asp:DropDownList ID="ddlCmpCode" runat="server" AutoPostBack="true" CssClass="select2-container form-control" OnSelectedIndexChanged="ddlCmpCode_SelectedIndexChanged"
                                    TabIndex="4">
                                </asp:DropDownList>
                    ...
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="lblCompDesc1" Text="Contestant Description" runat="server" CssClass="control-label" />
                    </div>
                    <div class="col-sm-3">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlCntstCode" runat="server" AutoPostBack="true" CssClass="select2-container form-control" OnSelectedIndexChanged="ddlCntstCode_SelectedIndexChanged"
                                    TabIndex="4"></asp:DropDownList>

                                <asp:TextBox ID="txtCompDesc1" runat="server" CssClass="form-control" TabIndex="2" Visible="false"
                ...
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="lblCompTyp" Text="RuleSet Description " runat="server" CssClass="control-label" />
                    </div>
                    <div class="col-sm-3">
                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                            <ContentTemplate>

                                 <asp:DropDownList ID="ddlRulset" runat="server" AutoPostBack="true" CssClass="select2-container form-control"  OnSelectedIndexChanged="ddlRulset_SelectedIndexChanged"
                                    TabIndex="4"></asp:DropDownList>
                                

                                <asp:DropDownList ID="ddlCompType" runat="server" AutoPostBack="true" CssClass="select2-container form-control" Visible="false"
                                    TabIndex="4">
                                </asp:DropDownList>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                     ...
                     <div class="col-sm-3" style="text-align: left">
                       <asp:Label ID="Label9" Text="Report Type" runat="server" CssClass="control-label" />
                    </div>
                    <div class="col-sm-3" style="text-align: left">
                         <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:DropDownList ID="ddlRprtType" runat="server" AutoPostBack="true" CssClass="select2-container form-control"  OnSelectedIndexChanged="ddlRprtType_SelectedIndexChanged"
                                    TabIndex="4">
                                </asp:DropDownList>
                 ...
                 <div class="row" style="margin-bottom: 5px;">
                   <div class="col-sm-3" style="text-align: left">
                         <asp:Label ID="lblCompStat" Text="Attribute Description" runat="server" CssClass="control-label" />
                    </div>
                    <div class="col-sm-3" style="text-align: left">
                        <asp:UpdatePanel ID="UpdatePanel41" runat="server">
                            <ContentTemplate>
                                <asp:ListBox ID="lstAttrDesc" runat="server" SelectionMode="Multiple"></asp:ListBox>

                                <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="true" CssClass="select2-container form-control" Visible="false"
                                    TabIndex="4">
                                </asp:DropDownList>
                    ...
                    <div class="col-sm-3 col-md-3" style="text-align: left">
                        <asp:Label ID="Label1" Text="Attribute Selected Value" runat="server" CssClass="control-label" />
                    </div>
                    <div class="col-sm-3">
                        <asp:UpdatePanel ID="UpdatePanel17" runat="server">
                            <ContentTemplate>
                        <asp:TextBox ID="txtareaFixfactor" style="overflow:auto;resize:none" runat="server" placeholder="Fix Factors" Enabled="false" TextMode="MultiLine" CssClass="form-control" />
                        </ContentTemplate>
                        </asp:UpdatePanel>
                    ...
                    <div class="col-sm-12" align="center">
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:LinkButton ID="btnSearch" runat="server" CssClass="btn btn-sample" OnClick="btnSearch_Click" Visible="false">
                                ...
                                <asp:LinkButton ID="btnClear" runat="server" CssClass="btn btn-sample" OnClick="btnClear_Click">
                                    ...
                                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-sample" OnClientClick="gotoHome(); return false;"
                                    >
                                     <span class="glyphicon glyphicon-remove"  style="color:White"></span> Cancel
                                </asp:LinkButton>
                                <asp:LinkButton ID="btnAddNew" runat="server" CssClass="btn btn-sample" OnClick="btnAddNew_Click" Visible="false">
        ...
        <div id="divRefCollapse" runat="server" style="width: 97%;" class="panel">
            <div id="Div2" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divRef','myImg');return false;">
                <div class="row">
                    <div class="col-sm-10" style="text-align: left">
<%--                        <span class="glyphicon glyphicon-chevron-down" style="color: Orange;"></span>&nbsp;commennted by ajay sawant 25/4/2018--%>
                        <asp:Label ID="Label3" Text="REFERENCE COMPENSATION REPORT COLUMN MAPPING" Font-Size="19px" runat="server" />
                    </div>
                    <div class="col-sm-2">
                             <span id="myImg" class="glyphicon glyphicon-chevron-down" style="float: right;color:#034ea2;
                            padding: 1px 10px ! important; font-size: 18px;"></span> <%--added by ajay sawant 24/4/2018--%>
            ...
            <div id="divRef" runat="server" style="width: 96%;" class="panel-body">
                <div class="row">

                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="Label4" Text="Reference Compensation" runat="server" CssClass="control-label" />
                    </div>
                    <div class="col-sm-3">
                        <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                            <ContentTemplate>
                               
                                 <asp:DropDownList ID="ddlRefcmp" runat="server" AutoPostBack="true" CssClass="select2-container form-control" OnSelectedIndexChanged="ddlRefcmp_SelectedIndexChanged"
                                    TabIndex="4">
                                </asp:DropDownList>
                    ...
                    <div class="col-sm-3" style="text-align: left">
                        <asp:Label ID="Label5" Text="Reference Contestant" runat="server" CssClass="control-label" />
                    </div>
                    <div class="col-sm-3">
                   ...
                   <div class="row" style="margin-bottom: 5px;" id="RefCntst" runat="server" >
                       <div class="col-sm-3" style="text-align: left">
                         <asp:Label ID="Label6" Text="Contestant Description" runat="server" CssClass="control-label" />
                    </div>
                    <div class="col-sm-3" style="text-align: left">
                        <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                            <ContentTemplate>
                               
                                 <asp:checkboxlist ID="lstCntst" runat="server" AutoPostBack="false" Align="left"
                                    TabIndex="4" SelectionMode="Multiple" CssClass="checkboxlistformat">
                                </asp:checkboxlist>

                              <%--  <asp:ListBox ID="lstCntst" runat="server" SelectionMode="Multiple"></asp:ListBox>
                                --%>
                        ...
                        <%--<div class="col-sm-3 col-md-3" style="text-align: left">
                        <asp:Label ID="Label7" Text="Selected Contestant" runat="server" CssClass="control-label" />
                    </div>
                    <div class="col-sm-3">
                       
                        <asp:TextBox ID="Txtcntst" style="overflow:auto;resize:none" runat="server" placeholder="Fix Factors" Enabled="false" TextMode="MultiLine" CssClass="form-control" />
                    ...
                    <div class="col-sm-12" align="center">
                        <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:LinkButton ID="BtnMapSave" runat="server" CssClass="btn btn-sample" OnClick="BtnMapSave_Click" >
                                    <span class="glyphicon glyphicon-floppy-disk" style="color: White;"></span> Save Mapping
                                </asp:LinkButton>
                               
                               
                                <asp:LinkButton ID="LinkButton3" runat="server" CssClass="btn btn-sample" OnClientClick="gotoHome(); return false;"
                                    >
                                     <span class="glyphicon glyphicon-remove"  style="color:White"></span> Cancel
                                </asp:LinkButton>
        ...
        <div id="divRprtG" runat="server" style="width: 97%;" class="panel">
            <div id="Div3" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divRprt','myImg');return false;">
                <div class="row">
                    <div class="col-sm-10" style="text-align: left">
<%--                        <span class="glyphicon glyphicon-chevron-down" style="color: Orange;"></span>&nbsp;commennted by ajay sawant 25/4/2018--%>
                        <asp:Label ID="Label7" Text="GENERATE REPORT" Font-Size="19px" runat="server" />
                    </div>
                    <div class="col-sm-2">
                             <span id="myImg" class="glyphicon glyphicon-chevron-down" style="float: right;color:#034ea2;
                            padding: 1px 10px ! important; font-size: 18px;"></span> <%--added by ajay sawant 24/4/2018--%>
            ...
            <div id="divRprt" runat="server" style="width: 96%;" class="panel-body">
                    ...
                    <div class="col-sm-3">
                        <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                            <ContentTemplate>
                                 ...
                                 <asp:DropDownList ID="ddlRprtCmp" runat="server" AutoPostBack="true" CssClass="select2-container form-control" 
                                    TabIndex="4">
                                </asp:DropDownList>
                ...
                <div class="row" style="margin-top: 12px;">
                    <div class="col-sm-12" align="center">
                       <%-- <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                         ...
                         <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-sample" OnClick="btnAddNew_Click" >
                                    <span class="glyphicon glyphicon-plus BtnGlyphicon"></span> Proceed for Rule Execution
                                </asp:LinkButton>


                                <asp:LinkButton ID="BtnBaseDwld" runat="server" CssClass="btn btn-sample" OnClick="BtnBaseDwld_Click" >
                                    <span class="glyphicon glyphicon-download" style="color: White;"></span> Download Base
                                </asp:LinkButton>
                               
                                <asp:LinkButton ID="BtnTrackDwld" runat="server" CssClass="btn btn-sample" OnClick="BtnTrackDwld_Click" >
                                     <span class="glyphicon glyphicon-download" style="color: White;"></span> Download Tracker
                                </asp:LinkButton>

                                <asp:LinkButton ID="LinkButton6" runat="server" CssClass="btn btn-sample" OnClientClick="gotoHome(); return false;"
                                    >
                                     <span class="glyphicon glyphicon-remove"  style="color:White"></span> Cancel
                                </asp:LinkButton>
        ...
        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
            <ContentTemplate>
                <div id="divcmpsrchhdrcollapse" runat="server" style="width: 97%;" class="panel ">
                        ...
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                               <%-- <span class="glyphicon glyphicon-chevron-down" style="color: Orange;"></span>&nbsp;--%><%--commented by ajay sawant 25/4/2018--%>
                                <asp:Label ID="lblCmpSrch" Text="COMPENSATION REPORT COLUMN MAPPING RESULTS" style="font-size:19px;" runat="server" />
                            </div>
                            <div class="col-sm-2">
                    ...
                    <div id="divkpisrch" runat="server" style="overflow:auto; width: 96%; padding: 10px;">
                       <%-- <asp:UpdatePanel ID="UpdatePanel6" runat="server"> <div style="overflow-x: auto; width: 1000px; Height: 300px;">
                            <ContentTemplate>--%>
                        <asp:Panel ID="Panel1" runat="server" style="overflow:auto">


                                <asp:GridView ID="dgCmp" runat="server" AutoGenerateColumns="false" 
                                    PageSize="10" AllowSorting="True" OnSorting="dgCmp_Sorting" AllowPaging="true"
                                    CssClass="footable" OnRowDataBound="dgCmp_RowDataBound" DataKeyNames="CMPNSTN_CODE" style="width:100%; overflow-x:auto">
                                    ...
                                    <Columns>
                                        <asp:TemplateField Visible="false">
                                            <ItemTemplate>
                                                ...
                                                <div id="divChild" visible="false" runat="server" style="display: none; width: auto; margin: 0px 0 !important;"
                                        ...
                                        <asp:TemplateField HeaderText="Comp Code" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                            SortExpression="CMPNSTN_CODE" Visible="false">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkCmpCode" Text='<%# Bind("CMPNSTN_CODE")%>' runat="server"
                                                    OnClick="lnkCmpCode_Click"></asp:LinkButton>
                                                <asp:LinkButton ID="lnkcntst" Text='<%# Bind("CNTSTNT_CODE")%>' runat="server"></asp:LinkButton>
                                                <asp:LinkButton ID="lnkrulset" Text='<%# Bind("RuleSetCode")%>' runat="server" ></asp:LinkButton>
                                                <asp:LinkButton ID="lnkAttrVal" Text='<%# Bind("ATTRIBUTE_VALUE")%>' runat="server"></asp:LinkButton>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Contestant Description" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Wrap="true" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblcntst" Text='<%# Bind("cntst") %>' runat="server" />
                                            </ItemTemplate>
                                            
                                        </asp:TemplateField>

                                         <asp:TemplateField HeaderText="Ruleset Description" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Wrap="true" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRulDesc" Text='<%# Bind("RulDesc") %>' runat="server" />
                                            </ItemTemplate>
                                             
                                        </asp:TemplateField>

                                         <asp:TemplateField HeaderText="Attribute Description" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Wrap="true" ItemStyle-HorizontalAlign="Left"  ItemStyle-Wrap="true">
                                            <ItemTemplate>
                                                <div style="white-space: normal; word-break: break-all;">
                                                <asp:Label ID="lblAttrDesc" Text='<%# Bind("AttrDesc") %>' runat="server" />
                                                    </div>
                                            </ItemTemplate>
                                             <ItemStyle Width="2000px" />
                                             
                                              
                                        </asp:TemplateField>

                                        <%--<asp:BoundField DataField="AttrDesc" HeaderText="Attribute Description" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Wrap="true" ItemStyle-HorizontalAlign="Cente>
                                        ...
                                        <asp:BoundField DataField="ACC_CYCLE" HeaderText="Accumulation Cycle" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Wrap="true" SortExpression="ACC_CYCLE" ItemStyle-HorizontalAlign="Center" Visible="false">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="ACC_YEAR" HeaderText="Accumulation Year" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Wrap="true" SortExpression="ACC_YEAR" ItemStyle-HorizontalAlign="Center" Visible="false">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="LAST_CYCCD" HeaderText="Last Cycle Run" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Wrap="true" SortExpression="LAST_CYCCD" ItemStyle-HorizontalAlign="Center" Visible="false">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="STATUS" HeaderText="Status" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Wrap="true" SortExpression="STATUS" ItemStyle-HorizontalAlign="Center" Visible="false">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="EFF_FROM" HeaderText="Eff. From" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="80px" SortExpression="EFF_FROM" ItemStyle-HorizontalAlign="Center" Visible="false">
                                            <HeaderStyle HorizontalAlign="Center" Width="80px" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="EFF_TO" HeaderText="Eff. To" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Wrap="true" SortExpression="EFF_TO" ItemStyle-HorizontalAlign="Center" Visible="false">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="Action">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#ctl00_ContentPlaceHolder1_lstAttrDesc').multiselect({
        ...
        function bindValFactor() {
            ...
            var sel = document.getElementById('<%= lstAttrDesc.ClientID %>');
        ...
        function fnValidate() {
            ...
            var ddlCmpCode = document.getElementById("<%=ddlCmpCode.ClientID%>");
            var optionSelIndex2 = ddlCmpCode.options[ddlCmpCode.selectedIndex].value;
            if (optionSelIndex2 == 0) {
                alert("Please Select Compensation");
                return false;
            }

            var ddlCntstCode = document.getElementById("<%=ddlCntstCode.ClientID%>");
            var optionSelIndex2 = ddlCntstCode.options[ddlCntstCode.selectedIndex].value;
            if (optionSelIndex2 == 0) {
                alert("Please Select Contestant");
                return false;
            }

            var ddlRulset = document.getElementById("<%=ddlRulset.ClientID%>");
            var optionSelIndex2 = ddlRulset.options[ddlRulset.selectedIndex].value;
            if (optionSelIndex2 == 0) {
                alert("Please Select Ruleset");
                return false;
            }

            var ddlRprtType = document.getElementById("<%=ddlRprtType.ClientID%>");
            var optionSelIndex2 = ddlRprtType.options[ddlRprtType.selectedIndex].value;
            if (optionSelIndex2 == 0) {
            ...
            if (fixFactorLength == 0) {
                alert("Please Select Attribute Description");
                return false;
            }
        ...
        function btnSaveRprt() {
            ...
            object["CmpCode"] = $('#<%=ddlCmpCode.ClientID %>').val();
            object["CntstCode"] = $('#<%=ddlCntstCode.ClientID %>').val();
            object["Rulset"] = $('#<%=ddlRulset.ClientID %>').val();
            object["Fixfactors"] = document.getElementById("<%=txtareaFixfactor.ClientID%>").value;
            object["RprtType"] = $('#<%=ddlRprtType.ClientID %>').val();
            //object["AttrVal"] = $('#<%=lstAttrDesc.ClientID %>').val();
            ...
            $.ajax({
                type: "POST",
                url: "CmpRptGenerate.aspx/actionSetupDetails",
                ...
                success: function (response) {
                    debugger;
                    if (response.d == "0") {
                        alert("Column mapping details has been saved successfully .");

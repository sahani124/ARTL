<%@ Page Language="C#" AutoEventWireup="true" CodeFile="commisionpage.aspx.cs" Inherits="Application_ISys_Saim_commisionpage" %>
...
<script type ="text/jscript" >
    ...
    function openNewPage() {
        ...
        window.open("../Saim/SaimPopup.aspx",
					...
					<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-search"></i>Contest results Search
										</div>
										<div class="tools">
										...
										<form action="#" class="form-horizontal">
											<div class="form-body">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-5">Contest Code</label>
															<div class="col-md-7">
																<input type="text" class="form-control" placeholder="Contest Code">
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-5">Contest Description</label>
															<div class="col-md-7">
																<%--<input type="text" class="form-control" placeholder="Compensation Description">--%>
                                                                <select class="form-control" id="ddlctype" runat="server"  placeholder="Contest Type">

                                                                    <option value="0">SELECT</option>
                                                                    <option value="1">FANTASTIC FEBRUARY CONTEST</option>
                                                ...
                                                <div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-5">Contest Cycle </label>
															<div class="col-md-7">

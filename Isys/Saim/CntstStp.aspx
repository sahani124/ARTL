...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ShowLoader(id) {
            debugger
            var res = id.replace("_lnkCopyCycle", "_iLoading");
            document.getElementById(id).style.display = 'none';
            document.getElementById(res).style.display = 'block';
        }

        //function funPopUpSetDteDef(rulsetcode,cyclecode ) {

        //    debugger;
        //    var strContent = "ctl00_ContentPlaceHolder1_";
        //    $find("mdldatdefsetupBID").show();
        //    document.getElementById("ctl00_ContentPlaceHolder1_Ifrmdatdefsetup").src = "Popdatedefsetup.aspx?RULE_SET_KEY=" + rulsetcode + "&CYCLE_CODE=" + cyclecode
        //    + "&mdlpopup=mdldatdefsetupBID";
        //}

        function funPopUpSetDteDef(id) {

            debugger;
            var rulsetcode, cyclecode;
            var prefix = "#";
            var rsk1 = id.replace("_lnkDteDef", "_lnkRule_SET_KEY");
            var cyccd = id.replace("_lnkDteDef", "_hdnCycle");
            var res = id.replace("_lnkDteDef", "_iLoadingDateDef");
            var rsk = prefix + rsk1;
            document.getElementById(id).style.display = 'none';
            document.getElementById(res).style.display = 'block';
            rulsetcode = $(rsk).text();
            cyclecode = document.getElementById(cyccd).value;
            var strContent = "ctl00_ContentPlaceHolder1_";
            $find("mdldatdefsetupBID").show();
            document.getElementById("ctl00_ContentPlaceHolder1_Ifrmdatdefsetup").src = "Popdatedefsetup.aspx?RULE_SET_KEY=" + rulsetcode + "&CYCLE_CODE=" + cyclecode
                + "&mdlpopup=mdldatdefsetupBID";
        }
        function funPopUpSetRul(id) {

            debugger;
            var rskid = id.replace("_lnkSetRulPopUp", "_lblRuleSetCode");
            var CHNID = id.replace("_lnkSetRulPopUp", "_lblCHN");
            var CHNCLSID = id.replace("_lnkSetRulPopUp", "_lblCHNCLS");
            var MEMTYPEID = id.replace("_lnkSetRulPopUp", "_lblMEMTYPE");
            var rsk = $('#' + rskid).text();
            var CHN = $('#' + CHNID).text();
            var CHNCLS = $('#' + CHNCLSID).text();
            var MEMTYPE = $('#' + MEMTYPEID).text();
            //var cyccd = id.replace("_lnkDteDef", "_hdnCycle");
            //var res = id.replace("_lnkDteDef", "_iLoadingDateDef");
            CMPCODE = GetQueryStringValue(window.location, 'CmpCode');
            CNTSTCODE = GetQueryStringValue(window.location, 'CntstCode');
            MODE = GetQueryStringValue(window.location, 'Mode');
            var strContent = "ctl00_ContentPlaceHolder1_";
            $find("mdldatdefsetupBID").show();
            document.getElementById("ctl00_ContentPlaceHolder1_Ifrmdatdefsetup").src = "../Saim/RuleSetPages/FFContestPageStdDef.aspx?role=maker&CmpTyp=" + MODE + "&flag=2" + "&CMPNSTN_CODE=" + CMPCODE +
                "&CNTST_CODE=" + CNTSTCODE + "&bizsrc=" + CHN + "&chncls=" + CHNCLS + "&memtype=" + MEMTYPE +
                "&RuleSetKey=" + rsk + "&KPIMode=KPISet" + "&KpiCode=0" + "&Mode=" + MODE + "&mdlpopup=mdldatdefsetupBID";
                    ...
                    <div id="Div13" runat="server" class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divcmphdr','myImg');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                ...
                                <%--<span class="glyphicon glyphicon-chevron-down" style="color: Orange;"></span>&nbsp;--%><%--added by ajay sawant 25/4/2018--%>
                        ...
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left" >
                               ...
                               <%-- <span class="glyphicon glyphicon-chevron-down" style="color: Orange;"></span>&nbsp;--%>
                                <asp:Label ID="Label1" Text=" CONTENSTANT DETAILS" Style="font-size:19px;" runat="server" />
                            </div>
                            <div class="col-sm-2">
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Std Def." Visible="false">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                        <ItemTemplate>
...
<%--                                                     <asp:HiddenField ID="hdnRulCode" runat="server" Value='<%# Bind("RULE_CODE")%>' />--%>
                                                    ...
                                                    <asp:Label ID="lblCHN" runat="server" style="display:none" Text='<%# Bind("CHN")%>' />
                                                    <asp:Label ID="lblCHNCLS" runat="server" style="display:none" Text='<%# Bind("CHNCLS")%>' />
                                                    <asp:Label ID="lblMEMTYPE" runat="server" style="display:none" Text='<%# Bind("MEMTYPE")%>' />
                                            ...
                                            <asp:TemplateField HeaderText="KPI Action Mapping">
                                                 <ItemStyle HorizontalAlign="Center" />
                                                 <ItemTemplate>
                                                   <asp:LinkButton ID="lnkSetRulPopUp" runat="server" Text="Set Rule" OnClientClick="funPopUpSetRul(this.id)" ></asp:LinkButton>
                                                 </ItemTemplate>
                                            </asp:TemplateField>
                                            <%--<asp:TemplateField HeaderText="Action">
                                                <ItemStyle HorizontalAlign="Center" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Eff To" SortExpression="EFF_TO">
                                                     ...
                                                     <%-- <asp:TemplateField HeaderText="Std Def.">
                                                      ...
                                                      <asp:TemplateField HeaderText="Action">
                                                        <ItemStyle HorizontalAlign="Center" />
<%--                                                        <ItemTemplate>
                                                            <asp:Button ID="lnkDteDef" CssClass="button1" runat="server" Text="Set Date Definition" OnClick="lnkDteDef_Click" ></asp:Button>
                                                        </ItemTemplate>--%>
                                                        <ItemTemplate>
                                                            <asp:Button ID="lnkDteDef" CssClass="button1" runat="server" Text="Set Date Definition" OnClientClick="funPopUpSetDteDef(this.id)" ></asp:Button>
                                                            <asp:Image id="iLoadingDateDef" runat="server" style="display:none"  src="../../loading-spinner-blue.gif" alt="LOADING" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>                                                      
                                                    </Columns>
                                ...
                                <h3 class="form-section" style="text-align: left;">
                                        <img id="ImageReward2" src="../../../images/Reward_Rule_Icon.png" style="border-width:0px;width: 
                                35px;margin-top: 0px;margin-bottom: 5px;height: 35px;"/> 
                                ...
                                <div id="div6" runat="server" style="width: 100%; border: none; margin: 0px 0 !important;overflow:auto;"
                                    ...
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="dgRwdRul" runat="server" CssClass="footable" AllowSorting="True" PageSize="70"
                                            ...
                                            <ItemTemplate>
                                                <img alt="" id="img2"  style="cursor: pointer" src="../../../images/btnexp.png" />
                                                <div id="divChild" runat="server" style="display: none; width: 100%; margin: 0px 0 !important;overflow-x:auto"
                                                    class="table-scrollable,divBorder1">
                                                    <asp:UpdatePanel ID="UpdatePanel61" runat="server">
                                                        <ContentTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Policy Term From" SortExpression="PolicyTermFrom">
                                             ...
                                             <asp:TemplateField HeaderText="Policy Term To" SortExpression="PolicyTermTo">
                                              ...
                                              <asp:TemplateField HeaderText="Premium From" SortExpression="PremiumFrom">
                                                <HeaderStyle Width="20px" />
                                                   <ItemStyle CssClass="cssalingright" Width="20px"  />
                                             ...
                                             <asp:TemplateField HeaderText="Premium To" SortExpression="PremiumTo">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="lblPremiumTo11" runat="server" Value='<%# Bind("PremiumTo")%>' />
                                                                     ...
                                                                     <asp:TemplateField HeaderText="RY From" SortExpression="RY_FROM">
                                                <HeaderStyle Width="20px" />
                                                <ItemStyle  CssClass="RightAlign"  Width="20px" />
                                                <ItemTemplate >
                                                    <asp:Label ID="lblRY_FROM" runat="server" Text='<%# Bind("RY_FROM")%>' />
                                                    <asp:HiddenField ID="lblRY_FROM11" runat="server" Value='<%# Bind("RY_FROM")%>' />
                                                </ItemTemplate>

                                                                         <%--RY_FROM,RY_TO--%>
                                               
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="RY To" SortExpression="RY_TO">
                                                <HeaderStyle Width="20px" />
                                                <ItemStyle  CssClass="RightAlign" Width="20px" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRY_TO" runat="server" Text='<%# Bind("RY_TO")%>' />
                                                    <asp:HiddenField ID="lblRY_TO11" runat="server" Value='<%# Bind("RY_TO")%>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                ...
                <div id="divModel" runat="server" style="width: 97%;" class="panel">
                    ...
                    <div id="Div17" runat="server" class="panel-heading" style="width: 99%;" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divmdlBody','myImg5');return false;">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <span id="myImg5" class="glyphicon glyphicon-chevron-down" style="float: right; color: #034ea2; padding: 1px 10px ! important; font-size: 18px;"></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <asp:Panel runat="server" Height="494px" Width="1020px" ID="pnldatdefsetup" display="none"
        Style="text-align: center; padding: 10px;" CssClass="panel panel-success">
        <iframe runat="server" id="Ifrmdatdefsetup" scrolling="yes" width="100%" frameborder="0"
            display="none" style="height: 100%;"></iframe>
    </asp:Panel>
    <asp:Label runat="server" ID="Label16" Style="display: none" />
    <ajaxToolkit:ModalPopupExtender runat="server" ID="mdldatdefsetup" BehaviorID="mdldatdefsetupBID" ClientIDMode="Static"
        DropShadow="false" TargetControlID="Label16" PopupControlID="pnldatdefsetup" BackgroundCssClass="modalPopupBg">
    </ajaxToolkit:ModalPopupExtender>
    ...
    <asp:Panel runat="server" Height="450px" Width="900px" ID="Panel1" display="none"
        Style="text-align: center; padding: 8px; margin-left: 68px;" CssClass="panel panel-success">
    ...
    <asp:Panel runat="server" Height="400px" Width="900px" ID="Panel2" display="none"
        Style="text-align: center; padding: 8px; margin-left: 27px !important;" CssClass="panel panel-success">

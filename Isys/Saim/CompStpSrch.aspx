<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true"
    CodeFile="CompStpSrch.aspx.cs" Inherits="Application_ISys_Saim_CompStpSrch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function funcShowPopupLOB() {
           ...
           <%-- var prdcode = document.getElementById('<%= hdnprdcode.ClientID%>').value;
            ...
            document.getElementById("ctl00_ContentPlaceHolder1_IframeLOB")
            //    .src = "../../../Application/ISys/ChannelMgmt/LOBDtls.aspx?mdlpopup=" + 'MdlPopExtndrLOB' + "&hdnprodcode=" + prdcode + "&Flag=" + ProdcodeEdit + "&Bizsrc=" + Bizsrc + "&ChnType=" + Chntype;
            //alert("ajay");
        }
    </script>
    ...
    <%-------%>
    <center>
        <div id="divcmphdrcollapse" runat="server" style="width: 97%;border: 1px solid #7dd5fa;padding: 5px 0 3px 0;" class="panel">
            <div id="Div6" runat="server" class="panel-heading" style="border:none !important" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divcmphdr','myImg');return false;">
                <div class="row">
...
<%--                        <span class="glyphicon glyphicon-menu-hamburger" style="color: Orange;"></span>&nbsp;commennted by ajay sawant 25/4/2018--%>
                        ...
                        <asp:Label ID="lblhdr" Text="COMPENSATION RULE SEARCH CRITERIA" Font-Size="16px" runat="server" />
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="row" style="margin-top: 12px;">
                    <div class="col-sm-12" align="center">
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                <asp:LinkButton ID="btnSearch" runat="server" CssClass="btn btn-sample" style="width:105px !important" OnClick="btnSearch_Click" OnClientClick="Enable()">
                                ...
                                <asp:LinkButton ID="btnCancel" runat="server" CssClass="btn btn-sample" style="width:105px !important" OnClick="btnCancel_Click"
                                    Visible="false">
                                    <span class="glyphicon glyphicon-erase BtnGlyphicon"></span> CANCEL
                                </asp:LinkButton>
                                <asp:LinkButton ID="btnAddNew" runat="server"   style="background-color:#034ea2;color:#FFF; border:none !important; width:105px !important"   CssClass="btn btn-sample" OnClick="btnAddNew_Click">
...
<%--        <br />
        ...
        <asp:UpdatePanel ID="UpdatePanel8" runat="server">
            <ContentTemplate>
                <div id="divChanlWiseCompenDsn" runat="server" style="width: 97%;display:none;" class="panel" visible="false" >
                                        ...
                                        <div class="row" style="color: White;">
                                            ...
                                            <div class="col-sm-4" style="margin: 1% 1% 1% 1%; text-align: center; width: 31%;
                                               ...
                                               <%-- <span id="SpanHealth" style="font-size: 200%; font-weight: bold" runat="server">0</span>--%>
                                                ...
                                                <br />
                                                <span id="Span3" style="font-size: small; font-weight: bold;">DIRECT SALES FORCE</span>
                                            </div>
                                            <div class="col-sm-4" style="margin: 1% 1% 1% 1%; width: 31%; text-align: center;
                                               ...
                                               <%-- <span id="SpanDirect" style="font-size: 200%; font-weight: bold" runat="server">0</span>--%>
                                                ...
                                                <br />
                                                <span id="Span4" style="font-size: small; font-weight: bold;">BANCASSURANCE</span>
                                            </div>
                                        </div>
                                    </div>
                                <%--</div>--%>
...
<%--        <br />
        ...
        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
            <ContentTemplate>
                <div id="divcmpsrchhdrcollapse" runat="server" style="width: 97%; border: 1px solid #7dd5fa;padding: 5px 0 3px 0;" class="panel ">
                    <div class="panel-heading" onclick="ShowReqDtl1('ctl00_ContentPlaceHolder1_divkpisrch','Img1');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                <div class="col-sm-6">
                                    <span style="margin-left:6px">
                                    <img id="imgCodeIcon" src="../../../KMI%20Styles/assets/css/Images/compensation_icon.png"/>
                                </span> 
                                <asp:Label ID="lblCmpSrch" Text="COMPENSATION RULE SEARCH RESULTS" style="font-size:16px;" runat="server" />
                                </div>
                                <div class="col-sm-6">
                    ...
                    <div id="divkpisrch" runat="server" style="width: 98%; padding: 10px;">

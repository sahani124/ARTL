<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true" CodeFile="BusiYrCreate_bkp12072021.aspx.cs" Inherits="Application_ISys_Saim_BusiYrCreate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <center>
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                <div id="divfinhdrcollapse" runat="server" style="width: 95%;text-align:left;" class="panel panel-success">
                    ...
                    <div id="divfinhdr" runat="server" style="width: 100%;" class="panel-body">
                        ...
                        <div class="row" style="margin-top: 12px;">
                            <div class="col-sm-12" align="center">
                                ...
                                <asp:LinkButton ID="btnCancel" runat="server" CssClass="btn btn-primary" TabIndex="25"

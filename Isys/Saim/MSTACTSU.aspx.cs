...
public partial class Application_Isys_Saim_Customisation_MSTACTSU : BaseClass
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            catch (Exception ex)
            {
                ...
                objErr.LogErr("ISYS-SAIM", "MSTACTSU", "Page_Load", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
            }
        }
    }
    ...
    protected void ChkPrntAct()
    {
        try
        {
            ...
            htParam.Add("@ACT_TYP", Request.QueryString["ACT_TYPE"].ToString().Trim());
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MSTACTSU", "ChkPrntAct", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    protected bool btnUpdateValdtn(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MSTACTSU", "btnUpdateValdtn", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
            return false;
        }
        return true;
    }
    ...
    protected bool btnSaveValdtn()
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MSTACTSU", "btnSaveValdtn", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MSTACTSU", "btnSave_Click", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    ...
    protected void SaveData()
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MSTACTSU", "SaveData", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
    ...
    protected void Fillddl(DropDownList ddl, string LookupCode)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MSTACTSU", "Fillddl", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
    ...
    protected void FillddlActNo(DropDownList ddl)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MSTACTSU", "FillddlActNo", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    protected void BindActionGrid()
    {
        try
        {
            ...
            htParam.Add("@ACT_TYPE", ddlActionType.SelectedValue); // added by daksh for act_type filter
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MSTACTSU", "BindActionGrid", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    protected void btnnext_Click(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MSTACTSU", "btnnext_Click", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //divcmpSrch.Attributes.Add(= "none");

            divcmpSrch.Attributes.Add("style","display:block");
        }
        catch (Exception ex)
        {
            //string currentFile = new System.Diagnostics.StackTrace(true).GetFrame(0).GetFileName();
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MSTACTSU", "btnSearch_Click", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    protected void lnkDelAct_Click(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MSTACTSU", "lnkDelAct_Click", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    protected void grvaddedresult_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            //if (e.Row.Cells[5].Text == "")    // here add the cell no at which the row is coming blank.
            //    e.Row.Visible = false;
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MSTACTSU", "grvaddedresult_RowDataBound", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    protected void btnY_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    ds = objDal.GetDataSetForPrc_SAIM("PRC_INS_PRNT_ACT_NO_NEW", htParam);
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MSTACTSU", "btnY_Click", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
    }
    ...
    public int compareDates(string date1, string date2)
    {
        ...
        catch (Exception ex)
        {
            ...
            //System.Reflection.MethodBase method = System.Reflection.MethodBase.GetCurrentMethod();
            //String LogClassName = method.ReflectedType.Name;
            objErr.LogErr("ISYS-SAIM", "MSTACTSU", "compareDates", ex.Message.ToString(), HttpContext.Current.Session["UserID"].ToString().Trim());
        }
        return d;
    }

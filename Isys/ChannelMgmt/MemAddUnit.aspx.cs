...
public partial class Application_Isys_ChannelMgmt_MemAddUnit : BaseClass

{
            ...
            try
            {
                ...
                if (strType == "N")
                {
                    ...
                    if (strPageName.Equals("REG"))
                       ...
                       //  dsResult = objDAL.GetDataSetForPrcCLP("Prc_GetUntCode_UntMgr", htParam);//Comented by usha 
                        dsResult = objDAL.GetDataSetForPrcCLP("Prc_GetAddUntCode_UntMgr", htParam);
        ...
        protected void ChkSelect_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                if (dsResult.Tables[0].Rows[0]["UnitLocation"].ToString().Trim() == "1")
                {

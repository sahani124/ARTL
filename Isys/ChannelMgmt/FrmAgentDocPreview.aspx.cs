...
public partial class Application_ISys_Recruit_FrmAgentDocPreview : BaseClass
{
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    dsIsSpPrsn = dataAccess.GetDataSetForPrc_DIRECT("Prc_GetIsSpecPeriConfig");
                    ...
                    if (Request.QueryString.Count > 0)
                    {
                        ...
                        if (Request.QueryString["TrnRequest"].ToString().Trim() == "Qc" && Request.QueryString["Type"].ToString().Trim() == "Qc")
                        {
                            ...
                            dsResult = dataAccess.GetDataSetForPrcRecruit("prc_GetDocType", htParam);
                            if (dsResult.Tables.Count > 0)
                            {
                                if (dsResult.Tables[0].Rows.Count > 0)
                                {
                                    ViewState["docType"] = dsResult.Tables[0].Rows[0]["DocType"].ToString();
                                    ViewState["DocNo"] = dsResult.Tables[0].Rows[0]["DocCode"].ToString();
                                    hdnDocCode.Value = ViewState["DocNo"].ToString();
                            ...
                            dsren = dataAccess.GetDataSetForPrcRecruit("Prc_GetCndLicnsDtls", htren);
                            ...
                            if (dsren.Tables[0].Rows[0]["RenewalFlag"].ToString().Trim() == "Y")//Renewal QC
                            {
                                ...
                                dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetRenewalRecrd", htParam);
                                ...
                                if (dsren.Tables[0].Rows[0]["RnwlQCFlag"].ToString().Trim() == "Y")
                                {
                                    ...
                                    dsrnwlQC = dataAccess.GetDataSetForPrcRecruit("Prc_GetLicDtls", htrnwlQc);
                                    ...
                                    ds_documentName = dataAccess.GetDataSetForPrcRecruit("Prc_GetLicDtls", htdata);
                            ...
                            dsReExm = dataAccess.GetDataSetForPrcRecruit("Prc_GetCndReExmDtls", htrexm);
                        ...
                        if (Request.QueryString["TrnRequest"].ToString().Trim() == "Renewal" && Request.QueryString["Type"].ToString().Trim() == "Renwl")//&& Request.QueryString["Type"].ToString().Trim() == "N")
                        {
                            ...
                            //drResult = dataAccess.exec_reader_prc_rec("Prc_Get50HrsNewReqSubmit", htdata);
                            //dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetCandType", htdata);
    ...
    private void PopulateICMStatus()
    {
        ...
        dsICMStat = dataAccess.GetDataSetForPrc_DIRECT("Prc_GetICMEnableStatus");
    ...
    private void GetTokenNoforDisplay()
    {
        ...
        dsToken = dataAccess.GetDataSetForPrcRecruit("Prc_GetTokenNoForSync", htToken);
    ...
    private void GetTotalFeesBasedOnLcnExpDate()
    {
        ...
        strRulecode = dataAccess.execute_sprc_with_output("Prc_GetFeesForRNWLCnd", htRuleCode, "@Strout");
        ...
        string strnewfees = dataAccess.execute_sprc_with_output("prc_GetLatestFeesbasedOnLcnDt", htLatestFees, "@Strout");
    ...
    private void GetRenewalDtls()
    {
        ...
        dsRe = dataAccess.GetDataSetForPrcRecruit("Prc_GetCndLicnsDtls", htRe);
        //viewstate for inserting fees details
    ...
    private void GetReExamDtls()
    {
        ...
        dsReExam = dataAccess.GetDataSetForPrcRecruit("Prc_GetCndReExmDtls", htReExam);
        //viewstate for inserting fees details
    ...
    private void PopulateTrnsfrInsurerName()
    {
        try
        {
            ...
            dtReadTrnsfr = dataAccess.GetDataSetForPrc_DIRECT("Prc_GetTransferInsurerName");
            //dtReadTrnsfr.Read();
    ...
    private void PopulateCompInsurerName()
    {
        try
        {
            ...
            dtReadComp = dataAccess.GetDataSetForPrc_DIRECT("Prc_GetCompositeInsurerName");
            //dtReadComp.Read();
    ...
    private void Bindgridview()
    {
        ...
        try
        {
            ...
            ds_candtype = dataAccess.GetDataSetForPrcRecruit("Prc_GetCandType", httable1); //added by pranjali on 14-03-2014 start
            Hashtable htparam = new Hashtable();
            ...
            //ds_documentName = dataAccess.GetDataSetForPrcRecruit("Prc_GetDocNames", htparam);//commented by pranjali on 11-04-2014 
            ds_documentName = dataAccess.GetDataSetForPrcRecruit("Prc_GetDocNames", htparam); //added by pranjali on 19-05-2014
    ...
    private void BindFeesDetails()
    {
        try
        {
            ...
            dsfeesDtls = dataAccess.GetDataSetForPrcRecruit("Prc_GetFeesDetailsforCnd", htfeesDtls);
    ...
    private void EnableDisableControls()
    {
        ...
        htParam.Clear();
        htParam.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
        dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_ChkCFRDocCFRRemark", htParam); //added by pranjali to check open cfr
        //dsResult = dataAccess.GetDataSetForPrcDBConn("Prc_GetCFRDetailsQualCheck", htParam, "INSCRecruitConnectionString");
    ...
    private void ChkPhotoNotExist_Repeater()
    {
        ...
        drResult = dataAccess.exec_reader_prc_rec("Prc_GetPopulateProofIDDoc", htdata);
    ...
    public bool ChkURNExist(string strCndNo)
    {
        ...
        try
        {
            ...
            dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetURNExistorExist", htParam);
    ...
    private bool chkExmResult()
    {
        ...
        try
        {
            ...
            drResult = dataAccess.exec_reader_prc_rec("Prc_chkExmResult", htdata);
        ...
        try
        {
            if (ChkURNExist(Convert.ToString(hdnCndNo.Value).Trim()) == true)
            {
                if (SpnsorshipDtExist() == true)
                {
                    ...
                    htdata.Clear();
                    htdata.Add("@CndNo", Convert.ToString(hdnCndNo.Value).Trim());
                    drResult = dataAccess.exec_reader_prc_rec("Prc_chkURNExistorNot", htdata);
                    //Added by Ibrahim on 05-07-2013 ,  To Get 50 Hrs Req Submit for Candidate who's QueryString ["Type"]= 'N' End
    ...
    protected void viewData(string strCndNo)
    {
        ...
        try
        {
            dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetAdvForHrsTrn", htParam);
            if (dsResult != null)
            {
                if (dsResult.Tables.Count > 0)
                {
                    ...
                    if (dsResult.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (Request.QueryString["Type"].ToString().Trim() == "Qc" || Request.QueryString["Type"].ToString().Trim() == "QcRes" || Request.QueryString["Type"].ToString().Trim() == "R" || Request.QueryString["Type"].ToString().Trim() == "E" || Request.QueryString["Type"].ToString().Trim() == "ReTrn")//added by pranjali on 28-04-2014
                        {
                            ...
                            if (dsren.Tables[0].Rows[0]["RenewalFlag"].ToString().Trim() == "Y")//Renewal QC
                            {
                                ...
                                ds_documentName.Clear();
                                htdata.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
                                ds_documentName = dataAccess.GetDataSetForPrcRecruit("Prc_GetTrnDtls", htdata);
                                if (ds_documentName.Tables[0].Rows.Count > 0)
                                {
    ...
    protected void InsertfeesDetails()
    {
        ...
        dsfeesDtls1 = dataAccess.GetDataSetForPrcRecruit("Prc_GetFeesDetailsforCnd", htfeesDtls1);
        ...
        if (dsfeesDtls1.Tables.Count > 0)
        {
            ...
            if (dsfeesDtls1.Tables[0].Rows.Count > 0)//if already exist moves to history table and again insert
            {
                ...
                strDel = dataAccess.execute_sprc_with_output("Prc_DeleteFeesDtls_new", htDel, "@strOut");
                ...
                foreach (GridViewRow row in dgPaymentdtls.Rows)
                {
                    ...
                    string strvalue = dataAccess.execute_sprc_with_output("Prc_InsertFeesDtls_new", Htfees, "@strOut");
                    Htfees.Clear();
                }
                #endregion
            }
    ...
    private bool checkPOINotExist()
    {
        ...
        try
        {
            ...
            drResult = dataAccess.exec_reader_prc_rec("Prc_GetcheckPOINotExist", htdata);
    ...
    private bool checkAdvPhotoNotExist()
    {
        ...
        try
        {
            ...
            htdata.Clear();
            htdata.Add("@CndNo", lblCndNoValue.Text.Trim());
            drResult = dataAccess.exec_reader_prc_rec("Prc_GetAdvPhotoNotExist", htdata);
            if (drResult.HasRows)
            {
                PhotoFlag = true;
            }
    ...
    protected bool SpnsorshipDtExist()
    {
        ...
        try
        {
            ...
            htdata.Clear();
            htdata.Add("@CndNo", Convert.ToString(hdnCndNo.Value).Trim());
            drResult = dataAccess.exec_reader_prc_rec("Prc_GetSpnsorshipDtExist", htdata);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if ((Request.QueryString["Type"].ToString().Trim().ToUpper() == "E") || (Request.QueryString["Type"].ToString().Trim().ToUpper() == "R"))
            {
                ...
                dsResult.Clear();
                htParam.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
                dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetCndLicnsDtls", htParam);
                Hashtable httable = new Hashtable();
                DataSet dscandtype = new DataSet();
                httable.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
                dscandtype = dataAccess.GetDataSetForPrcRecruit("Prc_GetCandType", httable);
            ...
            ds_documentName = dataAccess.GetDataSetForPrcRecruit("Prc_GetUpldDocNames", htparam); //added by pranjali on 11-04-2014  start
            if (ds_documentName.Tables.Count > 0)
            {
                if (ds_documentName.Tables[0].Rows.Count > 0)
                {
                    ...
                    for (j = 0; j < ds_documentName.Tables[0].Rows.Count; j++)
                    {
                        ...
                        else if (mandtry == "C" && imgshrt == "15")
                        {
                            ...
                            httable.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
                            ds_panchayat = dataAccess.GetDataSetForPrcRecruit("Prc_CheckForPanchayat", httable);
    ...
    public void GetNoofDays()
    {
        ...
        dsetdays = dataAccess.GetDataSetForPrc_DIRECT("Prc_GetNoofdays");
    ...
    public int GetNoofDaysForReexm()
    {
        ...
        dsetdays = dataAccess.GetDataSetForPrcRecruit("Prc_NoofDaysbasedonCndType", htdays);
        //dsetdays = dataAccess.GetDataSetForPrcRecruit("Prc_NoofDaysbasedonCndType");
    ...
    private void SetSysFreezeDate()
    {
        ...
        // dset = dataAccess.GetDataSetForPrcRecruit("Prc_GetUploadedDates");
        ...
        //QS
        dset = dataAccess.GetDataSetForPrcRecruit("Prc_GetUploadedDates", htSubmitDt);
        ...
        if (dset.Tables.Count > 0)
        {
            if (dset.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < dset.Tables[0].Rows.Count; i++)
                {
                    ...
                    g = dataAccess.execute_sprcrecruit("Prc_InsertSysFreezeDateSyncLog", htSync);
    ...
    protected void UpdteDt(string BrnCode, string FreezeDt, string CndNo)
    {
        ...
        f = dataAccess.execute_sprcrecruit("Prc_UpdSysFreezeDates", htsysemdate);
    ...
    private void Save()
    {
        try
        {
            ...
            dscandtype = dataAccess.GetDataSetForPrcRecruit("Prc_GetCandType", htcndtyp);
            ...
            if (Request.QueryString["TrnRequest"].ToString().Trim() == "CFRRaise") //&& Request.QueryString["Type"].ToString().Trim().ToUpper() == "R")
            {
                if (tblCndURN.Visible == true)
                {
                    ...
                    if (txtCndURNNo.Text != "")
                    {
                        ...
                        dsUrnChk = dataAccess.GetDataSetForPrcRecruit("Prc_GetChkCndURNNo", htUrnChk);
                ...
                if (Request.QueryString["Type"].ToString().Trim() == "R")
                {
                    ...
                    dsloc = dataAccess.GetDataSetForPrcRecruits("Prc_GetLocCODEQC", httable);
                ...
                if (Request.QueryString["Type"].ToString().Trim() == "Qc")
                {
                    ...
                    dtstcndtyp = dataAccess.GetDataSetForPrcRecruit("Prc_GetCandType", hscndtyp);
                    if (dtstcndtyp.Tables[0].Rows[0]["RenewalFlag"].ToString().Trim() != "Y" && dtstcndtyp.Tables[0].Rows[0]["ReExamFlag"].ToString().Trim() != "Y")
                    {
                        ...
                        dsDoc = dataAccess.GetDataSetForPrcRecruits("Prc_ChkIRDACloseCFR", htdoc);
                        ...
                        if (dsDoc.Tables[0].Rows.Count > 0)
                        {
                            ...
                            x = dataAccess.execute_sprcrecruit("Prc_UpdTrnReqForLicUser", htParam);
                        }
                ...
                {
                    x = dataAccess.execute_sprcrecruit("Prc_UpdateTrnReqDtl", htParam); //Added by pranjali on 02-01-2014 to update details
                }
                #region for AuditLog
            ...
            if (Request.QueryString["TrnRequest"].ToString().Trim() == "Renewal" && Request.QueryString["Type"].ToString().Trim() == "Renwl")
            {
                ...
                strvalue = dataAccess.execute_sprc_with_output("Prc_InsRenwlDtls", htParam, "@strOut");
            ...
            if (Request.QueryString["Type"].ToString().Trim() == "ReTrn")
            {
                ...
                if (dsReExm.Tables[0].Rows[0]["ReExamFlag"].ToString().Trim() == "Y" && dsReExm.Tables[0].Rows[0]["ReExmType"].ToString().Trim() == "I")//Reexam QC //added by pranjali on 28-04-2014
                {
                    ...
                    dsFees.Clear();
                    dsFees = dataAccess.GetDataSetForPrcRecruit("Prc_InsReExmDtls", htParam);
                    //MailResponse();
            ...
            if (Request.QueryString["Type"].ToString().Trim().ToUpper() == "N")
            {
                ...
                htdata.Clear();
                htdata.Add("@CndNo", Convert.ToString(hdnCndNo.Value).Trim());
                drResult = dataAccess.exec_reader_prc_rec("Prc_GetECRMpanUpdation", htdata);
                ...
                if (ECRMFlag == 0)
                {
                    ...
                    dsPANverify = dataAccess.GetDataSetForPrcRecruit("Prc_GetPANverify", htdata);
                    ...
                    if (dsPANverify.Tables[0].Rows.Count > 0)
                    {
                        ...
                        dataAccess.execute_sprc("Proc_adv_panupdation", htParam1);
                        htParam1.Clear();
                ...
                dsFees.Clear();
                dsFees = dataAccess.GetDataSetForPrcRecruit("Prc_InsertTrnReqDtl", htParam);
                //MailResponse();//MAIL
            ...
            else if (Request.QueryString["Type"].ToString().Trim().ToUpper() == "E")
            {
                ...
                //x = dataAccess.execute_sprcrecruit("Prc_UpdateTrnHrsDtls", htParam);
                x = dataAccess.execute_sprcrecruit("Prc_UpdateTrnReqDtl", htParam); //Added by pranjali on 02-01-2014 to update details 
                btnSubmit.Enabled = false;
            ...
            else if (ddlExmTpe.SelectedValue == "REXM")
            {
                if (Request.QueryString["Type"].ToString().Trim().ToUpper() == "N")
                {
                    ...
                    x = dataAccess.execute_sprcrecruit("Prc_InsertTrnHrsDtls", htParam);

                    if (ECRMFlag == 1)
                    {
                        dataAccess.exec_crmcommand("Prc_InsertIntoInscPANUpd", htParam1);
                        htParam1.Clear();
                    }
            ...
            else if (Request.QueryString["TrnRequest"].ToString().Trim() == "Renewal" && Request.QueryString["Type"].ToString().Trim() == "Renwl")
            {
                ...
                htParam.Clear();
                htParam.Add("@CndNo", lblCndNoValue.Text.ToString().Trim());
                dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetIncRenewalCnt", htParam);
                //added by shreela on 8/04/2014 end
            ...
            else if (Request.QueryString["TrnRequest"].ToString().Trim() == "ReExam" && Request.QueryString["Type"].ToString().Trim() == "ReTrn")
            {
                ...
                htParam.Clear();
                htParam.Add("@CndNo", lblCndNoValue.Text.ToString().Trim());
                //dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_UpdReExmCnt", htParam);
                x = dataAccess.execute_sprcrecruit("Prc_UpdReExmCnt", htParam);
    ...
    private void GetCandidateDtls()
    {
        ...
        dsDtls = dataAccess.GetDataSetForPrc("Prc_GetMemberDetails", htDtls);
    ...
    private void GetUserSAPCode()
    {
        ...
        dsSAP = dataAccess.GetDataSetForPrcRecruit("Prc_GetUserSAPCode", htSAP);
    ...
    private void MailResponse()
    {
        ...
        htParam.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
        dsres = dataAccess.GetDataSetForPrcRecruit("Prc_GetCndLicnsDtls", htParam);
        ...
        try
        {
            ...
            ds = dataAccess.GetDataSetForMailPrc("Prc_GetMailParams_ARTL", htData);
    ...
    protected void InsertUploadFile_Photo()
    {
        ...
        try
        {
            if (Request.QueryString["Type"].ToString().Trim().ToUpper() == "N")
            {
                intValue = dataAccess.execute_sprcrecruit("Proc_InsertDCTMFileUpload", htdata);
            }
            else if (Request.QueryString["Type"].ToString().Trim().ToUpper() == "E")
            {
                DataSet ds = new DataSet();
                ...
                ds = dataAccess.GetDataSetForPrcRecruit("Prc_GetDataPALDCTMFileUpload", ht);
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    {
                        intValue = dataAccess.execute_sprcrecruit("Proc_UpdateDCTMFileUpload", htdata);
                    }
                }
            }
        }
    ...
    protected void ddlTrnInstitute_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        dsAccrdtn = dataAccess.GetDataSetForPrcRecruits("Prc_GetAccrdtnNo", htdata);
    ...
    protected void btnVerifyPAN_Click(object sender, EventArgs e)
    {
        try
        {
            if (txtPAN.Text.Trim() != "ZZZPZ9999Z")
            {
                ...
                dsRes = dataAccess.GetDataSetForPrcRecruit("Prc_GetChkPANExist", htParam);
                ...
                if ((isFound == true) && (lblAppNoValue.Text.Trim() != hdnAgnCode.Value))//if (isFound == true)
                {
                    ...
                    htParam.Add("@Flag", 3);
                    dataAccess.execute_sprcrecruit("Prc_InsCfrRemarkMobEmailPan", htParam);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dsCndtype = dataAccess.GetDataSetForPrcRecruit("Prc_GetCandType", htable);
            ...
            //if (dsCndtype.Tables[0].Rows[0]["ReExamFlag"].ToString().Trim() != "Y")
            {
                ...
                x = dataAccess.execute_sprcrecruit("Prc_UpdateQCDtls", htParam);
                //InsertfeesDetails();
            }
            else if (dsCndtype.Tables[0].Rows[0]["ReExamFlag"].ToString().Trim() == "Y")
            {
                ...
                else if (dsReExm.Tables[0].Rows[0]["ReExamFlag"].ToString().Trim() == "Y" && dsReExm.Tables[0].Rows[0]["ReExmType"].ToString().Trim() == "V")
                {
                    ...
                    htParam.Add("@ExmCentre", txtExmCentre.Text.Trim());
                    //Added by rachana to save Exam details at the time of SAVE end
                    x = dataAccess.execute_sprcrecruit("Prc_UpdQCDtlsValidReExm", htParam);
                    //InsertfeesDetails();
                }
            }
            ...
            else if (dsCndtype.Tables[0].Rows[0]["RenewalFlag"].ToString().Trim() == "Y")//added by shreela on 03052014
            {
                ...
                if (dsCndtype.Tables[0].Rows[0]["CandType"].ToString().Trim() == "F")
                {
                    if (cbTccCompLcn.Checked == true)
                    {
                        ...
                        if (ViewState["InsRenType"] != "")
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    //dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetCndLicnsDtls", htParam1);
                        ...
                        //htParam.Add("@Updatedby", Session["UserId"].ToString().Trim());
                        htParam.Add("@flag", "1");
                        ds_documentName = dataAccess.GetDataSetForPrcRecruit("Prc_UpdQCRenwlDtls", htParam);
                    }
                    else
                    {
                        //htParam1.Clear();
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dsRWQCFlag = dataAccess.GetDataSetForPrcRecruit("Prc_GetCndLicnsDtls", htRWQCFlag);
            if (dsRWQCFlag.Tables[0].Rows[0]["RnwlQCFlag"].ToString().Trim() != "Y")
            {
                ...
                htparam.Add("@CndNo", lblCndNoValue.Text.ToString().Trim());
                dsapprovechk = dataAccess.GetDataSetForPrcRecruit("Prc_ChkCFRDocCFRRemark", htparam);
                ...
                dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetCndLicnsDtls", htrenwl);
                ...
                if (dsReExm.Tables[0].Rows[0]["ReExamFlag"].ToString().Trim() == "Y")
                {
                    ...
                    dsReExm1 = dataAccess.GetDataSetForPrcRecruit("Prc_GetCndReExmDtls", htrexm1);
                    ...
                    if (dsReExm1.Tables[0].Rows[0]["ReExamFlag"].ToString().Trim() == "Y" && dsReExm1.Tables[0].Rows[0]["ReExmType"].ToString().Trim() == "V")//Reexam QC
                    {
                        ...
                        htParam.Add("@PAN", txtPAN.Text.Trim());
                        htParam.Add("@Mobile", txtMobileNo.Text.Trim());
                        x = dataAccess.execute_sprcrecruit("Prc_ApprLictrnccsuForReExm", htParam);//added by pranjali on 29-04-2014 end
                        //MailResponse();
                    ...
                    else if (dsReExm1.Tables[0].Rows[0]["ReExamFlag"].ToString().Trim() == "Y" && dsReExm1.Tables[0].Rows[0]["ReExmType"].ToString().Trim() == "I")//Reexam QC)
                    {
                        ...
                        htParam.Add("@PAN", txtPAN.Text.Trim());
                        htParam.Add("@Mobile", txtMobileNo.Text.Trim());
                        x = dataAccess.execute_sprcrecruit("Prc_UpdateAppr_Lictrnccsu", htParam);
                        //MailResponse();
                ...
                if (dsResult.Tables[0].Rows[0]["RenewalFlag"].ToString().Trim() == "Y")
                {
                    if (dsResult.Tables[0].Rows[0]["CandType"].ToString().Trim() == "F" || dsResult.Tables[0].Rows[0]["CandType"].ToString().Trim() == "T")
                    {
                        if (cbTccCompLcn.Checked == true)
                        {
                            ...
                            ds_documentName = dataAccess.GetDataSetForPrcRecruit("Prc_updcndcompdtls", htdata);
                            //x = dataAccess.execute_sprcrecruit("Prc_UpdateAppr_LicRenTccsuRen", htParam);
                            //InsertfeesDetails();
                    ...
                    dsloc = dataAccess.GetDataSetForPrcRecruits("Prc_GetCandType", httable);
                    ...
                    if (dsloc.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (strtrn == "T")
                        {
                            if (dsloc.Tables[0].Rows[0]["RenewalFlag"].ToString().Trim() != "Y")//added by shreela on 26/05/2014
                            {
                                ...
                                int z = dataAccess.execute_sprcrecruit("Prc_UpdTrnsfrLicDtls", htTrnsfrLic);
                            }
                        }
                        //added by pranjali on 27-03-2014 start
                        if (IsPriorAgt == "1")
                        {
                            ...
                            else if (dsloc.Tables[0].Rows[0]["RenewalFlag"].ToString().Trim() == "Y")
                            {
                                ...
                                x = dataAccess.execute_sprcrecruit("Prc_updcndlicdtls", htdata);
                            }
                        }
                        //added by pranjali on 27-03-2014 end
                        //added by pranjali on 11-04-2014 start
                        if (strtrn == "C")
                        {
                            ...
                            if (dsloc.Tables[0].Rows[0]["RenewalFlag"].ToString() != "Y")
                            {
                                ...
                                {
                                    int y;
                                    y = dataAccess.execute_sprcrecruit("Prc_UpdForCompCand", httable); //Added by pranjali on 02-01-2014 to update details
                                }
                            }
                        }
                        //added by pranjali on 11-04-2014 end
    ...
    protected void btnverifyemail_Click(object sender, EventArgs e)
    {
        try
        {
            if (txtEMail.Text != "")
            {
                ...
                htParam.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
                htParam.Add("@Email", txtEMail.Text.Trim());
                dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetQualCheckverifyEmail", htParam);
                ...
                if (dsResult.Tables.Count > 0)
                {
                    if (dsResult.Tables[0].Rows.Count > 0)// && dsResult.Tables[0].Rows.Count == 1)
                    {
                        ...
                        htrenwl.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
                        dsrenwl = dataAccess.GetDataSetForPrcRecruit("Prc_GetCandType", htrenwl);
    ...
    protected void btnverifymobile_Click(object sender, EventArgs e)
    {
        try
        {
            if (txtMobileNo.Text != "")
            {
                ...
                htParam.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
                htParam.Add("@MobileNo", txtMobileNo.Text.Trim());
                dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetQualCheckverifyMobile", htParam);
                if (dsResult.Tables.Count > 0)
                {
                    if (dsResult.Tables[0].Rows.Count > 0)// && dsResult.Tables[0].Rows.Count ==1)
                    {
    ...
    protected void Btncrop_Click(object sender, EventArgs e)
    {
        ...
        dsResult = dataAccess.GetDataSetForPrcRecruit("prc_GetImagesforQC", htParam);
    ...
    protected void btnReject_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            htParam.Add("@CndNo", lblCndNoValue.Text.ToString().Trim());
            htParam.Add("@UpdatedBy", Session["UserID"].ToString().Trim());
            x = dataAccess.execute_sprcrecruit("Prc_UpdCndStatonRejApp", htParam);
    ...
    protected void Filluploadedfile() //string lbldocname
    {
        try
        {
            ...
            else
            {
                ...
                dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetUploaded_Images", htParam);
                //added by pranjali on 11-04-2014 end
                //dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetUploaded_Images", htParam);//commented by pranjali on 11-04-2014 start
                if (dsResult.Tables.Count > 0)
                {
                    if (dsResult.Tables[0].Rows.Count > 0)
                    {
    ...
    protected void btn_Upload_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            try
            {
                if (Request.QueryString["Type"].ToString().Trim().ToUpper() == "N")
                {
                    intValue = dataAccess.execute_sprcrecruit("Proc_InsertDCTMFileUpload1", htdata);
                }
        ...
        FileInfo fi = new FileInfo(strPath);
        {
            if (fuData.PostedFile.ContentLength <= BMaxImgSize1)
            {
                if (File.Exists(strFileName))
                {
                    ...
                    htdata.Add("@doctype", lbldocName.Text.Trim());
                    dsResult.Clear();
                    dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetDocStatus", htdata);
                    if (dsResult.Tables.Count > 0)
                    {
                        if (dsResult.Tables[0].Rows.Count > 0)
                        {
    ...
    protected void FillReuploadedfile(string Docname) //string lbldocname
    {
        try
        {
            if (Request.QueryString["Type"].ToString().Trim().ToUpper() == "E" || Request.QueryString["Type"].ToString().Trim() == "R")
            {
                ...
                dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetReUploadedDetails", htParam);
                if (dsResult.Tables.Count > 0)
                {
                    if (dsResult.Tables[0].Rows.Count > 0)
                    {
            ...
            else
            {
                ...
                Hashtable httable1 = new Hashtable();
                httable1.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
                ds_candtype = dataAccess.GetDataSetForPrcRecruit("Prc_GetCandType", httable1);
                htParam.Clear();
                htParam.Add("@CandType", Convert.ToString(ds_candtype.Tables[0].Rows[0]["CandType"]).Trim());
                htParam.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
                htParam.Add("@doctype", Docname.Trim());
    ...
    private void BindGrid()
    {
        try
        {
            ...
            ds_image = dataAccess.GetDataSetForPrc("prc_GetImagesforMember", httable);
            if (ds_image.Tables.Count > 0)
            {
                if (ds_image.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (strPhotoExt == "PDF" || strPhotoExt == "pdf")
                    {
                        ...
                        {
                            valcode = Request.QueryString["CndNo"].ToString().Trim();
                        }
                        else
                        {
                            valcode = Request.QueryString["Memcode"].ToString().Trim();
                        }
    ...
    protected DataTable GetDataTableForUplds()
    {
        ...
        try
        {
            ...
            dsUpdDocPgIndxng = dataAccess.GetDataSetForPrcRecruit("Prc_GetDocNames", htparam); //added by pranjali on 11-04-2014 
    ...
    protected DataTable GetDataTable()
    {
        try
        {
            ...
            //dsResult = dataAccess.GetDataSetForPrcRecruit("prc_GetImagesbinary", htParam);
    ...
    protected void btnnext_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            dsResult1 = dataAccess.GetDataSetForPrcRecruit("prc_GetImagesforQC", htParam);
    ...
    protected DataTable GetRemarkdtl()
    {
        ...
        try
        {
            ...
            dsRemark = dataAccess.GetDataSetForPrcRecruit("Prc_GetRemarksDtls", htRemark);
        }
        catch (Exception ex)
        {
            string currentFile = new System.Diagnostics.StackTrace(true).GetFrame(0).GetFileName();
    ...
    protected DataTable GetDataTableInbox()
    {
        try
        {
            ...
            //dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_AssignedCFR_bracheduser", htParam);
            ...
            {
                htParam.Add("@UserId", Request.QueryString["user"].ToString());
                dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_AssignedCFR_Licenseduser", htParam);
            }
            else
            {
                dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_RespondedCFR_bracheduser", htParam);
            }
    ...
    private void BindgridChkboxChnge()
    {
        ...
        try
        {
            ...
            htParam.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
            dsResultren = dataAccess.GetDataSetForPrcRecruit("Prc_GetCandType", htParam);
            Hashtable htren = new Hashtable();
            htren.Clear();
            DataSet dsren = new DataSet();
            dsren.Clear();
            ...
            dscand = dataAccess.GetDataSetForPrcRecruit("Prc_GetDocNames", ht);
            //added by pranjali on 11-04-2014 end
            //dscand = dataAccess.GetDataSetForPrcRecruit("Prc_GetDocNames", ht); //commented by pranjali on 11-04-2014
    ...
    protected void FilluploadedfileChkboxChnge() //string lbldocname
    {
        try
        {
            ...
            ds_candtype1 = dataAccess.GetDataSetForPrcRecruit("Prc_GetUploaded_Images", httable2);
            //added by pranjali on 11-04-2014 end
            //ds_candtype1 = dataAccess.GetDataSetForPrcRecruit("Prc_GetUploaded_Images", httable2);//commented by pranjali on 11-04-2014 start
    ...
    protected void lnkmandtry_click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds_panchayat = dataAccess.GetDataSetForPrcRecruit("Prc_GetPanchayatCheck", ht);
            ...
            if (Request.QueryString["Type"].ToString().Trim().ToUpper() == "E" || Request.QueryString["Type"].ToString().Trim().ToUpper() == "R")
            {
                ...
                //}
                //added by pranjali on 11-04-2014 end
                dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetMandatoryDocEdit", htParam);
            }
            else
            {
                dsResult = dataAccess.GetDataSetForPrcRecruit("Prc_GetMandatoryDoc", htParam);
            }
            if (dsResult.Tables[0].Rows.Count > 0)
            {
        ...
        try
        {
            ...
            foreach (GridViewRow row in Assignedcfr)
            {
                ...
                if (chkassign.Checked == true)
                {
                    ...
                    dsclose = dataAccess.GetDataSetForPrcRecruit("Prc_GetCandType", htClose);
                    ...
                    dataAccess.execute_sprcrecruit("Prc_Submit_AssignedCFR_admin", htCFR);
                    btnSubmit.Enabled = false;
                    BindInboxGrid();
    ...
    protected void dgView_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            else if (lblManDoc.Text == "C" && lbldoccode.Text == "15")
            {
                ...
                ds_panchayat = dataAccess.GetDataSetForPrcRecruit("Prc_CheckForPanchayat", htPanchayat);
                if (ds_panchayat.Tables[0].Rows[0]["PANCHAYAT"].ToString() == "1")
                {
                    e.Row.BackColor = Color.LightPink;
                }
            ...
            dsdtl = dataAccess.GetDataSetForPrcRecruit("Prc_GetCndLicnsDtls", httable1);
            Hashtable htparam = new Hashtable();
            htparam.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
            if (Request.QueryString["Type"].ToString().Trim().ToUpper() == "E" || Request.QueryString["Type"].ToString().Trim() == "R")
            {
            ...
            dsUpldImg = dataAccess.GetDataSetForPrcRecruit("Prc_GetUpldDocCode", htparam);
            //ds_documentName = dataAccess.GetDataSetForPrcRecruit("Prc_GetUpldDocNames", htparam);
    ...
    protected void btnRespond_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow row in Assignedcfr)
        {
            ...
            if (chkassign.Checked == true)
            {
                ...
                {
                    dataAccess.execute_sprcrecruit("Prc_CFRRespondForIRDA", htCFR);
                    BindInboxGrid();
                ...
                {
                    dataAccess.execute_sprcrecruit("Prc_Submit_AssignedCFR_bracheduser", htCFR);
                    BindInboxGrid();
                    //lblcfrrespnd.Text = "Responded successfully";
        ...
        //htdoc.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
        //htdoc.Add("@DocCode", "28");
        //dsResult = dataAccess.GetDataSetForPrcRecruits("Prc_ChkIRDACloseCFR", htdoc);
        ...
        //            htdoc.Clear();
        //            htdoc.Add("@CndNo", Request.QueryString["CndNo"].ToString().Trim());
        //            dataAccess.execute_sprcrecruit("Prc_UpdCFRStatusforIRDA", htdoc);
        //        }
        //    }
        //}        
    }
    protected void lnkGetFees_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            f = dataAccess.execute_sprcrecruit("Prc_InsertSyncLogFees", htLog);

            //Binding output xml to gridview 
            DataSet dsinput = new DataSet();
            DataSet dsoutput = new DataSet();
            dsoutput = dataAccess.FuncConvertToDataset(objOutPut);

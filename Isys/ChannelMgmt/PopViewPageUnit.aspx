<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopViewPageUnit.aspx.cs" MasterPageFile="~/iFrame.master" Inherits="Application_Isys_ChannelMgmt_PopViewPage" %>
    ...
    <div class="panel" id="ImpactedMemTypeCount" style="width: 80%;/* margin-top: -15px; *//* margin-left: 1%; */margin: 0 auto;">
        <div id="trtitle" runat="server" class="panel-heading"
            ...
            <div class="row" id="trDetails" runat="server">
                <div class="col-sm-10" style="text-align: left;float:left;margin-top:10px;">
                    <%--<span class="glyphicon glyphicon-menu-hamburger" style="color: #034ea2;"></span>--%>
                    <asp:Label ID="lblprospectsearch" runat="server" Text="Impacted  Unit Type Results" Style="font-size: 19px;"></asp:Label>
                </div>
        ...
        <div id="div1" runat="server" style="width: 96%; height: 40%; padding: 10px; overflow-x: scroll;" class="panel-body">
            ...
            <asp:UpdatePanel ID="UPDErrMsg" runat="server">
                <ContentTemplate>
                    ...
                    <div class="row" id="trAgentTypes" runat="server" style="margin-left: 19px; width: 97%; overflow: auto;">
                        <asp:GridView AllowSorting="True" ID="gv" runat="server" CssClass="footable"
                            ...
                            <Columns>
                                 ...
                                 <asp:BoundField DataField="memtypeNew" HeaderText="Impacted Unit Type" SortExpression="memtypeNew"
                    ...
                    <div id="divPagingBtn" runat="server">
                        <br />
                        <center>
                                <table>
                                    <tr>
            ...
            <asp:UpdatePanel ID="UpdOk" runat="server" style="margin-left: 506px;width: 19%;">
                <ContentTemplate>
                    
                       
                    <asp:LinkButton ID="btnProceed" runat="server" OnClick="btnProceed_Click" CssClass="btn btn-success">
                                          <span class="glyphicon glyphicon-check BtnGlyphicon"></span> Proceed </asp:LinkButton>

                    <asp:LinkButton ID="btnCancel" runat="server" OnClientClick="doCancel();return false;" Text="Cancel" CssClass="btn btn-clear">

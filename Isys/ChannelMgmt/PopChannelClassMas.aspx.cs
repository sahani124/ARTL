...
public partial class Application_ISys_ChannelMgmt_PopChannelClassMas : BaseClass
{
    ...
    private void fillGridDgComDetails(string strFincYr, string Version)
    {
        ...
        dsResult = objDAL.GetDataSetForPrcCLP("prc_ChnClsSearch", htParam);
        if (dsResult != null)
        {

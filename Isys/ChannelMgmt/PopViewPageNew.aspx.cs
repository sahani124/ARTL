...
public partial class Application_Isys_ChannelMgmt_PopViewPage : BaseClass
{
    #region DECLARATION
    ...
    protected void BindAgentGrid()
    {
        ...
        try
        {
            ...
            //htParam.Add("@BizSrc1", Request.QueryString["Bizsrc"].ToString());
            //htParam.Add("@ChnCls2", Request.QueryString["Bizsrc"].ToString());
            //htParam.Add("@AgnType3", Request.QueryString["AgentType"].ToString());
            ...
            dsResult = objDAL.GetDataSetForPrc("Prc_GetActInActAgent_Test1", htParam);

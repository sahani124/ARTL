<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaymentVoucher.aspx.cs" Inherits="Application_Isys_ChannelMgmt_PaymentVoucher" %>
...
<script type="text/javascript">
    ...
    function popupHist() {
        ...
        $("#myModal1").modal();
        var returnObjName = localStorage.getItem('PaymentVoucherTable');
        if (returnObjName && Object.keys(returnObjName).length > 0) {
            document.getElementById("tblTxnPayVoucher").innerHTML = localStorage.getItem("PaymentVoucherTable");
        } else {
    ...
    function ClosePopup() {
        debugger;
        $('#myModal1').modal('hide');
        localStorage.setItem("PaymentVoucherTable", "");
    ...
    function Remove(button) {
        ...
        if (confirm("Do you want to delete: " + name)) {
            ...
            var table = document.getElementById("tblTxnPayVoucher");
    ...
    function AddRow(TransType, AccountName, Debit, Credit) {
        ...
        var tBody = document.getElementById("tblTxnPayVoucher").getElementsByTagName("TBODY")[0];
    ...
    function GetTableValues() {
        ...
        localStorage.setItem("PaymentVoucherTable", document.getElementById("tblTxnPayVoucher").innerHTML);
        //Reference the Table.
        var table = document.getElementById("tblTxnPayVoucher");
        ...
        document.getElementsByName("PaymentVoucherJSON")[0].value = JSON.stringify(PaymentVouchers);
    }
        ...
        <asp:UpdatePanel ID="updatepanel44" runat="server">
            <ContentTemplate>
                <div class="panel " id="divcmphdrcollapse" runat="server">
                    <div id="Div4" runat="server" class="panel-heading" onclick="ShowReqDtl('divcmphdr','btndivcmphdr');return false;">
                        <div class="row">
                            <div class="col-sm-10" style="text-align: left">
                                <asp:Label ID="lblPymtVoc" runat="server" Font-Size="19px"> Payment Voucher</asp:Label>
                            </div>
                            <div class="col-sm-2">
                    ...
                    <div id="divcmphdr" runat="server" class="panel-body" style="display: block;height: 85px;margin-top: -1px;">
                        <div class="row" style="margin-bottom: 5px;">
                            <div class="col-md-3" style="text-align: left">
                                <asp:Label ID="lblPaymentVoucher" CssClass="control-label" runat="server"> Payment Voucher No</asp:Label>&nbsp;
                                   
                            </div>
                            <div class="col-md-3" style="text-align: left">
                                <asp:TextBox ID="txtPaymentVoucher" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                ...
                <div class="panel " id="div3" runat="server">
                    ...
                    <div id="div1" runat="server" class="panel-body" style="display: block">
                        <div class="" style="margin-bottom: 5px;">
                            <asp:GridView ID="dgPymntVoucher" runat="server" CssClass="footable" AllowSorting="true"
                                AutoGenerateColumns="False" PageSize="10" AllowPaging="true" CellPadding="1" Style="margin-top: 10px" OnRowEditing="dgPymntVoucher_RowEditing" OnRowCommand="dgPymntVoucher_RowCommand" OnRowDeleting="dgPymntVoucher_RowDeleting" OnRowCancelingEdit="dgPymntVoucher_RowCancelingEdit" OnRowUpdating="dgPymntVoucher_RowUpdating">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Payment Voucher No" ShowHeader="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPV_NO" runat="server" Text='<%# Bind("PV_NO") %>'></asp:Label>
                                        </ItemTemplate>
                                         <ItemStyle HorizontalAlign="Center" Width="10% " CssClass="ccsalignCenter"></ItemStyle>
                                      <EditItemTemplate>
                                            <asp:Label ID="lblPaymentVoNoEdit" runat="server" Visible="true" Text='<%# Eval("PV_NO") %>'></asp:Label>
                                               
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Created Date" ShowHeader="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCreateDate" runat="server" Text='<%# Bind("CREATED_DATE") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Narration" ShowHeader="true">
                                        <ItemTemplate>
                    ...
                    <div class="modal-dialog modal-sm" style="width: auto; padding: 49px">
                        ...
                        <div class="modal-content">
                            <div class="modal-header" style="text-align: center; text-align: initial; background-color: #f04e5e; height: 45px; padding-top: 11px;">
                                <asp:Label ID="Label31" Text="Add Payment Voucher" runat="server" Font-Bold="true" Style="font-size: initial"></asp:Label>
                                ...
                                <div id="divsrch" runat="server" class="panel-body" style="display: block; overflow: auto">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2" style="text-align: left; margin-left: 21px;">
                                            <asp:Label ID="lblPymntVouchNo" runat="server" CssClass="control-label" Font-Size="16px">Payment Voucher No</asp:Label>
                                            <asp:Label Text="*" runat="server" Style="color: Red" />
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:TextBox ID="txtPymntVouchNo" CssClass="form-control" disabled="disabled" placeholder="Payment Voucher No" runat="server"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="panel " id="div2" runat="server" style="margin-top:-35px;">
                                        <div id="Div6" runat="server" class="panel-heading">
                                            <div class="row">
                                                <div class="col-sm-10" style="text-align: left">
                                                    <asp:Label ID="lblParticulars" runat="server" Style="font-size: 16px; margin-left: -9px; color: #333;"> Add Particulars</asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="panel-body" style="display: block;margin-top: -1px; height: 77px;">
                                            <div class="row" style="margin-top: -9px;"
 >

                                                <div class="col-sm-3" style="text-align: left;">
                                                    <asp:Label ID="lblTransType" runat="server" CssClass="control-label" ForeColor="Red" Font-Size="16px">Transaction Type</asp:Label>

                                                </div>

                                                <div class="col-sm-3" style="text-align: left;">
                                                    <asp:Label ID="lblAccountName" runat="server" CssClass="control-label" ForeColor="Red" Font-Size="16px">Account Name</asp:Label>

                                                </div>
                                                <div class="col-sm-3" style="text-align: left;">
                                                    <asp:Label ID="lblAmount" runat="server" CssClass="control-label" ForeColor="Red" Font-Size="16px">Amount</asp:Label>

                                                </div>
                                                <div class="col-sm-3" style="text-align: left;">
                                                    <asp:Label ID="lblAction" runat="server" CssClass="control-label" ForeColor="Red" Font-Size="16px">Action</asp:Label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                    <asp:TextBox ID="txtAmount" CssClass="form-control" style="text-align: right;" placeholder="Amount" runat="server"></asp:TextBox>
                                                </div>
                                                <div class="col-sm-3">
                                    ...
                                    <div class="panel-body" style="margin-top:-18px">
                                        <table id="tblTxnPayVoucher" runat="server" cellpadding="0" cellspacing="0" border="0">
                                            <thead>
                                                <tr>
                                    ...
                                    <div id="divNarration">
                                        ...
                                        <div class="row" style="text-align: left; margin-left: 2%;">
                                            <asp:Label ID="lblNarration" runat="server" CssClass="control-label" Font-Size="16px" Style="text-align: left;">Narration</asp:Label>
                                        </div>
                                        <div class="row">
                    ...
                    <div class="modal-dialog" style="padding-top: 0px; margin-top: 2px; width: 95%;">
                        <div class="modal-content">
                            <div class="modal-header" style="margin-top: -10px; background-color: #f04e5e; color: white; margin-bottom: -20px; padding-bottom: 10px ! important;">
                                View Payment Voucher Transaction
                            ...
                            <div class="modal-body">
                                ...
                                <asp:GridView ID="gvTxnDetails" runat="server" AutoGenerateColumns="False" CssClass="footable"
                                    ...
                                    <HeaderStyle CssClass="gridview th" HorizontalAlign="Left" />
                                       <Columns>
                                        <asp:TemplateField HeaderText="PV Transaction No" HeaderStyle-CssClass="AlignCenter">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPaymentTxnNo" runat="server" Text='<%# Eval("PV_TXN_NO") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                               <asp:Label ID="lblPaymentTxnNoEdit" runat="server" Visible="true" Text='<%# Eval("PV_TXN_NO") %>'></asp:Label>  
                                            </EditItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Payment Voucher No" HeaderStyle-CssClass="AlignCenter">
                                            <ItemTemplate>
                                                <asp:HiddenField ID="hdnPvNo" runat="server" Value='<%# Bind("PV_NO")%>' />
                                                <asp:Label ID="lblPaymentVoucherNo" runat="server" Text='<%# Eval("PV_NO") %>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Account Name" HeaderStyle-CssClass="AlignCenter">
                                            <ItemTemplate>
                                             ...
                                             <EditItemTemplate>
                                              ...
                                              <%--<EditItemTemplate>
                                                <asp:Label ID="lblAccountNameEdit" runat="server" Visible="false" Text='<%# Eval("ACCOUNT_NAME") %>'></asp:Label>
                                                <asp:TextBox ID="txtAccountNameEdit" runat="server" CssClass="form-control" Style="background-color: #FFE5B4" Text='<%# Eval("ACCOUNT_NAME") %>'></asp:TextBox>
                                            </EditItemTemplate>--%>
                                            <HeaderStyle CssClass="AlignCenter"></HeaderStyle>
                                        ...
                                        <asp:TemplateField HeaderText="Debit Amount" HeaderStyle-CssClass="AlignCenter">
                                            <ItemTemplate>
                                             ...
                                             <EditItemTemplate>
                                                <asp:Label ID="lblDebitAmountEdit" runat="server" Visible="false" Text='<%# Eval("DEBIT_AMT") %>'></asp:Label>
                                                <asp:TextBox ID="txtDebitAmountEdit" runat="server" CssClass="form-control" Style="background-color: #FFE5B4" Text='<%# Eval("DEBIT_AMT") %>'></asp:TextBox>
                                            </EditItemTemplate>
                ...
                <asp:HiddenField ID="PaymentVoucherJSON" runat="server" />
            </ContentTemplate>
        </asp:UpdatePanel>
    </form>
</body>

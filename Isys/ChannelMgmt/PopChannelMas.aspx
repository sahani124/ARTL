<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true" CodeFile="PopChannelMas.aspx.cs" Inherits="Application_ISys_ChannelMgmt_PopChannelMas" %>
                                                ...
                                                <asp:UpdatePanel runat="server" ID="upddgcom" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <asp:GridView ID="dgComDetails" runat="server" AutoGenerateColumns="False" HorizontalAlign="Left"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField SortExpression="BizSrc" HeaderText="Company Code" ItemStyle-Width="15%">
                                                                    <ItemTemplate>
                                                                    <div>
                                                                ...
                                                                <asp:TemplateField SortExpression="ChannelDesc01" ItemStyle-HorizontalAlign="Left"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblComChannelDesc01" runat="server" Text='<%# Eval("ChannelDesc01") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                             ...
                                                             <asp:TemplateField HeaderText="Version"  SortExpression="BaseVersion">
                                                             <ItemTemplate>
                                                             ...
                                                             <asp:TemplateField HeaderText="Cease Date" SortExpression="CeaseDate">
                                                             <ItemTemplate>
                                                        ...
                                                        <asp:GridView ID="dgDetails" runat="server" AutoGenerateColumns="False" HorizontalAlign="Left"
                                                           ...
                                                           AllowSorting="True" OnSorting="dgDetails_Sorting">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Channel Code" ItemStyle-Width="20%" SortExpression="BizSrc">
                                                                    <ItemTemplate>
                                                                    <div>
                                                                ...
                                                                <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="Channel Desc" SortExpression="ChannelDesc01">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblChannelDesc01" runat="server" Text='<%# Eval("ChannelDesc01") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField SortExpression="SortOrder" HeaderText="Sort Order" ItemStyle-Width="10%"
                                                                    Visible="false">

<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true" CodeFile="DataView_TypeSetup.aspx.cs" Inherits="Application_ISys_ChannelMgmt_DataView_TypeSetup" %>
...
<div id="div1" runat="server" style="display: none;">
 ...
 <td>
                    ...
                    <td id="Td1" runat="server">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                <span>
                                <asp:LinkButton ID="lnk1" runat="server" OnClick="lnk1_click" CommandArgument='<%# Eval("UnitType")%>'> <%# Eval("UnitDesc01").ToString().Length > 20 ? (Eval("UnitDesc01") as string).Substring(0, 17) + " ..." : Eval("UnitDesc01")%></asp:LinkButton>
                                </span>
  ...
  <div id="div3"  runat="server" style="display:none;" >
   ...
   <table id="Table1" style="border-style:solid; width:80%;   border-color:gray; border-width:1px; height:495px; margin-left: 240px;margin-top:8px; " runat="server" >
                        <tr>
...
<%--              <img src="../../../theme/iflow/Backb.jpg"
             ...
             <table style="width:100%; margin-left: 5px;margin-top:-191px;">
                        <tbody> 
                            <tr>
                             <td >  
                                    <a href="DataView.aspx">             <%-- ProductDetails.aspx?productID=<%#:Item.ProductID%>--%>
                                        <img src="../../../theme/iflow/Channel.jpg"
                                            width="97%" height="215"  style="border:1px solid gray;"/></a>

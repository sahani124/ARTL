<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopUntView.aspx.cs" Inherits="Application_Isys_ChannelMgmt_PopUntView" %>--%>
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopUntView.aspx.cs" MasterPageFile="~/iFrame.master" Inherits="Application_Isys_ChannelMgmt_PopUntView" %>
    ...
    <link href="../../../Styles/main.css" rel="stylesheet" type="text/css" />
     ...
     <script language="javascript" type="text/javascript">
        ...
        function ShowReqDtl(divName, btnName) {
         ...
         <%--function doCancel() {
             debugger;
             var getCncl = document.getElementById('<%=btnCancel.ClientID%>');
             //data-dismiss="modal"
             element.setAttribute("class", "data-dismiss:modal");
        }--%>
        ...
        <div class="row">
                            ...
                            <asp:GridView ID="gv" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CssClass="footable"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sub channel" SortExpression="ChnClsDesc01">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblMemType" runat="server" Text='<%# Bind("UnitDesc01") %>'></asp:Label>
                                        </ItemTemplate>
                                          <ItemStyle CssClass="ccsalignCenter" />
                                    </asp:TemplateField>
          ...
          <%--   </div>
              ...
              <br />
                    ...
                    <asp:UpdatePanel ID="UpdOk" runat="server" style="margin-left: 602px;">
                        <ContentTemplate>
                    <%--       <asp:LinkButton ID="btnOK" runat="server" Text="Ok" CssClass="btn btn-primary"
                                    OnClick="btnOK_Click"><span class="glyphicon glyphicon-ok BtnGlyphicon"></span> Ok </asp:LinkButton>--%>
                                      <asp:LinkButton ID="btnCancel" Visible="false" runat="server" OnClientClick="doCancel();return false;" Text="Cancel" CssClass="btn btn-danger">

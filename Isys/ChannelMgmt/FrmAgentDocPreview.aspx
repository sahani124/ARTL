<%@ Page Title="" Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true" CodeFile="FrmAgentDocPreview.aspx.cs" Inherits="Application_ISys_Recruit_FrmAgentDocPreview" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <td align="left" class="formcontent" style="width: 20%;">
        ...
        <table class="tableIsys" id="tblupload" runat="server" style="width: 90%;">
            ...
            <tr>
                <td class="test" colspan="3" style="text-align: left;" visible="false">
                    <asp:Label ID="lblCanddoc" runat="server" Text="Candidate Document Upload" visible="false" Font-Bold="true"></asp:Label>
      ...
      <center>
        ...
        <asp:Panel ID="Panelphoto2" runat="server"  Width="100%" Visible="true"  ScrollBars="Vertical" >
                ...
                <div id="Div11" runat="server" class="panel-heading" style="background-color: white !important;" onclick="ShowReqDtl('ctl00_ContentPlaceHolder1_divgrid','btnWfParam');return false;"> 
                 ...
                 <div class="row" >
                          <div class="col-sm-10" style="text-align: left">
                           <asp:Label ID="lblpanelheader" runat="server" CssClass="control-label"  Font-Size="19px" />
                            ...
                            <tr>
                              ...
                              <%--      <asp:GridView ID="GridImage" runat="server" AllowSorting="True" CssClass="tableIsys"
                                        ...
                                        OnRowDataBound="GridImage_RowDataBound">--%>
                                            ...
                                            AutoGenerateColumns="False"   CssClass="footable image"
                            ...
                            <AlternatingRowStyle CssClass="GridViewAlternateRow"></AlternatingRowStyle>
                                        <Columns>
                                            ...
                                            <asp:ImageField DataImageUrlField="ID" DataImageUrlFormatString="FPImageCSharp.aspx?ImageID={0}"
                                                HeaderText="Preview Image" ControlStyle-Width="90%">
                        ...
                        <td style="height: 20px" align="center" colspan="4">
                         ...
                         <%--   <asp:Button ID="btnClear" TabIndex="43" OnClick="btnClear_Click" runat="server" Text="Cancel"
                                CssClass="standardbutton" Width="114px"></asp:Button>--%>
                                       <asp:LinkButton ID="btnClear" TabIndex="43"  style="width:80px;padding-top: 8px;height: 40px;" 
                                runat="server" 

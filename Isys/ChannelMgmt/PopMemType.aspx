<%@ Page Language="C#" MasterPageFile="~/iFrame.master" AutoEventWireup="true" CodeFile="PopMemType.aspx.cs"
    Inherits="Application_Isys_ChannelMgmt_PopMemType" %>
    ...
    <div  >
        ...
        <div id="div1" runat="server" style="overflow-x: scroll;" class="panel-body">
                ...
                <ContentTemplate>
                    ...
                    <asp:GridView ID="gv" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CssClass="footable"
                        ...
                        <Columns>
                            ...
                            <%--                             <asp:TemplateField HeaderText="Member Code" SortExpression="MemCode" Visible="false>
                                        <ItemTemplate>
                                        <i class="fa fa-male"></i>&nbsp;&nbsp;
                                            <asp:Label ID="lblMemCode" runat="server" Text='<%# Bind("MemType") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="20%" />
                                    </asp:TemplateField>--%>

                            <asp:TemplateField HeaderText="Member Description" SortExpression="MemTypeDesc01">
                                <ItemTemplate>
                                    <asp:Label ID="lblMemType_desc" runat="server" Text='<%# Bind("MemTypeDesc01") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="20%" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Member Level" SortExpression="MemLevel">
                                <ItemTemplate>
                                    <asp:Label ID="lblMemlevel" runat="server" Text='<%# Bind("MemLevel") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="20%" />
                            </asp:TemplateField>
            ...
            <asp:UpdatePanel ID="UpdOk" runat="server" style="margin-left: 290px;">
                <ContentTemplate>
                    <asp:LinkButton ID="btnOK" runat="server" Text="Ok" Width="85" CssClass="btn btn-primary"
                        OnClick="btnOK_Click"><span class="glyphicon glyphicon-ok BtnGlyphicon"></span> OK </asp:LinkButton>
                    <asp:LinkButton ID="btnCancel" runat="server" Style="background-color: #FFF; color: #f04e5e; width: 85px !important" OnClientClick="doCancel();return false;" Text="Cancel" CssClass="btn btn-danger">

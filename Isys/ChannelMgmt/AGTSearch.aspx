<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AGTSearch.aspx.cs" Inherits="INSCL.AGTSearch"
    MasterPageFile="~/iFrame.master" Title="Agent Search" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   <link href="../../../KMI%20Styles/Bootstrap/css/bootstrap.min.css" rel="stylesheet"
    ...
    <center>
                ...
                <div id="Div6" runat="server" class="panel-heading" onclick="ShowReqDtl1('hide1','btnNominee');return false;">
                    <div class="row">
                        <div class="col-sm-10" style="text-align: left">
                            <asp:Label ID="lblSourceName" Visible="false" runat="server" Font-Size="19px"></asp:Label>
                        </div>
                        <div class="col-sm-2">
                ...
                <div id="hide1" class="panel-body">
                    <div class="panel" style="margin-top: 15px;">
                        <div id="Div1" runat="server" class="panel-heading"
                            ...
                            <div class="row">
                                <div class="col-sm-10" style="text-align: left">
                                    <span  style="color: #034ea2;"></span>
                                    <asp:Label ID="lblbas" Text="Basic Search" runat="server" class="subheader" />
                                </div>
                                <div class="col-sm-2">
                    ...
                    <div class="panel " style="margin-top: 15px;">
                        <div id="Div3" runat="server" class="panel-heading"
                            ...
                            <div class="row">
                                <div class="col-sm-10" style="text-align: left">
                                    <span style="color: #034ea2;"></span>
                                    <asp:Label ID="Label3" Text="Advance Search" runat="server" CssClass="subheader" />
                                </div>
                                <div class="col-sm-2">
                        ...
                        <div id="divAgtAdv" runat="server" class="panel-body">
                            ...
                            <div class="col-sm-3" style="display: flex;">
                                ...
                                <asp:Button ID="btnUnitCode" runat="server" Style="margin-left: 2px;" CssClass="btn btn-verify"
                           ...
                           <%--     <asp:TextBox CssClass="form-control" runat="server" ID="txtDTJoinFrom" onclientclick="$('#txtDTJoinFrom').datepicker({ changeMonth: true, changeYear: true });"
                                  ...
                                  <asp:TextBox ID="txtDTJoinFrom" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        ...
                        <%--    <asp:RequiredFieldValidator ID="RFV" runat="server" SetFocusOnError="true" ControlToValidate="txtDTJoinFrom"
                         ...
                         --%>  
                                  ...
                                  <asp:TextBox ID="txtDTJoinTo" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <asp:TextBox ID="txtLicNo" runat="server" CssClass="form-control" MaxLength="20" style="margin-top:-15px" ></asp:TextBox>
                    ...
                    <div class="row" style="margin-top: 12px;">
                        <div class="col-sm-12" align="center">
                            <asp:LinkButton ID="btnSearch" runat="server" CssClass="btn btn-sample" CausesValidation="true"
                         ...
                         <span class="glyphicon glyphicon-search" style='color: White;'></span> Search
                            ...
                            <asp:LinkButton ID="btnClear" runat="server" CssClass="btn btn-sample" CausesValidation="False"
                                 OnClick="btnClear_Click" ><%--OnClientClick="funClearTxt();"--%>
                        ...
                        <div class="row" align="center"  >
                            <div class="col-sm-12" align="center" style="margin-top: 12px;">
                                <asp:label id="lblmsg" text="No Record Found" ForeColor="Red" Visible="false" runat="server" /> <%--added by Meena--%>
                            </div>
        ...
        <div id="divsearch1" runat="server" class="panel container" style="margin-top: 15px;
            display: none;">
            ...
            <div id="divsrch" runat="server" style="width: 100%; margin-top:10px">
                <%--padding: 10px;--%>
                <div id="Div2" runat="server" style="width: 97%;"
                    class="table-scrollable"><%-- style="width: 97%; border: none; margin: 0px 0 !important;"--%>
    ...
    <asp:Panel runat="server" ID="pnlMdl" Width="570" BackColor="White"  display="none">
        <iframe runat="server" id="ifrmMdlPopup" width="570" height="420px" frameborder="0"
            display="none"></iframe>
    </asp:Panel>

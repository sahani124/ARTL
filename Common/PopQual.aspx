<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopQual.aspx.cs" Inherits="Application_Common_PopQual" %>
        ...
        <table class="formtable" width="100%">
            ...
            <tr>
                <td class="formcontent" colspan="2" align="center" style="text-align: center">
                    <asp:Button CssClass="standardbutton" ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" /><asp:Button class="standardbutton" ID="btnClear" runat="server" Text="Clear" OnClientClick="doClear();return false;" />
                    ...
                    <atlas:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="gv" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Highest Qualification Code" SortExpression="ParamValue">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnk" runat="server" Text='<%# Bind("ParamValue") %>'></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="ParamDesc" HeaderText="Highest Qualification Name" SortExpression="ParamDesc" />
                                </Columns>
                            </asp:GridView>
                    </ContentTemplate>
                    <Triggers>
